...
$atributos["leyenda"] = "Consultar Certificado de Ingresos y Retenciones";
...
unset($atributos);
    ...
    //-------------Control Mensaje-----------------------
$tipo = 'message';
$mensaje = "EL SIGUIENTE FORMLUARIO LE PERMITIRÁ CONSULTAR LOS CERTIFICADOS DE INGRESOS Y RETENCIONES<br>
            - Digite el número de documento. <br>
             <br>
