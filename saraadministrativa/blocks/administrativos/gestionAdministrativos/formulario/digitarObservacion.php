...
$valorCodificado.="&opcion=certificadoRecursosHumanos";
$valorCodificado.="&usuario=".$_REQUEST['usuario'];
$valorCodificado.="&tipoCertificado=".$_REQUEST['tipoCertificado'];
...
$atributos["leyenda"] = "Registrar observación";
...
unset($atributos);
    ...
    //-------------Control Mensaje-----------------------
$tipo = 'message';
$mensaje = "- Digite la observación al certificado seleccionado, si no desea digitar observación, haga click en 'Continuar'.";
...
$atributos["titulo"]="Digite la observación para el certificado seleccionado.";
