...
class SqlregistrarFuncionario extends sql {
	var $miConfigurador;
	...
	function cadena_sql($tipo, $variable = "", $variable1 = "") {
		...
		switch ($tipo) {
			...
			case "buscarNombreDocente" :
				...
				$cadena_sql .= "FROM ";
				$cadena_sql .= "".$esquema.".docente_informacion ";
				$cadena_sql .= "WHERE ";
			...
			case "tipoDocumento" :
				...
				$cadena_sql .= "FROM ".$esquema.".tipo_identificacion ";
			...
			case "categoriaLibro" :
				...
				$cadena_sql .= "FROM ".$esquema.".categoria_libro ";
			...
			case "tipo_entidad" :
				...
				$cadena_sql .= "FROM ".$esquema.".tipo_entidad ";
			...
			case "tipo_titulo" :
				...
				$cadena_sql .= "FROM ".$esquema.".nivel_formacion ";
			...
			case "universidad" :
				...
				$cadena_sql .= "FROM ".$esquema.".universidades ";
			...
			case "facultad" :
				...
				$cadena_sql .= "FROM ".$esquema.".facultades ";
			...
			case "proyectos" :
				...
				$cadena_sql .= "FROM ".$esquema.".proyectocurricular ";
			...
			case "categoria" :
				...
				$cadena_sql .= "FROM ".$esquema.".item_parametro ";
