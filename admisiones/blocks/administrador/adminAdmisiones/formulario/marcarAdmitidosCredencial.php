...
if($cierto==1)
{
    ...
    $valorCodificado.="&opcion=marcarAdmitidosCredencial";
    ...
    $atributos["leyenda"] = "Marcar aspirantes admitidos y opcionados por No. de credencial";
    ...
    //---------------Inicio Formulario (<form>)--------------------------------
        ...
        unset($atributos);
         ...
         //-------------Control Mensaje-----------------------
        $tipo = 'message';
        $mensaje = "EL SIGUIENTE FORMLUARIO LE PERMITIRÁ MARCAR LOS ASPIRANTES ADMITIDOS Y OPCIONADOS POR No. DE CREDENCIAL,
