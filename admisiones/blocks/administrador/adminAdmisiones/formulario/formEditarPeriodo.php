...
$valorCodificado.="&opcion=editarPeriodo";
...
$atributos["leyenda"] = "Estado: ".$_REQUEST['estado'];
echo $this->miFormulario->marcoAgrupacion("inicio", $atributos);
unset($atributos);
////-------------------------------Mensaje-------------------------------------
$tipo = 'message';
$mensaje = "<span class='textoNegrita textoPequenno'>Periodo académico que va a cambiar el estado:<br>
            Año: ".$_REQUEST['anio']."<br>
            Periodo: ".$_REQUEST['per']."<br>
            Estado: ".$_REQUEST['estado']."</span>";
...
//---------------Inicio Formulario (<form>)--------------------------------
    ...
    $atributos["etiqueta"] = "Estado nuevo: ";
    //-----De donde rescatar los datos ---------
    $atributos["cadena_sql"] = $this->sql->cadena_sql("consultaEstados");
