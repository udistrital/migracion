...
$valorCodificado.="&opcion=procesarEditarTipIns";
$valorCodificado.="&usuario=".$_REQUEST['usuario'];
$valorCodificado.="&id_tipIns=".$_REQUEST['id_tipIns'];
...
unset($atributos);
    ...
    //-------------Control Mensaje-----------------------
$tipo = 'message';
$mensaje = "EL SIGUIENTE FORMLUARIO LE PERMITIRÁ EDITAR LOS TIPOS DE INSCRIPCIÓN.<br>
            - Digite el nombre del tipo de inscripción.<br>
            - Digite el número del tipo de inscripción.<br>
...
//---------------Inicio Formulario (<form>)--------------------------------
    ...
    //-------------Control cuadroTexto-----------------------
    $esteCampo="nombreTipInsNuevo";
    $atributos["id"]=$esteCampo;
    $atributos["etiqueta"]=$this->lenguaje->getCadena($esteCampo);
    $atributos["titulo"]="Nombre del tipo de inscripción.";
    ...
    $atributos["valor"]=$_REQUEST['nombreTipIns'];
    $atributos["categoria"]="";
    echo $this->miFormulario->campoCuadroTexto($atributos);
    unset($atributos);
    
    //-------------Control cuadroTexto-----------------------
    $esteCampo="numeroTipInsNuevo";
    $atributos["id"]=$esteCampo;
    $atributos["etiqueta"]=$this->lenguaje->getCadena($esteCampo);
    ...
    $atributos["valor"]=$_REQUEST['numeroTipIns'];
    $atributos["categoria"]="";
    echo $this->miFormulario->campoCuadroTexto($atributos);
    unset($atributos);
