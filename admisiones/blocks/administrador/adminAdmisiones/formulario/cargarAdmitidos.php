...
if($cierto==1)
{
    ...
    $atributos["leyenda"] = "Carga de aspirantes admitidos y opcionados";
    ...
    //---------------Inicio Formulario (<form>)--------------------------------
        ...
        unset($atributos);
         ...
         //-------------Control Mensaje-----------------------
        $tipo = 'message';
        $mensaje = "EL SIGUIENTE FORMLUARIO LE PERMITIRÁ CARGAR AL SISTEMA LOS ASMIRANTES ADMITIDOS Y OPCIONADOS PARA EL PROCESO DE ADMISONES,
