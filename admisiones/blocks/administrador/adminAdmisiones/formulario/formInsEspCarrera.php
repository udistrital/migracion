...
$atributos["leyenda"] = "Inscritos Especiales Proyecto Curricular ".$registro[0]["asp_cra_cod"];
...
if($registro)
{
    //-------------Control Mensaje-----------------------
    $tipo = 'message';
    $mensaje = "<b>".count($registro)."</b> inscripciones especiales, periodo académico ".$variable['anio']." - ".$variable['periodo'].",  para la carrera ".$registro[0]["asp_cra_cod"]."";
    ...
    for($i=0;$i<count($registro);$i++)
    {
        ...
        echo "<tr>
            ...
            <td align='center'>";
                ...
                $atributos["etiqueta"] = " ";
                $atributos["seleccion"] = $registro[$i]["ti_id"]."-".$variable['Idacasp']."-".$variable['id'];
                //-----De donde rescatar los datos ---------
                $atributos["cadena_sql"] = $this->sql->cadena_sql("tiposInscripcionEspeciales",$variable);
