...
$valorCodificado.="&opcion=guardarLocalidades";
...
$atributos["leyenda"] = "Actalización de localidades";
...
unset($atributos);
    ...
    //-------------Control Mensaje-----------------------
$tipo = 'message';
$mensaje = "EL SIGUIENTE FORMLUARIO LE PERMITIRÁ ACTUALIZAR LAS LOCALIDADES, PARA EL PROCESO DE INSCRIPCIÓN DE ADMISIONES PARA EL PERIODO ACADÉMICO: ".$variable['anio']."-".$variable['periodo'].".<br>
...
$variables.="&opcion=copiarLocalidades";
...
echo "<hr/>";
echo "<hr />";
echo "Loacalidades registradas en el sistema:";
...
{	
    ...
    for($i=0;$i<count($registro);$i++)
    {
        ...
        $variable.="&opcion=editarLocalidad";
        $variable.="&usuario=". $_REQUEST['usuario'];
        $variable.="&id_localidad=".$registro[$i][0];
        $variable.="&numero=".$registro[$i][1];
        $variable.="&localidad=".$registro[$i][2];
