...
$valorCodificado.="&opcion=procesarEditarMedios";
$valorCodificado.="&usuario=".$_REQUEST['usuario'];
$valorCodificado.="&id_medio=".$_REQUEST['id_medio'];
...
unset($atributos);
    ...
    //-------------Control Mensaje-----------------------
$tipo = 'message';
$mensaje = "EL SIGUIENTE FORMLUARIO LE PERMITIRÁ ACTUALIZAR EL MEDIO POR EL CUAL EL ASPIRANTE SE ENTERÓ DE LA UNIVERSIDAD.<br>
            - Digite el medio.<br>
...
//---------------Inicio Formulario (<form>)--------------------------------
    ...
    //-------------Control cuadroTexto-----------------------
    $esteCampo="medioNuevo";
    $atributos["id"]=$esteCampo;
    $atributos["etiqueta"]=$this->lenguaje->getCadena($esteCampo);
    $atributos["titulo"]="Medio por el cual el aspirante se enteró de la Universidad";
