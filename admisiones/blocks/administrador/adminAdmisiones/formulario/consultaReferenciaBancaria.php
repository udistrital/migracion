...
$valorCodificado.="&opcion=consultarReferenciaBancaria";
...
$tipo = 'message';
$mensaje = "<center><h3>CONSULTA DE REFERENCIAS BANCARIAS REPORTADAS POR EL BANCO 
    <br>".$periodo." PERIODO ACADÉMICO ".$variable['anio']."<br></h3></center>
            - Digite el número de referencia bancaria o el número de identificación.<br>
    ...
    if($registro)
    {
        ...
        for($i=0;$i<count($registro);$i++)
        {
            echo "<tr>
                    ...
                    <td align='center'>".$registro[$i]['rba_ref_pago']."</td>
