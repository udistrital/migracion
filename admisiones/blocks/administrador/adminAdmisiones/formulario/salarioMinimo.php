...
$atributos["leyenda"] = "Actalización de salaio mínimo";
...
echo "Salarios registrados en el sistema:<hr />";
...
$cadena_sql = $this->sql->cadena_sql("buscarSalMin", "");
...
{	
    ...
    for($i=0;$i<count($registro);$i++)
    {
        ...
        $variable.="&opcion=editarSalMin";
        $variable.="&usuario=". $_REQUEST['usuario'];
        $variable.="&id_salmin=".$registro[$i][0];
        $variable.="&anio=".$registro[$i][1];
        $variable.="&valor=".$registro[$i][2];
        $variable.="&porcentaje=".$registro[$i][3];
        $variable.="&estado=".$registro[$i][4];
