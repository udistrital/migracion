...
$valorCodificado.="&opcion=guardarTipInscripcion";
...
$atributos["leyenda"] = "Registro de tipos de inscripción.";
...
unset($atributos);
    ...
    //-------------Control Mensaje-----------------------
$tipo = 'message';
$mensaje = "EL SIGUIENTE FORMLUARIO LE PERMITIRÁ REGISTRAR LOS TIPOS DE INSCRIPCIÓN, PARA EL PROCESO DE INSCRIPCIÓN DE ADMISIONES PARA EL PERIODO ACADÉMICO: ".$variable['anio']."-".$variable['periodo'].".<br>
            - Digite código del tipo de inscripción.<br>
            - Digite el nombre del tipo de inscripción.<br>
...
$atributos["titulo"]="Número del tipo de inscripción.";
...
echo "Tipos de inscripción registrados en el sistema:<hr />";
...
{	
    ...
    for($i=0;$i<count($registro);$i++)
    {
        ...
        $variable.="&opcion=editarTipInscripcion";
        $variable.="&usuario=". $_REQUEST['usuario'];
        $variable.="&tipo=".$_REQUEST['tipo'];
        $variable.="&id_tipIns=".$registro[$i][0];
        $variable.="&numeroTipIns=".$registro[$i][1];
        $variable.="&nombreTipIns=".$registro[$i][2];
