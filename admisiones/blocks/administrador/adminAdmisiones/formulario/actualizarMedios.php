...
$valorCodificado.="&opcion=guardarMedio";
...
unset($atributos);
    ...
    //-------------Control Mensaje-----------------------
$tipo = 'message';
$mensaje = "EL SIGUIENTE FORMLUARIO LE PERMITIRÁ ACTUALIZAR LOS MEDIOS POR LOS CUALES EL ASPIRANTE SE ENTERÓ DE LA UNIVERSIDAD.<br>
            - Medio: Medios por el cuál el aspirante se enteró de la universidad (Prensa, Radio, Amigo, etc..).<br>
