...
if($cierto==1)
{
    ...
    $valorCodificado.="&opcion=marcarAdmitidos";
    ...
    $atributos["leyenda"] = "Marcar aspirantes admitidos y opcionados";
    ...
    //---------------Inicio Formulario (<form>)--------------------------------
        ...
        unset($atributos);
         ...
         //-------------Control Mensaje-----------------------
        $tipo = 'message';
        $mensaje = "EL SIGUIENTE FORMLUARIO LE PERMITIRÁ MARCAR LOS ASPIRANTES ADMITIDOS Y OPCIONADOS PARA EL PROCESO DE ADMISONES,
        ...
        $atributos["etiqueta"] = "Seleccione el Proyeto Curricular: ";
        ...
        $atributos["anchoEtiqueta"] = 250;
        $atributos["obligatorio"] = true;
        $atributos["etiqueta"] = "Seleccione el Tipo de ICFES: ";
        //-----De donde rescatar los datos ---------
        $atributos["cadena_sql"] = array(array("N","NUEVO"), array("A","ANTERIOR"), array("V","VIEJO"));
        $atributos["baseDatos"] = "aspirantes";
        echo $this->miFormulario->campoCuadroLista($atributos);
        unset($atributos);
        ...
        $atributos["anchoEtiqueta"] = 250;
        $atributos["obligatorio"] = true;
        $atributos["etiqueta"] = "Seleccione el estado de admisión: ";
        //-----De donde rescatar los datos ---------
        $atributos["cadena_sql"] = array(array("A","ADMITIDO"), array("O","OPCIONADO"), array("N","NO ADMITIDO"));
        $atributos["baseDatos"] = "aspirantes";
        echo $this->miFormulario->campoCuadroLista($atributos);
        unset($atributos);
        
        //-------------Control cuadroTexto-----------------------
        $esteCampo="rangoInferior";
        $atributos["id"]=$esteCampo;
        ...
        $atributos["estilo"]="jqueryui";
        $atributos["obligatorio"] = true;
        $atributos["validar"]="required,min[0]";
    ...
    if(isset($_REQUEST["mensaje"])=="registroExitoso"){
        ...
        $atributos["mensaje"] ="REGISTRO EXITOSO!!!";
        echo $this->miFormulario->cuadroMensaje($atributos);
        unset($atributos);
    }
}
