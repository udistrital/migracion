    ...
    {   
        ...
        else
        {
            ...
            else
            {
                ...
                if($registro==true)
                {
                    $variable[6]=$_REQUEST['usuario'];
                    $variable[0]="INSCRIBIR";
                    $variable[1]=$variable['rba_id']; //
                    $variable[2]="Realiza inscripción";
                    $variable[3]="Realizar inscripción a admisiones acaspw"; //
                    $variable[4]=time();
                    $variable[5]="Realiza inscripción al módulo de admisones acaspw ";
                    $variable[5].="Periodo académico: ".$variable['id_periodo'];
        ...
        if($_REQUEST['evento']==2 || $_REQUEST['evento']==3)
        {
            ...
            {    
                ...
                if($registro==true)
                {
                    ...
                    $variable[1]=$variable['rba_id']; //
                    $variable[2]="Realiza inscripción";
                    $variable[3]="Realizar inscripción a admisiones reingreso"; //
                    $variable[4]=time();
                    $variable[5]="Realiza inscripción al módulo de admisones Reingreso ";
                    $variable[5].="Periodo académico: ".$variable['id_periodo'];
    ...
    if(isset($_REQUEST['carreras']) && $_REQUEST['evento']==4)
    {
        ...
        {    
            ...
            if($registro==true)
            {
                ...
                $variable[1]=$variable['rba_id']; //
                $variable[2]="Realiza inscripción";
                $variable[3]="Realizar inscripción a admisiones transferencia"; //
                $variable[4]=time();
                $variable[5]="Realiza inscripción al módulo de admisones Transferencia ";
                $variable[5].="Periodo académico: ".$variable['id_periodo'];
