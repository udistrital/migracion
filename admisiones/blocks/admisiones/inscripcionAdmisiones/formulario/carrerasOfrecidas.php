...
if($cierto==1)
{
    ...
    //---------------Inicio Formulario (<form>)--------------------------------
        ...
        {
            $valor['carrerasNoOfrecidas']="(273,275,277,378,373,383,279,283,372,375,377,579,678)";
            $nota="NOTA: Las inscripciones a los programas de ciclo profesional de ingenierias de la facultad tecnológica se realizan en la opción 'INGRESO A PRIMER SEMESTRE'.";
        }
        else
        {
            $valor['carrerasNoOfrecidas']="(0)";
            $nota="";
        }   
         //-------------Control Mensaje-----------------------
        $tipo = 'message';
        $mensaje = "<H3><center>PROCESO DE ADMISIONES  ".$periodo." PERIODO ACADÉMICO ".$variable['anio']."</p>
                    SELECCIONE LA CARRERA A LA QUE SE INSCRIBE</p></H3>".$nota."</center>";
        ...
        $atributos["cadena_sql"] = $this->sql->cadena_sql("carrerasOfrecidas",$valor);
