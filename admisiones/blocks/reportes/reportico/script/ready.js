...
var $formValidar = $("#resultados");
        // Asociar el widget de validación al formulario
        
 $("#resultados").validationEngine({
            promptPosition : "centerRight", 
            scroll: false
        });

$(function() {
    $("#resultados").submit(function() {
        var resultado=$("#resultados").validationEngine("validate");
        if (resultado) {
