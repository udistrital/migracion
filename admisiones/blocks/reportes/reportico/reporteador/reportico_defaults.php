    ...
    function reportico_defaults($reportico)
    {
            ...
            */
            ...
            {   
                ...
                $reportico->create_page_footer("F1", 2, "Impreso por: ".$user." Sistema de Gestión Académica - ADMISIONES {STYLE border-width: 1 0 0 0; margin: 40 0 0 0; font-size: 8; text-align: left; font-style: italic; }" );
                $reportico->create_page_footer("F2", 2, "Página: {PAGE}{STYLE border-width: 1 0 0 0; margin: 40 0 0 0; font-style: italic; }" );
                $reportico->create_page_footer("F3", 2, "Fuente de datos: Sistema de Gestión Académica {STYLE border-width: 1 0 0 0; margin: 40 0 0 0; font-size: 8; text-align: right; font-style: italic; }" );
            }
            else   // FPDF page headers
            {
                ...
                // Create Page No on bottom of PDF page
                $reportico->create_page_footer("F1", 1, "Impreso por: Sistema de Gestión Académica - ADMISIONES {STYLE font-size: 8; text-align: left; font-style: italic; }" );
                $reportico->create_page_footer("F2", 1, "Pag: {PAGE}{STYLE border-width: 1 0 0 0; margin: 40 0 0 0; font-style: italic; }" );
                $reportico->create_page_footer("F3", 1, "Fuente de datos: Sistema de Gestión Académica {STYLE border-width: 1 0 0 0; margin: 40 0 0 0; font-size: 8; text-align: right; font-style: italic; }" );
