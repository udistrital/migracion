...
define('SW_PROJECT_PASSWORD', 'prueba');
...
define('SW_PROJECT_TITLE', 'esto esuna prueba');
...
define('SW_DB_USER', 'soporteJNG');
define('SW_DB_PASSWORD', 'abc123');
define('SW_DB_HOST', '10.20.0.38');
define('SW_DB_DATABASE', 'saraadmisiones');
}
