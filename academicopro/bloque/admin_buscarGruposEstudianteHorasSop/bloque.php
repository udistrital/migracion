...
class bloque_adminBuscarGruposEstudianteHorasSop extends bloque {

  private $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarGruposEstudianteHorasSop();
    $this->funcion = new funcion_adminBuscarGruposEstudianteHorasSop($configuracion, $this->sql);
  }
  ...
  function action() {
    switch ($_REQUEST['opcion']) {
      ...
      case "adicionar":
        ...
        $variable = "pagina=admin_buscarGruposEstudianteHorasSop";
...
$esteBloque = new bloque_adminBuscarGruposEstudianteHorasSop($configuracion);
