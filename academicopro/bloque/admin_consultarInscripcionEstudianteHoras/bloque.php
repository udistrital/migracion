...
//Clase
class bloque_adminConsultarInscripcionEstudianteHoras extends bloque {
  ...
  public function __construct($configuracion) {
    ...
    $this->tema = $tema;
    $this->funcion = new funcion_adminConsultarInscripcionEstudianteHoras($configuracion);
...
$esteBloque = new bloque_adminConsultarInscripcionEstudianteHoras($configuracion);
