		...
		<table border="0" cellpadding="10" cellsapcing="0">
		  <tbody>
		    	<tr class="bloquecentralcuerpo">
		      	<td>
		     	En este momento el sistema de base de datos se encuentra congestionado. Por favor intente la acci&oacute;n
		     	dentro de algunos minutos.<br>
		     	Si el problema es recurrente por favor comunique el caso al administrador del sistema:<br>
		     	<?echo $configuracion["correo"]?><br>
