        ...
        switch($tipo) {
            ...
            //Oracle
              case 'consultar_recibos_estudiante':
                ...
                $cadena_sql.=" CASE WHEN ema_ano_pago is null then ema_ano ELSE ema_ano_pago END ANIO_PAGO,";
                $cadena_sql.=" CASE WHEN ema_per_pago is null then ema_per ELSE ema_per_pago END PERIODO_PAGO,";
                $cadena_sql.=" 0 PRIMER_SEMESTRE";
                ...
                $cadena_sql.=" AMA_OBS,";
                $cadena_sql.=" CASE WHEN AMA_ANO_PAGO is null then AMA_ANO ELSE AMA_ANO_PAGO END ANIO_PAGO,";
                $cadena_sql.=" CASE WHEN AMA_PER_PAGO is null then AMA_PER ELSE AMA_PER_PAGO END PERIODO_PAGO,";
                $cadena_sql.=" 1 PRIMER_SEMESTRE";
                ...
                $cadena_sql.=" ORDER BY 1 desc, 2 DESC, 7 asc, 9";
...
//                $cadena_sql.=" ema_cuota ";
             ...
             case 'consultar_conceptos_primer_recibo':
                $cadena_sql=" SELECT aer_ano, ";
                $cadena_sql.=" aer_secuencia,";
                $cadena_sql.=" aer_bancod, ";
                $cadena_sql.=" aer_refcod, ";
                $cadena_sql.=" aer_valor";
                $cadena_sql.=" FROM acrefadm ";
                $cadena_sql.=" WHERE aer_secuencia =".$variable['secuencia'];
                $cadena_sql.=" AND aer_ano=".$variable['anio'];
                 break;
