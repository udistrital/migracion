...
class sql_registroRegistrarEntregaDerechosPecuniarios extends sql {
    ...
    function cadena_sql($opcion,$variable="") {
        ...
        switch($opcion) {
            ...
            case 'adicionar_entrega':
                    ...
                    $cadena_sql="INSERT INTO sga_recibos_der_pecuniarios ";
                    $cadena_sql.="(";
                    $cadena_sql.=" rpe_anio,";
                    $cadena_sql.=" rpe_per,";
                    $cadena_sql.=" rpe_secuencia,";
                    $cadena_sql.=" rpe_est_cod,";
                    $cadena_sql.=" rpe_valor,";
                    $cadena_sql.=" rpe_cod_concepto,";
                    $cadena_sql.=" rpe_concepto,";
                    $cadena_sql.=" rpe_entregado,";
                    $cadena_sql.=" rpe_fecha_entregado,";
                    $cadena_sql.=" rpe_fecha_registro,";
                    $cadena_sql.=" rpe_estado";
                    $cadena_sql.=") ";
                    $cadena_sql.="VALUES (";
                    ...
                    $cadena_sql.=" ".$variable['COD_CONCEPTO'].",";
                    $cadena_sql.=" '".$variable['CONCEPTO']."',";
                    $cadena_sql.=" 'SI',";
                    $cadena_sql.=" '".$variable['FECHA_ENTREGA']."',";
                    $cadena_sql.=" '".  date('Y-m-d H:m:s')."',";
                    $cadena_sql.=" '1')";
                break;
            ...
            case 'consultar_recibo_derecho_pecuniario':
                ...
                $cadena_sql.=" AND aer_refcod in (5,6,8,9,10)";
