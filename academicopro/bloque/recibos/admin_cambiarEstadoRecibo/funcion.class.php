...
/**
 * Funcion admin_cambiarEstadoRecibo
 *
...
/**
 * Clase funcion_adminCambiarEstadoRecibo
 *
 * Clase que contiene los métodos que ejecutan tareas y crean los formularios de la pagina del bloque.
 * @package admin_cambiarEstadoRecibo
 * @subpackage Admin
 */
class funcion_adminCambiarEstadoRecibo extends funcionGeneral {

  public $configuracion;
  public $accesoOracle;

  /**
     * Método constructor que crea el objeto sql de la clase funcion_adminCambiarEstadoRecibo
     *
    ...
    function __construct($configuracion) {
        ...
        $this->formulario = "admin_cambiarEstadoRecibo";//nombre del BLOQUE que procesa el formulario
        $this->bloque = "recibos/admin_cambiarEstadoRecibo";//nombre del BLOQUE que procesa el formulario
...
<?
           ...
           */
                ...
                if(is_array($datos_estudiante)){
                    ...
                    if(is_array($recibos)){
                        ...
                        if($tipoBusqueda=='identificacion'){
                            echo "<br>Identificaci&oacute;n de estudiante no valida";
                            exit;
                        }else{
                            echo "<br>C&oacute;digo de estudiante no valido";
                            exit;
                        }
                    }
        }else{
	...
	foreach ($recibos as $key => $recibo) {
                ...
                $variable2.="&usuario=".$this->usuario;
                $variable2.="&opcion=solicitarConfirmacion";
                ...
                if($recibo['ESTADO']=='I' && $this->nivel==80){
                    $variable2.="&operacion=activar";
                    $variable2=$this->cripto->codificar_url($variable2,$this->configuracion);
                
                    $html .="<td class='cuadro_plano centrar'><a href='".$indice_academico.$variable2."'>Activar</a></td>";
                }elseif($recibo['ESTADO']=='A' && $this->nivel==80 && $recibo['REALIZO_PAGO']!='SI'){
                    $variable2.="&operacion=inactivar";
                    $variable2=$this->cripto->codificar_url($variable2,$this->configuracion);
                
                    $html .="<td class='cuadro_plano centrar'><a href='".$indice_academico.$variable2."'>Inactivar</a></td>";
                }else{
...
?>
  ...
  <?          }
     ...
     *
     */
    function solicitarConfirmacionCambioEstado() {
        ?>
            ...
            <tr class="texto_subtitulo">
              <td align="center">
                  <?
                    ...
                    $enlace=$this->encriptarEnlace($opciones,"confirmarCambio");
    ...
    function mensajesConfirmacion() {
            ?>
            <br>
            <br> ¿Esta seguro de cambiar el estado al recibo con secuencia <? echo $_REQUEST['secuencia'];?>,  año <? echo $_REQUEST['anioRecibo'];?> del estudiante con código <? echo $_REQUEST['codEstudiante'];?>?<?
 ...
 /**
    ...
    function cancelarConfirmacion() {
     ...
     /**
     * Esta funcion se utiliza para retornar cuando se cancela la modificacion
    ...
    function enlaceNoCancelar($mensaje='')
    {
        ...
        $variable.="&tipoBusqueda=codigo";
        $variable.="&datoBusqueda=".$_REQUEST['codEstudiante'];
