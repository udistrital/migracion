<?
/**
 * Bloque admin_consultarRecibosPecuniariosFuncionario
 *
...
/**
 * Clase funcion.class.php del bloque_adminConsultarRecibosPecuniariosFuncionario
 *
 * Clase que contiene toda la logica del bloque y muestra la interfaz al usuario
 */
include_once("funcion.class.php");
/**
 * Clase sql.class.php del bloque admin_consultarRecibosPecuniariosFuncionario
 *
 ...
 * @subpackage Admin
 */
class bloque_adminConsultarRecibosPecuniariosFuncionario extends bloque
{
  private  $configuracion;
        /**
         * Funcion constructor del bloque bloque_adminConsultarRecibosPecuniariosFuncionario
         *
         * Esta funcion permite instanciar las clases funcion y sql del bloque bloque_adminConsultarRecibosPecuniariosFuncionario
         *
         * @access public
        ...
        public function __construct($configuracion)
	{
           ...
           $this->funcion=new funcion_adminConsultarRecibosPecuniariosFuncionario($configuracion);
	...
	/**
         ...
         *
         * Esta funcion redirije a las funciones que contiene la clase funcion.class.php que se encuentra en el bloque bloque_adminConsultarRecibosPecuniariosFuncionario,
...
/**
 * Crea un nuevo objeto de la clase bloque_adminConsultarRecibosPecuniariosFuncionario
 *
 * Se instancia la clase bloque_adminConsultarRecibosPecuniariosFuncionario y se envia a la funcion que se necesita dependiendo si existe la variable $_REQUEST['action'] o no
 */
$obj_aprobar=new bloque_adminConsultarRecibosPecuniariosFuncionario($configuracion);
