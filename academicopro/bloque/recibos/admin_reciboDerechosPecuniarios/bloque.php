...
//Clase
class bloque_adminGenerarReciboDerechosPecuniarios extends bloque {
  ...
  public function __construct($configuracion) {
    ...
    //$this->tema = $tema;
    $this->funcion = new funcion_adminGenerarReciboDerechosPecuniarios($configuracion);
  ...
  function html() {
    ...
    switch ($_REQUEST['opcion']) {
      ...
      case "nuevo":
        $this->funcion->mostrarFormularioReciboDerechos();
        break;
      
      case "validar":
        $this->funcion->mostrarDatosReciboDerechos();
  ...
  function action() {
    switch ($_REQUEST['opcion']) {
        ...
        case "registrar":
            $pagina = $this->configuracion["host"] . $this->configuracion["site"] . "/index.php?";
            $variable = "pagina=registro_generarReciboDerechosPecuniarios";
            $variable.="&opcion=adicionar";
            $variable.="&tipoRecibo=".$_REQUEST['tipoRecibo'];
...
$esteBloque = new bloque_adminGenerarReciboDerechosPecuniarios($configuracion);
