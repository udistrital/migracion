...
//Clase
class bloque_adminInscripcionEstudianteCoorPosgrado extends bloque
{
...
//		$this->tema=$tema;
		$this->funcion=new funcion_adminInscripcionEstudianteCoorPosgrado($configuracion);
...
$obj_aprobar=new bloque_adminInscripcionEstudianteCoorPosgrado($configuracion);
