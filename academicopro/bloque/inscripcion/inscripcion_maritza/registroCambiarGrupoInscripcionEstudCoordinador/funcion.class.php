                            ...
                            <tr>
                                <td>
                                    <table width="100%" border="0" align="center" cellpadding="5 px" cellspacing="1px" >
                                        ...
                                        <td><center><?echo "Proyecto Curricular: ".$variables[1]."<br>".$codEspacio." - ".htmlentities(utf8_decode($nombre));?></center></td>
                                        </thead>
                                        <tr>
                                            <td>
                ...
                for($j=0;$j<count($resultado_grupos);$j++){
                    ...
                    for($i=1; $i<8; $i++)
                    {
                        ...
                        for ($k=0;$k<count($resultado_horarios);$k++)
                        {
                           ...
                           if ($resultado_horarios[$k]['DIA']==$i && $resultado_horarios[$k]['DIA']==$resultado_horarios[$k+1]['DIA'] && $resultado_horarios[$k+1]['SEDE']==($resultado_horarios[$k][1]+1) && (isset($resultado_horarios[$k+1]['SALON'])?$resultado_horarios[$k+1]['SALON']:'')==($resultado_horarios[$k]['SALON']))
                            {
                                $l=$k;
    ...
    <tbody>
        <tr>
            <td>
                <table width="100%" border="0" align="center" cellpadding="5 px" cellspacing="1px" >
                    <thead class='texto_subtitulo centrar'>
                    <td><center><?echo $espacio." - ".htmlentities(utf8_decode($nombre))."<br>Proyecto Curricular: ".$variables[5]?></center></td>
                    </thead>
                    <tr>
                        <td>
                            <table class='contenidotabla'>
