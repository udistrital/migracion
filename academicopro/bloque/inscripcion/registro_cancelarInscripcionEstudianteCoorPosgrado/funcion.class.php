...
class funcion_registroCancelarInscripcionEstudianteCoorPosgrado extends funcionGeneral {
...
//Crea un objeto tema y un objeto SQL.
    function __construct($configuracion, $sql)
    {
        ...
        //Datos de sesion
        $this->formulario="registro_cancelarInscripcionEstudianteCoorPosgrado";
        $this->bloque="inscripcion/registro_cancelarInscripcionEstudianteCoorPosgrado";
    ...
    function verificarCancelacionEspacio()
    {
      ...
      //solicitar confirmacion
        $this->solicitarConfirmacion((isset($mensaje)?$mensaje:''));
    }
      ...
      <table border='0' width='90%' cellpadding="2" cellspacing="2" align="center">
          <tr class="texto_subtitulo">
              ...
              if (isset($mensaje))
                ...
                <br><br> ¿Est&aacute; seguro que desea cancelar <b><? echo $_REQUEST['nombreEspacio'] ?></b>?
              </td>
          </tr>
    ...
    */
    function cancelarCreditos() {
        ...
        //las siguientes lineas se modifican para permitir cancelar espacios inscritos en otros proyectos mediante cancelacion por estudiante.
        //Milton Parra 02/09/2014
        if ($_REQUEST['retorno']=='admin_consultarInscripcionEstudianteCoorPosgrado')
        {
            $proyecto_valido = 1;
        }else{
                $proyectos = $this->consultarProyectos($this->identificacion);
                $proyecto_valido = $this->validarProyecto($proyectos, $_REQUEST['carrera']);
        }
        //hasta aqui modificacion
        if($proyecto_valido==1){
                ...
                $retorno['mensaje']='El proyecto curricular no es valido para el usuario';
                $_REQUEST['retorno']='admin_inscripcionCoordinadorPosgrado';
                $_REQUEST['opcionRetorno']='verProyectos';
    ...
    *                           codEspacio,grupo,retorno,opcionRetorno)
    ...
    function consultarProyectos($identificacion){
            ...
            return $resultado_bloquePublicado=$this->ejecutarSQL($this->configuracion, $this->accesoOracle, $cadena_sql,"busqueda" );
    }
