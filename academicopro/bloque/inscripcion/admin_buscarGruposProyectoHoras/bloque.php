...
class bloque_adminBuscarGruposProyectoHoras extends bloque {

  private $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarGruposProyectoHoras();
    $this->funcion = new funcion_adminBuscarGruposProyectoHoras($configuracion, $this->sql);
  }
  ...
  function action() {
      ...
      case "adicionar":
        ...
        $variable.="&nivel=" . (isset($_REQUEST["nivel"])?$_REQUEST["nivel"]:0);
...
$esteBloque = new bloque_adminBuscarGruposProyectoHoras($configuracion);
