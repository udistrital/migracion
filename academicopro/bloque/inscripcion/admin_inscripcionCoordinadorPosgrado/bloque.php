<?
/**
 * Bloque adminInscripcionCoordinadorPosgrado
 *
...
/**
 * Clase funcion.class.php del bloque adminInscripcionCoordinadorPosgrado
 *
 * Clase que contiene toda la logica del bloque y muestra la interfaz al usuario
 */
include_once("funcion.class.php");
/**
 * Clase sql.class.php del bloque adminInscripcionCoordinadorPosgrado
 *
 ...
 * @subpackage Admin
 */
class bloque_adminInscripcionCoordinadorPosgrado extends bloque
{
  private $configuracion;

  /**
         * Funcion constructor del bloque adminInscripcionCoordinadorPosgrado
         *
         * Esta funcion permite instanciar las clases funcion y sql del bloque adminInscripcionCoordinadorPosgrado
         *
         * @access public
	 ...
	 public function __construct($configuracion)
	{
            ...
            $this->funcion=new funcion_adminInscripcionCoordinadorPosgrado($configuracion);
	...
	/**
         ...
         *
         * Esta funcion redirije a las funciones que contiene la clase funcion.class.php que se encuentra en el bloque adminInscripcionCoordinadorPosgrado,
...
/**
 * Crea un nuevo objeto de la clase bloque_adminInscripcionCoordinadorPosgrado
 *
 * Se instancia la clase bloque_adminInscripcionCoordinadorPosgrado y se envia a la funcion que se necesita dependiendo si existe la variable $_REQUEST['action'] o no
 */
$obj_aprobar=new bloque_adminInscripcionCoordinadorPosgrado($configuracion);
