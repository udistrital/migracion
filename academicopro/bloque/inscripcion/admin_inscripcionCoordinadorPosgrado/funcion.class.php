...
<?
    ...
    function verProyectos()
    {
         ...
         */
    	switch($_REQUEST['tipoUser']){
			case '110':
				$cadena_sql_proyectos=$this->sql->cadena_sql("proyectos_curriculares_asistente",$this->usuario);
				
				break;
			default:
				$cadena_sql_proyectos=$this->sql->cadena_sql("proyectos_curriculares_coordinador",$this->usuario);
