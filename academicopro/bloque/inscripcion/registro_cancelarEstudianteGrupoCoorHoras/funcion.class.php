...
//Crea un objeto tema y un objeto SQL.
    function __construct($configuracion, $sql)
    {
        ...
        $this->bloque="inscripcion/registro_cancelarEstudianteGrupoCoorHoras";
              ...
              if ($reprobado=='ok')
              {
              ...
              else
                {
                  ...
                  $variablesRegistro=array('usuario'=>$this->usuario,
                                      ...
                                      'registro'=>$this->ano."-".$this->periodo.", ".$_REQUEST['codEspacio'].",".$_REQUEST['id_grupo'].", 0, ".$_REQUEST['planEstudio'].", ".$_REQUEST['codProyecto'],
                  ...
                  else
                  {
                    $variablesRegistro=array('usuario'=>$this->usuario,
                                      ...
                                      'registro'=>$this->ano."-".$this->periodo.", ".$_REQUEST['codEspacio'].",0, ".$_REQUEST['id_grupo'].", ".$_REQUEST['planEstudio'].", ".$_REQUEST['codProyecto'],
                                      'afectado'=>$_REQUEST['codEstudiante']);
                    $this->procedimiento->registrarEvento($variablesRegistro);
