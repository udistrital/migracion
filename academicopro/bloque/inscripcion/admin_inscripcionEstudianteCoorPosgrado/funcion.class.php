...
//    $this->tema = $tema;
    ...
    $this->bloque = "inscripcion/admin_inscripcionEstudianteCoorPosgrado";
...
<?
  ...
  function validarEstudiante() {
    ...
    {        
        if((trim($validacion['creditos'])=='S')&&($validacion['nivel']==1||is_null($validacion['nivel'])))
        {
//          echo "creditos pre";exit;
          $variable = "pagina=adminConsultarInscripcionEstudianteCoordinador";
        }
        elseif((trim($validacion['creditos'])=='N')&&($validacion['nivel']==1||is_null($validacion['nivel'])))
        {
//          echo "horas pre";exit;
          $variable = "pagina=admin_consultarInscripcionEstudianteCoorHoras";
        }
        elseif(in_array($validacion['nivel'],range(2,4)))
        {
