...
class funcion_registroCambiarGrupoEstudianteCoorHoras extends funcionGeneral
{
    ...
    function cambiarGrupo() {
        ...
        if($cambioOracle>=1)
        {
                ...
                $variablesRegistro=array('usuario'=>$this->usuario,
                                          ...
                                          'registro'=>$this->ano."-".$this->periodo.", ".$_REQUEST['codEspacio'].",".$_REQUEST['id_grupo'].",".$grupo.", ".$_REQUEST['planEstudio'].", ".$_REQUEST['carrera'],
