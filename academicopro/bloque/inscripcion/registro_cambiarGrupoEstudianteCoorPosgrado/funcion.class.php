...
class funcion_registroCambiarGrupoEstudianteCoorPosgrado extends funcionGeneral
{
  ...
  //Crea un objeto tema y un objeto SQL.
    ...
    function cambiarGrupo() {
        ...
        if($proyecto_valido==1 && $proyecto_valido_coordinador==1){  
                ...
                $retorno['parametros'].="&nivel=".$_REQUEST['nivel'];
                ...
                echo "<script>alert ('Proyecto curricular no valido para el usuario');</script>";
                $pagina=$this->configuracion["host"].$this->configuracion["site"]."/index.php?";
