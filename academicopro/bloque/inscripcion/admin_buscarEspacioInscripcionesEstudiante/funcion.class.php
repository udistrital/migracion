...
class funcion_adminBuscarEspacioInscripcionesEstudiante extends funcionGeneral {      //Crea un objeto tema y un objeto SQL.
  ...
  private $espaciosNoInscribir;
    ...
    $this->bloque = "inscripcion/admin_buscarGruposProyectosEstudiante";
                    ...
                    if($nivel==$espacio['NIVEL'])
                    {
                        ...
                        if ($nombreObservacion=='Adicionar')
                        {
                            if (trim($this->datosEstudiante[0]['TIPO_ESTUDIANTE']) == 'S')
                            {
                                ...
                                ?>
                                <div class='cuadro_plano_centrar' style="width:<?echo $ancho;?>"><? echo (isset($espacio['CREDITOS'])?$espacio['CREDITOS']:'');?></div>            
                            <?
                            }
...
<?
     ...
     * Se hacen ajustes para nuevas tablas y nuevos bloques dentro del framework /05/06/2013 ($this->bloque)
    ...
    function enlaceAdicionar($espacio) {
                  ...
                  $parametros.="&nivel=" . $espacio['NIVEL'];
