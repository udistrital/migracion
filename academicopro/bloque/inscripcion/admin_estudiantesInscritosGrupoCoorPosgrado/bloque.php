 ...
 * @subpackage Consulta
 */
class bloque_estudiantesInscritosGrupoCoordinadorPosgrado extends bloque
{
  ...
  /**
	...
	{	
		...
		//$this->tema=$tema;
		$this->funcion=new funcion_estudiantesInscritosGrupoCoordinadorPosgrado($configuracion);
				...
				break;
                              ...
                              case "procesar":
                                ...
                                if (isset ($_REQUEST['cancelar_x']))
                                  {
                                    $pagina=  $this->configuracion["host"].  $this->configuracion["site"]."/index.php?";
                                    $variable="pagina=registro_cancelarEstudianteGrupoCoorPosgrado";
 ...
 */
$esteBloque=new bloque_estudiantesInscritosGrupoCoordinadorPosgrado($configuracion);
