              ...
              ?>
               ...
               <?
                ...
                if ($vista == 'adicion' || $vista == 'cancelacion') {
                    if(isset($this->reprobados))
                    {
                        foreach ($this->reprobados as $key => $reprobados) {
                            if($reprobados['REPROBADO']==1 && $resultadoInscritos[$j]['CODIGO']==$reprobados['CODIGO'])
                            {
                                $enlace=1;
                            }
                        }
                ...
                ?>
                  <td class='cuadro_plano centrar' onmouseover="this.style.background='#F8E0E0'" onmouseout="this.style.background=''">
                    Reprobado: No se puede Cancelar
                  </td>
...
//se ejusta consulta para nueva estructura de tablas 04/06/13
