...
//Clase
class bloque_adminBuscarEspacioEstudianteCoorPosgrado extends bloque {

  public $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarEspacioEstudianteCoorPosgrado();
    $this->funcion = new funcion_adminBuscarEspacioEstudianteCoorPosgrado($this->configuracion, $this->sql);
  }
...
$esteBloque = new bloque_adminBuscarEspacioEstudianteCoorPosgrado($configuracion);
