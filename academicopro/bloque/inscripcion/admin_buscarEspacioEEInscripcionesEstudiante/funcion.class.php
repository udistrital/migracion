...
class funcion_adminBuscarEspacioEEInscripcionesEstudiante extends funcionGeneral {      //Crea un objeto tema y un objeto SQL.
...
<?
    ...
    function enlaceAdicionar($datosEspacio, $datosGenerales) {
        $parametro = "=";
                  ...
                  $variables.="&retorno=admin_buscarEspacioEEInscripcionesEstudiante";
     ...
     function buscarEspaciosExtrinsecos(){
          ...
          foreach($extrinsecosMenosAprobadosMenosInscritos as $key => $value){
                ...
                foreach($this->espaciosPlan as $key2 => $value2){
                       if($value['CODIGO'] == (isset($value2['CODIGO'])?$value2['CODIGO']:'') ){
                        $existe=1;
                      }
                }
                if ($existe==0){
