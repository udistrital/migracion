...
class bloque_adminBuscarGruposEstudianteHoras extends bloque {

  private $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarGruposEstudianteHoras();
    $this->funcion = new funcion_adminBuscarGruposEstudianteHoras($configuracion, $this->sql);
  }
  ...
  function action() {
    switch ($_REQUEST['opcion']) {
      ...
      case "adicionar":
        ...
        $variable = "pagina=admin_buscarGruposEstudianteHoras";
...
$esteBloque = new bloque_adminBuscarGruposEstudianteHoras($configuracion);
