...
//Clase
class bloque_adminMenuFlotanteInscripciones extends bloque {
  ...
  public function __construct($configuracion) {
    ...
    //$this->tema = $tema;
    $this->funcion = new funcion_adminMenuFlotanteInscripciones($configuracion);
  ...
  function html() {
    ...
    switch ($_REQUEST['opcion']) {
      ...
      case "cambiar":
        $this->funcion->mostrarMenuFlotanteCambiar();
        break;
...
$esteBloque = new bloque_adminMenuFlotanteInscripciones($configuracion);
