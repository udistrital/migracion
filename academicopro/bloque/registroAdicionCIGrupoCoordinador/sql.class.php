...
class sql_registroAdicionCIGrupoCoordinador extends sql {
...
//echo $cadena_sql;exit;
            ...
            case 'nombre_espacio':
             ...
             case 'requisitos':
                ...
                $cadena_sql="SELECT distinct requisitos_previoAprobado, requisitos_idEspacioPrevio, requisitos_idEspacioPosterior, requisitos_idPlanEstudio ";
                $cadena_sql.="FROM ".$configuracion['prefijo']."requisitos_espacio_plan_estudio ";
                $cadena_sql.="WHERE requisitos_idPlanEstudio='".$variable[0]."' AND requisitos_idEspacioPosterior='".$variable[1]."' and requisitos_previoAprobado='1'";
