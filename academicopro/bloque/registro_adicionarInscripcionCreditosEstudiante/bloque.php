...
class bloque_registroAdicionarInscripcionCreditosEstudiante extends bloque {

  private $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_registroAdicionarInscripcionCreditosEstudiante($configuracion);
    $this->funcion = new funcion_registroAdicionarInscripcionCreditosEstudiante($configuracion, $this->sql);
  }
  ...
  function action() {
    ...
    switch ($_REQUEST['opcion']) {
      ...
      case "inscribirEstudiante":
        ...
        $variable = "pagina=registro_adicionarInscripcionCreditosEstudiante";
...
$esteBloque = new bloque_registroAdicionarInscripcionCreditosEstudiante($configuracion);
