...
class funcion_registroCambiarGrupoEstudianteHoras extends funcionGeneral
{
  ...
  //Crea un objeto tema y un objeto SQL.
    function __construct($configuracion, $sql)
    {
            ...
            //Datos de sesion
            $this->formulario="registro_cambiarGrupoEstudianteHoras";
    ...
    function cambiarGrupo() {
        ...
        if($cambioOracle>=1)
        {
                ...
                if (isset($this->configuracion['dbdistribuida'])&&$this->configuracion['dbdistribuida']==1)
                {
                    $resultado_cambio=$this->cambiarGrupoEspacioEstudianteMyOracle($_REQUEST);
                    $_REQUEST['grupo']=$grupo;
                    $cupos=$this->consultarCupos($_REQUEST);
                    $_REQUEST['inscritos']=$cupos[0]['INSCRITOS'];
                    $this->actualizarCupoMyOracle($_REQUEST);
