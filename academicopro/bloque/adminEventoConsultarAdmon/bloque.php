...
//Clase
class bloque_adminEventoConsultarAdmon extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql=new sql_adminEventoConsultarAdmon();
 		$this->funcion=new funciones_adminEventoConsultarAdmon($configuracion, $this->sql);
...
$esteBloque=new bloque_adminEventoConsultarAdmon($configuracion);
