...
//Clase
class bloque_registroAdicionEstudiante extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql=new sql_registroAdicionEstudiante();
 		$this->funcion=new funciones_registroAdicionEstudiante($configuracion, $this->sql);
...
$esteBloque=new bloque_registroAdicionEstudiante($configuracion);
