...
//Clase 
class bloqueMenuNoticia extends bloque
{
	...
	{
		$this->funcion=new registro_menunoticia($configuracion);
		$this->sql=new sql_menunoticia();
	}
...
$esteBloque=new bloqueMenuNoticia($configuracion);
