...
class bloqueAdminActivo extends bloque
{
	...
	{
		$this->funcion=new admin_activo($configuracion);
	...
	{	
		...
		switch($_REQUEST['opcion'])
		{
			...
			case "editar":
				$this->funcion->editarRegistro($configuracion,$tema,$_REQUEST['id_activo'], $this->acceso_db, "");
				break;
	...
	switch($_REQUEST['opcion'])
		{
			case "nuevo":
				$this->funcion->guardarActivo($configuracion);
				break;
