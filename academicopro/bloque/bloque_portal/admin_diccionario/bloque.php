...
//Clase
class bloqueAdminActivo extends bloque
{
	...
	{
		$this->funcion=new admin_diccionario($configuracion);
	...
	{	
		...
		switch($_REQUEST['opcion'])
		{
			...
			case "editar":
				$this->funcion->editarRegistro($configuracion,$tema,$_REQUEST['id_objeto'], $this->acceso_db, "");
				break;
			...
			case "corregir":
				...
				break;
			case "ver":
				$this->funcion->verRegistro($configuracion,$tema,$_REQUEST['id_objeto'], $this->acceso_db, "");
				break;	
	...
	switch($_REQUEST['opcion'])
		{
			case "nuevo":
				$this->funcion->guardarObjeto($configuracion);
				break;
...
$this->esteBloque=new bloqueAdminActivo($configuracion);
