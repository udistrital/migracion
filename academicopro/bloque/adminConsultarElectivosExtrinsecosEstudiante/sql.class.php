...
class sql_adminConsultarElectivosExtrinsecosEstudiante extends sql {	//@ Método que crea las sentencias sql para el modulo admin_noticias
...
//                exit;
              ...
              case "listaPlanesEstudio":
                ...
                $cadena_sql.="FROM ".$this->configuracion["prefijo"];
            ...
            case "consultaEspacioPlan":
                ...
                $cadena_sql.=" AND PLAN_ESPACIO.id_estado=1 ";
                $cadena_sql.=" AND PLAN_ESPACIO.id_aprobado=1 ";
                $cadena_sql.=" AND PLAN_ESPACIO.ofrecido_portafolio=1 ";
                $cadena_sql.=" AND PLAN_ESPACIO.id_clasificacion between 4 and 7 ";
...
//                exit;
            ...
            case "aprobarEspacio":
                $cadena_sql="UPDATE ".$this->configuracion["prefijo"];
...
//                exit;
            ...
            case "datosEspacio":
                ...
                $cadena_sql.=" FROM ".$this->configuracion["prefijo"]."espacio_academico ";
...
//                exit;
            ...
            case 'buscarIDRegistro':
                ...
                $cadena_sql="select id_log from ".$this->configuracion['prefijo']."log_eventos ";
            ...
            case "buscar_id":
                ...
                $cadena_sql.=$this->configuracion["prefijo"];
...
//                exit;
            ...
            case "listaEspacios":
                ...
                $cadena_sql.="FROM ";
                $cadena_sql.=$this->configuracion["prefijo"]."espacio_academico ";
                $cadena_sql.="AS ESPACIO ";
                $cadena_sql.="INNER JOIN ".$this->configuracion["prefijo"];
            ...
            case "comentariosNoLeidos":
                $cadena_sql="SELECT * FROM ".$this->configuracion["prefijo"]."comentario_espacio_planEstudio ";
