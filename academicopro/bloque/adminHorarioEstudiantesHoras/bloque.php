...
//Clase
class bloque_adminHorarioEstudiantesHoras extends bloque
{
	...
	{	
		...
		$this->funcion=new funcion_adminHorarioEstudiantesHoras($configuracion);
...
$esteBloque=new bloque_adminHorarioEstudiantesHoras($configuracion);
