...
//Clase
class bloque_adminBuscarEspacioCreditosEstudiante extends bloque {

  public $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarEspacioCreditosEstudiante();
    $this->funcion = new funcion_adminBuscarEspacioCreditosEstudiante($this->configuracion, $this->sql);
  }
...
$esteBloque = new bloque_adminBuscarEspacioCreditosEstudiante($configuracion);
