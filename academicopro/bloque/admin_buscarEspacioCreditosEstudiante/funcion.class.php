...
class funcion_adminBuscarEspacioCreditosEstudiante extends funcionGeneral {      //Crea un objeto tema y un objeto SQL.
...
<?
    ...
    function enlaceAdicionar($datosEspacio, $datosGenerales) {
        $parametro = "=";
                  ...
                  $variables.="&destino=registro_adicionarInscripcionCreditosEstudiante";
                  ...
                  $parametros.="&retorno=admin_buscarEspacioCreditosEstudiante";
