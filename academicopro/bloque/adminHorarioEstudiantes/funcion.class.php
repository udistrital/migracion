...
class funcion_adminHorarioEstudiantes extends funcionGeneral {
    ...
    function mostrarHorarioEstudiante() {
        ...
        if (isset($registroEstudiante)) {
            ...
            $this->cadena_sql = $this->sql->cadena_sql($this->configuracion, "consultaGrupo", $codigoEstudiante); 
           ...
           function HorarioEstudiante($resultado_grupos)
			...
			<tbody>
                ...
                for($j=0;$j<count($resultado_grupos);$j++){
                    ...
                    //consulta los docentes del grupo
                ...
                ?>
                           ...
                           <tr>
<?
                if(isset($resultado_grupos)||$resultado_grupos!=NULL)
                {
...
?>                            </tr>
        ...
        <?
        $resultado_clasificacion = $this->consultarClasificacion($this->configuracion);
...
/**
 * Funcion que consulta la clasificacion de un espacio
 * @return type
 */
    ...
    function consultarDocentesGrupo($datosGrupo) {
        $cadena_sql = $this->sql->cadena_sql($this->configuracion, "consultarDocentesGrupo", $datosGrupo);
