...
class bloque_adminBuscarGruposEstudianteCreditos extends bloque {

  private $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarGruposEstudianteCreditos();
    $this->funcion = new funcion_adminBuscarGruposEstudianteCreditos($configuracion, $this->sql);
  }
  ...
  function action() {
    switch ($_REQUEST['opcion']) {
      ...
      case "validar":
        ...
        $variable = "pagina=admin_buscarGruposEstudianteCreditos";
...
$esteBloque = new bloque_adminBuscarGruposEstudianteCreditos($configuracion);
