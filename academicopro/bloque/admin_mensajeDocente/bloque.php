 ...
 * @subpackage Consulta
 */
class bloque_mensajesDocente extends bloque
{
  ...
  /**
	...
	{	
		...
		$this->tema=$tema;
		$this->funcion=new funcion_mensajesDocente($configuracion);
		$this->sql=new sql_mensajesDocente($configuracion);
	}
 ...
 */
$esteBloque=new bloque_mensajesDocente($configuracion);
