...
class funcion_admin_consejerias extends funcionGeneral {
    ...
    function __construct($configuracion) {
        ...
        $this->tema=$tema;
        $this->sql=new sql_admin_consejerias();
        $this->log_us= new log();
        $this->formulario="admin_consejerias";
    ...
    function menuCoordinador($configuracion)
    {
...
?>
    ...
    function verProyectos($configuracion) {
        ...
        $cadena_sql=$this->sql->cadena_sql($configuracion, 'nombre_usuario', $this->usuario);
        $resultado_nombre=$this->ejecutarSQL($configuracion, $this->accesoOracle, $cadena_sql, "busqueda");
...
<table class='contenidotabla centrar' background="<?echo $configuracion['site'].$configuracion['grafico']?>/escudo_fondo.png" style="background-attachment:fixed; background-repeat:no-repeat; background-position:top">
    ...
    <tr align="center">
        <td class="centrar" colspan="4">
            <h4>PROYECTOS CURRICULARES ASOCIADOS A <?echo $resultado_nombre[0]['NOMBRES']." ".$resultado_nombre[0]['APELLIDOS']?></h4>
            <hr noshade class="hr">
...
//var_dump($_REQUEST);exit;
    ...
    <?
        ...
        {
            $this->menuCoordinador($configuracion);
        }
...
<table class='contenidotabla centrar' background="<?echo $configuracion['site'].$configuracion['grafico']?>/escudo_fondo.png" style="background-attachment:fixed; background-repeat:no-repeat; background-position:top">
    ...
    function comunicacion ($configuracion)
    {
        $codDocente=$_REQUEST['codDocente'];
        $nombreDocente=$_REQUEST['nombreDocente'];
        $codCoordinador=$this->usuario;
        $nivelCoordinador=$this->nivel;

        //echo "<br><br>".$codCoordinador."**".$nivelCoordinador;exit;

//var_dump($_REQUEST);exit;
            //$cadena_sql=$this->sql->cadena_sql($configuracion,"docente_asociado",$codCoordinador);//echo $cadena_sql;exit;
            //$resultado_docente=$this->ejecutarSQL($configuracion, $this->accesoGestion, $cadena_sql,"busqueda" );
...
//            $html.="<a id='pestanalink1' class='link' onclick='xajax_comunicacion(".$codCoordinador.", ".$codDocente.", ".$nivelCoordinador.");'>";
//            $html.="<font size='1'><b>Comunicación</b></font></a></li>";
            $html.="<li id='pestana2' class='pestanainactiva a'>";
            $html.="<a id='pestanalink2' class='link' onclick='xajax_estudiantes(".$codCoordinador.", ".$codDocente.", ".$nivelCoordinador.");'>";
            $html.="<font size='1'><b>Estudiantes</b></font></a></li>";
            $html.="</ul>";
            $html.="</div>";
            ...
            $html.="<tr>
                     ...
                     ";
            //$cadena_sql=$this->sql->cadena_sql($configuracion,"datosEstudiante",$codCoordinador);//echo $cadena_sql;exit;
                    ...
                    <td>
                        <div id='div_nuevo'>
                            <table class='contenidotabla' centrar>
                                <tr>
                                    <td class='centrar' colspan='2'>Tiene ".$resultado_cuenta[0][0]." mensajes por leer del Consejero ".$nombreDocente."<br>";
...
//fin nuevo mensaje
            if(is_array($resultado_mensaje))
            {
                    ...
                    <table class='contenidotabla centrar' border='0' background=".$configuracion['site'].$configuracion['grafico']."/escudo_fondo.png' style='background-attachment:fixed; background-repeat:no-repeat; background-position:top'>
                        <tr align='center'>
                            <td class='centrar' colspan='2'>
                                Escr&iacute;bale un mensaje al Consejero ".$nombreDocente."
                            </td>
                        </tr>
                        <tr>
                            <td class='centrar' colspan='2'>
               ...
               $html.="
                ...
                <tr>
                   <td class='centrar' colspan='2'>
                       <b>Mensajes entre Usted y ".$nombreDocente."
                       </b>
                   </td>
               </tr>";
                ...
                for($m=0;$m<count($resultado_mensaje);$m++)
                {
                    ...
                    {
                        $resultado_mensaje[$m][1]=$nombreDocente;
                    }
                    else
                    {
            ...
            else
            {
                ...
                $html.="<tr><td colspan='2'>
                    <table class='contenidotabla centrar' border='0' background=".$configuracion['site'].$configuracion['grafico']."/escudo_fondo.png' style='background-attachment:fixed; background-repeat:no-repeat; background-position:top'>
                        <tr align='center'>
                            <td class='centrar' colspan='2'>
                                Escr&iacute;bale un menssaje a ".$nombreDocente."
                            </td>
                        </tr>
                        <tr>
                            <td class='centrar' colspan='2'>
...
*/
        ...
        else
        {
         ?>
             <table class="contenidotabla centrar">
                <tr>
                    <BR><td class="cuadro_brownOscuro centrar">
