...
//Clase
class bloque_admin_consejerias extends bloque
{

	 public function __construct($configuracion)
	{	include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
		$this->tema=$tema;
		$this->funcion=new funcion_admin_consejerias($configuracion);
	...
	function html($configuracion)
	{
		...
		switch($_REQUEST['opcion'])
		{
                        ...
                        case "comunicacion":
                                $this->funcion->comunicacion($configuracion);
                        break;
...
$obj_aprobar=new bloque_admin_consejerias($configuracion);
