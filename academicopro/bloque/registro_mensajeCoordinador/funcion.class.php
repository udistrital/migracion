...
<?php
/**
 * Funcion registro_mensajeCoordinador
 *
 ...
 * @subpackage Consulta
 */
class funcion_registroMensajeCoordinador extends funcionGeneral
{
	...
	function __construct($configuracion) {
	    ...
	    $this->sql=new sql_registroMensajeCoordinador($configuracion);
            ...
            $this->formulario="registro_mensajeCoordinador";//nombre del bloque que procesa el formulario
...
<!--          <tr id="fila" class="sigma" class="izquierda">
        ...
        function seleccionarDestinatarios() {
          ...
          $docenteConsejeroDestinatario=  $this->buscarDocenteConsejeroDestinatario();          
      ...
      <form enctype='tipo:multipart/form-data,application/x-www-form-urlencoded,text/plain' method='POST' action='index.php' name='<? echo $this->formulario ?>'>
        ...
        <table border='1' cellspacing='0' cellpadding='1'>
            ...
            foreach ($docenteConsejeroDestinatario as $key => $value) {
         ...
         *
         */
        function buscarDocenteConsejeroDestinatario() {
          
              $variablesCoordinador = array(  
                                            codCoordinador => $this->usuario
                                        );

              $cadena_sql = $this->sql->cadena_sql("buscarDocenteConsejeroDestinatario", $variablesCoordinador);//echo $cadena_sql;exit;
              $arreglo_docenteConsejero = $this->ejecutarSQL($this->condiguracion,$this->accesoOracle, $cadena_sql, "busqueda");              
              return $arreglo_docenteConsejero;
         ...
         * @return <type>
         */
        function armarCadenaNombres($datosReceptor) {
