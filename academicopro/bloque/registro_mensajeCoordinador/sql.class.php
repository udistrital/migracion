<?php
/**
 * SQL registro_mensajeCoordinador
 *
 ...
 * @subpackage Consulta
 */
class sql_registroMensajeCoordinador extends sql
{
   ...
   function cadena_sql($tipo,$variable="")
	{
	 ...
	 switch($tipo)
	 {
              ...
              //Oracle
              case 'buscarDocenteConsejeroDestinatario':

                $cadena_sql="SELECT";
                $cadena_sql.=" DISTINCT(dco_doc_nro_ident) CODIGO,";
                ...
                $cadena_sql.=" WHERE cra_emp_nro_iden=".$variable['codCoordinador'];                                         
