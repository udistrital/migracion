...
//Clase
class bloque_registroEventoBorrarFechaAdmon extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql=new sql_registroEventoBorrarFechaAdmon();
 		$this->funcion=new funciones_registroEventoBorrarFechaAdmon($configuracion, $this->sql);
		...
		if(isset($_REQUEST['opcion']))
			{
				...
				switch($accion)
				{
						...
						break;
                                       ...
                                       case "borrar":
						$this->funcion->borrarFecha($configuracion);
						break;
...
$esteBloque=new bloque_registroEventoBorrarFechaAdmon($configuracion);
