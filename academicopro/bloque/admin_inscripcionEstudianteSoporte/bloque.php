...
//Clase
class bloque_adminInscripcionEstudianteSoporte extends bloque
{

	 public function __construct($configuracion)
	{	include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
		$this->tema=$tema;
		$this->funcion=new funcion_adminInscripcionEstudianteSoporte($configuracion);
...
$obj_aprobar=new bloque_adminInscripcionEstudianteSoporte($configuracion);
