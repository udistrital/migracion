	 ...
	 switch($tipo)
	 {
          ...
          //Oracle
            ...
            case 'buscarHorarioGrupo':
                ...
                $cadena_sql.=" sal_sed_id SEDE,";
                $cadena_sql.=" Hor_Sal_id_espacio ID_SALON,";
                $cadena_sql.=" sal_nombre SALON";
                ...
                $cadena_sql.=" INNER JOIN GESALON_2012 ON Achorario_2012.hor_sal_id_espacio=gesalon_2012.sal_id_espacio";
