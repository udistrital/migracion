...
?>  
        ...
        foreach ($grupos as $key=> $grupo) {
          $enlace=$this->enlaceGrupo($grupo['GRUPO']);
          if ($_REQUEST['grupo']==$grupo['GRUPO'])
            {$color="#E4EBFE";}
            else{$color='';}
          ?>
                  ...
                  for ($a = 0; $a < count($horario); $a++) {
                          ...
                          if (    $horario[$a]['DIA'] == $i &&
                            ...
                            $l = $a;
                              ...
                              $dia = "<strong>" . $horario[$l]['HORA'] . "-" . ($horario[$m]['HORA'] + 1) . "</strong><br>" . $horario[$a]['SEDE'] . "<br>" . $horario[$a]['SALON'];
                              echo $dia . "<br>";
                              unset($dia);
                          } elseif ($horario[$a]['DIA'] == $i && $horario[$a]['DIA'] != (isset($horario[$a + 1]['DIA'])?$horario[$a + 1]['DIA']:'')) {
                              $dia = "<strong>" . $horario[$a]['HORA'] . "-" . ($horario[$a]['HORA'] + 1) . "</strong><br>" . $horario[$a]['SEDE'] . "<br>" . $horario[$a]['SALON'];
                              echo $dia . "<br>";
                              unset($dia);
                              $a++;
