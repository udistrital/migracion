 ...
 * @subpackage Consulta
 */
class sql_mensajeCoordinador extends sql
{
   ...
   function cadena_sql($tipo,$variable="")
	{
	 ...
	 switch($tipo)
	 {
              ...
              case "buscarMensajesRecibidos":
                    ...
                    $cadena_sql.=" TO_CHAR(men_fecha, 'DD/month/YYYY HH24:MI') FECHA";
