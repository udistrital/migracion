    ...
    function cancelarCreditos() {
        ...
        if($canceladoOracle==1)
        {
            ...
            $variablesRegistro=array('usuario'=>$this->usuario,
                                    ...
                                    'registro'=>$this->ano."-".$this->periodo.", ".$this->datosInscripcion['codEspacio'].", ".$this->datosInscripcion['grupo'].", 0, ".$this->datosEstudiante[0]['PLAN_ESTUDIO'].", ".$this->datosEstudiante[0]['COD_CARRERA'],
        ...
        }else
            {
                ...
                $variablesRegistro=array('usuario'=>$this->usuario,
                                        ...
                                        'registro'=>$this->ano."-".$this->periodo.", ".$this->datosInscripcion['codEspacio'].", 0, ".$this->datosInscripcion['grupo'].", ".$this->datosEstudiante[0]['PLAN_ESTUDIO'].", ".$this->datosEstudiante[0]['COD_CARRERA'],
                                        'afectado'=>$this->datosEstudiante[0]['CODIGO']);
            }
