...
//Clase
class bloque_adminBuscarEspacioEstudianteHoras extends bloque {

  public $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarEspacioEstudianteHoras();
    $this->funcion = new funcion_adminBuscarEspacioEstudianteHoras($this->configuracion, $this->sql);
  }
...
$esteBloque = new bloque_adminBuscarEspacioEstudianteHoras($configuracion);
