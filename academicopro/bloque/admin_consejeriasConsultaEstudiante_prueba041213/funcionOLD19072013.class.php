...
<?
    ...
    ?>
          ...
          <tr>
            ...
            <td class='cuadro_plano centrar'><? echo $resultado_grupo[$i]['GRUPO'] ?></td>
    ...
    ?><td class='cuadro_plano centrar'><?
            ...
            for ($k = 0; $k < count($resultado_horarios); $k++) {
              ...
              if ($resultado_horarios[$k][0] == $i && $resultado_horarios[$k][0] == (isset($resultado_horarios[$k + 1][0])?$resultado_horarios[$k + 1][0]:'') && (isset($resultado_horarios[$k + 1][1])?$resultado_horarios[$k + 1][1]:'') == ($resultado_horarios[$k][1] + 1) && (isset($resultado_horarios[$k + 1][3])?$resultado_horarios[$k + 1][3]:'') == ($resultado_horarios[$k][3])) {
                $l = $k;
                while ($resultado_horarios[$k][0] == $i && $resultado_horarios[$k][0] == (isset($resultado_horarios[$k + 1][0])?$resultado_horarios[$k + 1][0]:'') && (isset($resultado_horarios[$k + 1][1])?$resultado_horarios[$k + 1][1]:'') == ($resultado_horarios[$k][1] + 1) && (isset($resultado_horarios[$k + 1][3])?$resultado_horarios[$k + 1][3]:'') == ($resultado_horarios[$k][3])) {
