...
//          $espaciosVistos = $this->espaciosVistos(); 
//          $matriculas = $this->consultarMatriculas($this->datosEstudiante['CODIGO']);
//          $semestre_ingreso = substr($this->datosEstudiante['CODIGO'], 0,5);
//          
//          $rendimiento_academico = $this->calculosRendimientoAc($reglamentoEstudiante,$notaAprobatoria,$espaciosVistos,$matriculas,$semestre_ingreso);
//          $probabilidad_riesgo = $this->calculosProbabilidadR($reglamentoEstudiante,$espaciosVistos,$matriculas,$semestre_ingreso);
                ...
                <tr>
                  <td>
                    <table width="100%"  cellspacing="1 px" cellpadding="1px" border="0px">
                      <tr>
                        <td style="border:0px" rowspan="11" colspan="6">
...
<?
    ...
    <?
        ...
        for ($j = 0; $j < count($resultado_grupos); $j++) {
          ...
          $variables[0][7] = $this->periodo[0][0];  //clasificacion
          $variables[0][8] = $this->periodo[0][1];  //clasificacion
    ...
    function mostrarReglamentoEstudiante($reglamentoEstudiante,$estado){
        ...
        $html .="</tr>";
                ...
                $html .="<td  class='cuadro_plano'>Estar cursando 3 o m&aacute;s espacios acad&eacute;micos en un mismo periodo</td>";
                $html .="</tr>";
                $html .="<tr>";
