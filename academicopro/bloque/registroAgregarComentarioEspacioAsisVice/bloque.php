...
//Clase
class bloque_registroAgregarComentarioEspacioAsisVice extends bloque
{

	 public function __construct($configuracion)
	{	include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
		$this->tema=$tema;
		$this->funcion=new funcion_registroAgregarComentarioEspacioAsisVice($configuracion);
...
$obj_aprobar=new bloque_registroAgregarComentarioEspacioAsisVice($configuracion);
