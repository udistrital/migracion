    ...
    {       $cadena_sql=$this->sql->cadena_sql($configuracion,$this->accesoOracle,"resumenCurso",$variable);
            ...
            {       $formulario='admin_consultaHorarios';
                    ...
                    <table class="centrar" width="100%">
                            <tr>
                                    <td class="centrar">
                                    <!--img width="30" height="30" src="<? echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]?>/excel.jpg" alt="Exportar reporte" title="Exportar reporte" border="0" /-->    
                                    <form enctype='tipo:multipart/form-data,application/x-www-form-urlencoded,text/plain' method='GET' action='index.php' name='<? echo $formulario?>'>
                                        ...
                                        <input type='hidden' name='opcion' value='exportarHorario'>
                                        ...
                                        <input type='hidden' name='espacio' value='<? echo  $variable['asignatura'];?>'>
                                        <!--input name='buscar' value='Exportar Reporte' type='submit'-->   
