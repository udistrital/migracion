...
//Clase
class bloque_registroAdicionarInscripcionEstudiante extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql=new sql_registroAdicionarInscripcionEstudiante();
 		$this->funcion=new funciones_registroAdicionarInscripcionEstudiante($configuracion, $this->sql);
...
$esteBloque=new bloque_registroAdicionarInscripcionEstudiante($configuracion);
