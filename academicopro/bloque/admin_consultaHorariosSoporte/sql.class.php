	...
	//	$variable=$conexion->verificar_variables($variable);		
		...
		{	
			case "carrerasPublicaron":
				...
				$this->cadena_sql.="dep_nombre NOMBRE_FACULTAD ";
				$this->cadena_sql.="FROM ";
				$this->cadena_sql.="ACASPERI,ACCRA,ACCALEVENTOS,GEDEP ";
				...
				$this->cadena_sql.="AND ";
				$this->cadena_sql.="DEP_COD=CRA_DEP_COD ";
				$this->cadena_sql.="AND ";
			...
			case "carrerasNoPublicaron":
				...
				$this->cadena_sql.="dep_nombre NOMBRE_FACULTAD ";
				$this->cadena_sql.="FROM ";
				$this->cadena_sql.="ACASPERI,ACCRA,GEDEP,ACCALEVENTOS A ";
				$this->cadena_sql.="WHERE ";
				$this->cadena_sql.="CRA_COD=ACE_CRA_COD ";
