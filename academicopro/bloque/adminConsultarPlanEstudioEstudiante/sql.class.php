...
class sql_adminConsultarPlanEstudioEstudiante extends sql {	//@ Método que crea las sentencias sql para el modulo admin_noticias
    function cadena_sql($configuracion,$tipo,$variable="", $variable2="") {
        switch($tipo) {
            ...
            case "consultaEspacioPlan":
                ...
                $cadena_sql.="PLAN_ESPACIO.id_aprobado, ";        //registro[9]
                $cadena_sql.="PLAN_ESPACIO.id_planEstudio, ";      //registro[10]
                $cadena_sql.="PLAN_ESPACIO.semanas ";      //registro[11]
                ...
                $cadena_sql.="AND PLAN_ESPACIO.id_espacio not in (SELECT DISTINCT id_espacio FROM sga_espacioEncabezado WHERE id_planEstudio =".$variable." and id_aprobado=0 ) ";
                $cadena_sql.="ORDER BY PLAN_ESPACIO.id_nivel,ESPACIO.id_espacio, ESPACIO.espacio_nombre ASC";
                break;


            case "buscar_planEstudioEstudiante":
                $cadena_sql="SELECT est_pen_nro, est_cra_cod FROM acest ";
...
//                $cadena_sql="SELECT * ";
//                $cadena_sql.="FROM ".$configuracion["prefijo"];
//                $cadena_sql.="encabezado as cabeza ";
//                $cadena_sql.="INNER JOIN ".$configuracion["prefijo"]."espacio_clasificacion AS CLASIFICACION ";
//                $cadena_sql.="ON CLASIFICACION.id_clasificacion = cabeza.id_clasificacion ";
...
//
            ...
            case "datosEspacioEncabezado":

                $cadena_sql="select escab.id_espacio from ".$configuracion["prefijo"];
                $cadena_sql.="espacioEncabezado escab ";
                $cadena_sql.="inner join sga_encabezado cab ";
                $cadena_sql.="on escab.id_encabezado=cab.id_encabezado ";
                $cadena_sql.="where escab.id_espacio=".$variable[0]." ";
                $cadena_sql.="and escab.id_planEstudio=".$variable[1]." ";
                $cadena_sql.="and cab.id_aprobado=1";
//                echo $cadena_sql;
//                exit;
                break;
            ...
            case "datosEspacioOpcion":
                ...
                $cadena_sql.=" AND CLASIFICACION.id_clasificacion!=4 ";
                $cadena_sql.=" AND CLASIFICACION.id_clasificacion!=5 ";
                $cadena_sql.="ORDER BY PLAN_ESPACIO.id_nivel,ESPACIO.id_espacio, ESPACIO.espacio_nombre ASC";
                break;
