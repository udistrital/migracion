...
//Clase
class bloque_adminMenuFlotanteEspacioFisicoAcademico extends bloque {
    ...
    public function __construct($configuracion) {
        ...
        //$this->tema = $tema;
        $this->funcion = new funcion_adminMenuFlotanteEspacioFisicoAcademico($configuracion);
    ...
    function html() {
        ...
        switch ($_REQUEST['opcion']) {
            ...
            case "menuAuxiliar":
                ...
                $this->funcion->mostrarMenuAuxiliar($espacio);
                break;
...
$esteBloque = new bloque_adminMenuFlotanteEspacioFisicoAcademico($configuracion);
