...
//Clase
class bloque_adminConsultarInscripcionesEstudiante extends bloque {
  ...
  public function __construct($configuracion) {
    ...
    //$this->tema = $tema;
    $this->funcion = new funcion_adminConsultarInscripcionesEstudiante($configuracion);
...
$esteBloque = new bloque_adminConsultarInscripcionesEstudiante($configuracion);
