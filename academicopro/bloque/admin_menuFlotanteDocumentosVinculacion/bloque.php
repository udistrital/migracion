...
//Clase
class bloque_adminMenuFlotanteVinculacion extends bloque {
  ...
  public function __construct($configuracion) {
    ...
    //$this->tema = $tema;
    $this->funcion = new funcion_adminMenuFlotanteVinculacion($configuracion);
...
$esteBloque = new bloque_adminMenuFlotanteVinculacion($configuracion);
