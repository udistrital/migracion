...
class bloque_registroAdicionarEspacioEstudianteHoras extends bloque {

  private $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_registroAdicionarEspacioEstudianteHoras($configuracion);
    $this->funcion = new funcion_registroAdicionarEspacioEstudianteHoras($configuracion, $this->sql);
  }
  ...
  function action() {
    ...
    switch ($_REQUEST['opcion']) {
      ...
      case "inscribirEstudiante":
        ...
        $variable = "pagina=registro_adicionarEspacioEstudianteHoras";
...
$esteBloque = new bloque_registroAdicionarEspacioEstudianteHoras($configuracion);
