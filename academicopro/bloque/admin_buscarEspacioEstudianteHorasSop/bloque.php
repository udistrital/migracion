...
//Clase
class bloque_adminBuscarEspacioEstudianteHorasSop extends bloque {

  public $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarEspacioEstudianteHorasSop();
    $this->funcion = new funcion_adminBuscarEspacioEstudianteHorasSop($this->configuracion, $this->sql);
  }
...
$esteBloque = new bloque_adminBuscarEspacioEstudianteHorasSop($configuracion);
