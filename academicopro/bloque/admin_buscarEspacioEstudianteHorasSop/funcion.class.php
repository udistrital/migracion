...
class funcion_adminBuscarEspacioEstudianteHorasSop extends funcionGeneral {      //Crea un objeto tema y un objeto SQL.
  ...
  private $espaciosBorrados;
    ...
    //Datos de sesion
    $this->formulario = "admin_buscarGruposEstudianteHorasSop";
    ...
    function retorno() {
        ...
        <td>
            <button class="botonEnlacePreinscripcion" onclick="window.location = 
                '<?
                        $variable="pagina=adminConsultarInscripcionEstudianteHorasSop";
...
<?
    ...
    function enlaceAdicionar($datosEspacio, $datosGenerales) {
        $parametro = "=";
                  ...
                  $variables.="&destino=registro_adicionarEspacioEstudianteHorasSop";
                ...
                if (is_array($this->espaciosEquivalentes))
                {
                    ...
                    {                
                        ...
                        $mostrar[]=$espacioEquivalente['ASI_COD_ANTERIOR']; 
                                $mostrar[]=(isset($espacioEquivalente['ASI_COD_ANTERIOR2'])?$espacioEquivalente['ASI_COD_ANTERIOR2']:'');   
