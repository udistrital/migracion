    ...
    function cadena_sql($opcion,$variable="") {
        ...
        switch($opcion) {
            ...
            case 'adicionar_espacio_oracle':
                ...
                $cadena_sql.="(INSDE_ANO,INSDE_PER,INSDE_EST_COD,INSDE_ASI_COD,INSDE_CRA_COD,INSDE_CRED,INSDE_HTD,INSDE_HTC,INSDE_HTA,INSDE_CEA_COD,INSDE_PERDIDO,INSDE_ESTADO,INSDE_EQUIVALENTE) ";
