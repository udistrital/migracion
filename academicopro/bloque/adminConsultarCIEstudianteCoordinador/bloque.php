...
//Clase
class bloque_adminConsultarCIEstudianteCoordinador extends bloque
{

	 public function __construct($configuracion)
	{	include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
		$this->tema=$tema;
		$this->funcion=new funcion_adminConsultarCIEstudianteCoordinador($configuracion);
...
$esteBloque=new bloque_adminConsultarCIEstudianteCoordinador($configuracion);
