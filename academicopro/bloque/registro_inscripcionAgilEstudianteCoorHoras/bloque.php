...
//Clase
class bloque_registroInscripcionAgilEstudianteCoorHoras extends bloque
{
  ...
  public function __construct($configuracion)
	{
            ...
            $this->sql=new sql_registroInscripcionAgilEstudianteCoorHoras($configuracion);
            $this->funcion=new funcion_registroInscripcionAgilEstudianteCoorHoras($configuracion, $this->sql);
...
$esteBloque=new bloque_registroInscripcionAgilEstudianteCoorHoras($configuracion);
