...
class sql_registroAdicionarInscripcionEEEstudiante extends sql {
    function cadena_sql($configuracion,$opcion,$variable="") {
        ...
        switch($opcion) {
            ...
            case 'parametros_plan':
                ...
                $cadena_sql="select parametro_idPlanEstudio, parametro_creditosPlan, parametro_promedioMinimo, parametro_maxCreditosNivel, ";
                $cadena_sql.="parametro_minCreditosNivel, parametros_OB, parametros_OC, parametros_EI, parametros_EE, parametros_aprobado ";
            ...
            case 'electivas_extrinsecas':
                  ...
                  $cadena_sql.="INNER JOIN ACCURSO ON CLP_ASI_COD=CUR_ASI_COD ";
...
//                $cadena_sql="SELECT EA.id_espacio , ";
//                $cadena_sql.="id_nivel , ";
//                $cadena_sql.=" id_clasificacion,";
//                $cadena_sql.=" id_planEstudio,";
//                $cadena_sql.=" planEstudioProyecto_idProyectoCurricular,";
//                $cadena_sql.=" proyecto_nombre,";
//                $cadena_sql.=" FAC.id_facultad,";
//                $cadena_sql.=" FAC.nombre_facultad";
...
//                $cadena_sql.=" INNER JOIN ".$configuracion['prefijo']."planEstudio_proyecto PEP on PEE.id_planEstudio=PEP.planEstudioProyecto_idPlanEstudio";
//                $cadena_sql.=" INNER JOIN ".$configuracion['prefijo']."proyectoCurricular PC on PEP.planEstudioProyecto_idProyectoCurricular=PC.id_proyectoAcademica";
//                $cadena_sql.=" INNER JOIN ".$configuracion['prefijo']."facultad FAC on FAC.id_facultad=PC.id_facultad";
//                $cadena_sql.=" WHERE id_clasificacion = '4'";
//                $cadena_sql.=" AND id_aprobado = '1'";
//                $cadena_sql.=" ORDER BY FAC.id_facultad, planEstudioProyecto_idProyectoCurricular";
...
//
            ...
            case 'creditosPlan':
                ...
                case 'espaciosInscritosClas':
                    ...
                    $cadena_sql="SELECT ins_asi_cod, ins_cra_cod, ins_cred, ins_cea_cod ";
                    $cadena_sql.="FROM acins ";
                    $cadena_sql.="WHERE ins_est_cod =".$variable;
                    $cadena_sql.=" AND ins_ano=(SELECT APE_ANO FROM ACASPERI WHERE APE_ESTADO LIKE '%A%')";
                    $cadena_sql.=" AND ins_per=(SELECT APE_PER FROM ACASPERI WHERE APE_ESTADO LIKE '%A%')";
