...
class funciones_registroAdicionarInscripcionEEEstudiante extends funcionGeneral {     	//Crea un objeto tema y un objeto SQL.
...
//        $this->administrar->administrarModuloSGA($configuracion, '4');
        ...
        //Datos de sesion
        $this->formulario="registroAdicionarInscripcionEEEstudiante";
...
document.oncontextmenu = new Function("return false")
    ...
    function consultarEspaciosPermitidos($configuracion) {
        ...
        $cadena_sql_planEstudio=$this->sql->cadena_sql($configuracion,"electivas_extrinsecas", $permitidos);//echo $cadena_sql_planEstudio;exit;
...
//            {
//                $cadena_sql=$this->sql->cadena_sql($configuracion,"buscar_cargado", $resultado_planEstudio[$i][0]);//echo $cadena_sql;exit;
...
//                        $cargados[$c][1]=$resultado_planEstudio[$i][4];//id_Carrera
//                        $cargados[$c][2]=$resultado_planEstudio[$i][3];//id_Plan Estudio
//                        $cargados[$c][3]=$resultado_planEstudio[$i][2];//Nivel
//                        $cargados[$c][4]=$resultado_planEstudio[$i][6];//Id_facultad
//                        $cargados[$c][5]=$resultado_planEstudio[$i][7];//Nombre_facultad
//                        $cargados[$c][6]=$resultado_planEstudio[$i][5];//Nombre_Proyecto
//                        $c++;
//                    }
//            }

        $cadena_sql_parametros=$this->sql->cadena_sql($configuracion,"parametros_plan", $_REQUEST['planEstudioGeneral']);//echo $cadena_sql_parametros;
...
<table class='contenidotabla' align='center' cellpadding='2' cellspacing='2'>
    
            <?
                    list($OBEst, $OCEst, $EIEst, $EEEst, $OB, $OC, $EI, $EE)=$this->evaluaRangos($configuracion, $codigoEstudiante);
                    //echo "OB:".$OBEst."-OC".$OCEst."-EI".$EIEst."-EE".$EEEst."-Rang".$OB."-".$OC."-".$EI."-".$EE;
                    ...
                    for($i=0;$i<count($resultado_planEstudio);$i++) {
                        ...
                        $cadena_sql_espacio=$this->sql->cadena_sql($configuracion,"nombre_espacio", $resultado_planEstudio[$i][0]);//echo "<br>".$cadena_sql_espacio;//exit;
                        ...
                        $cadena_sql=$this->sql->cadena_sql($configuracion,"buscarInscrita",$varInscritas);//echo "<br>".$cadena_sql;exit;
                            ...
                            if ($resultado_otroRequisito[0][0]=='2') {
                                ...
                                if(!is_array($resultado_Inscrita))
                                    ...
                                    if ($band == '0') {
                                        ...
                                        if($resultado_planEstudio[$i][6]!=$facActual)
                                        {
                                        ?>
  <tr><td></td>
  </tr>
                                            <tr>
                                                <td class="sigma_a cuadro_plano centrar" colspan="6">
                                                    <b>
                                                    <?
                                                        echo strtoupper($resultado_planEstudio[$i][7]);
                                                        $facActual=$resultado_planEstudio[$i][6];
                                                    ?>
                                                    </b>
                                                </td>
                                            </tr>
                                        ...
                                        if($resultado_planEstudio[$i][4]!=$proyActual)
                                            {
                                            ?>
                                            <tr>
                                                <td class='sigma_b centrar' colspan="6" style=""><b><?echo $resultado_planEstudio[$i][5]?></b></td>
                                            </tr>
                                            <tr >
                                            ...
                                            <?$proyActual=$resultado_planEstudio[$i][4];
                                            }
                    ...
                    $variablesCancelado=array($codigoEstudiante,$resultado_planEstudio[$i][0],$ano[0],$ano[1]);
                                ...
                                $resultado_cancelo=$this->ejecutarSQL($configuracion, $this->accesoGestion, $cadena_sql,"busqueda" );
                                        ...
                                        echo $resultado_planEstudio[$i][2];
                                               ...
                                               $bandClasifica=0;
                                            switch(trim($resultado_planEstudio[$i][2]))
                                             {
                                                case 'OB':
                                                       if ($OB<$totalOB)
                                                       {$bandClasifica=1;}
                                        ...
                                        <?if($_REQUEST['estado_est']=='B')
                                            {
                                              ?>  <td class='cuadro_plano centrar'><font color="#F90101"><? echo $resultado_espacio[0][1]?></font></td>
                                                ...
                                                <?
                                            }else if(is_array($resultado_cancelo)) {
                                ?>
                                            <td class='cuadro_plano centrar'>
                                ...
                                <?
                                        ...
                                        ?>
                                            ...
                                            <td class='cuadro_plano centrar' width="15%">
                                                No puede adicionar, El n&uacute;mero de cr&eacute;ditos inscritos no es permitido
                                            </td>
                                            <?}
                                }else if($resultado_espacio[0][1]>$numeroCreditosRestantes) {
                                        ?>
...
<table class="cuadro_color centrar" width="100%">
    ...
    function buscarGrupo($configuracion) {
        ...
        $cadena_sql_periodo=$this->sql->cadena_sql($configuracion,"ano_periodo","");//echo $cadena_sql_periodo;
        $resultado_periodo=$this->ejecutarSQL($configuracion, $this->accesoOracle, $cadena_sql_periodo,"busqueda" );
...
<tr>
    <td class="cuadro_plano centrar">
        No existen grupos habilitados en el Proyecto.<br><font size="2" color="red">Si est&aacute; adicionando espacios acad&eacute;micos Electivos Extr&iacute;nsecos<br>por favor consulte Grupos en otros Proyectos Curriculares.</font>
    </td>
</tr>
        <?
        }
...
<table class="contenidotabla centrar" border="0">
    ...
    function buscarOtrosGrupos($configuracion) {
        ...
        $cadena_sql_carreras=$this->sql->cadena_sql($configuracion,"buscar_carrerasAbiertas", $variables);//echo $cadena_sql_carreras;exit;
        ...
        <tr>
                            ...
                            <table class='contenidotabla'>
                                ...
                                <td class='cuadro_plano centrar' >Adicionar</td>
                                            ...
                                            for($j=0;$j<count($resultado_grupos);$j++) {
                                                ...
                                                $cadena_sql_horarios=$this->sql->cadena_sql($configuracion,"horario_otros_grupos", $variables);//echo $cadena_sql_horarios;exit;
                                                $resultado_horarios=$this->ejecutarSQL($configuracion, $this->accesoOracle, $cadena_sql_horarios,"busqueda" );
            ...
            if($cuenta==$p){
              ...
              <?
                    ...
                    <tr>
                        <td class="cuadro_plano centrar">
                            No existen grupos registrados para este periodo
                        </td>
                    </tr>
                    <?}
                ?>
...
<table class="contenidotabla centrar" border="0">
    ...
    function inscribirCredito($configuracion) {
        ...
        $retorno['parametros'].="&carrera=".$_REQUEST["carrera"];
        ...
        if ($resultado_EspacioOracle =='' and $resultado_buscarEspacioMysql == '') {
            ...
            if($resultado_cupo_inscritos[0][0]<=$resultado_cupo_grupo[0][0] || $this->nivel=28) {
                ...
                $resultado_numCreditos=$this->calcularCreditosInscritos($configuracion,$_REQUEST['codEstudiante']);

                //echo $cadena_sql_numCreditos;
                $creditos=($resultado_numCreditos+$_REQUEST['creditos']);
                //echo $creditos;
                if ($creditos<='18') {
                    ...
                    $cadena_sql_adicionarMysql=$this->sql->cadena_sql($configuracion,"adicionar_espacio_mysql", $variableInscripcion);//echo $cadena_sql_adicionarMysql.'<br>';
                    ...
                    if($resultado_adicionarMysql==true)
                        {
                            $cadena_sql_adicionar=$this->sql->cadena_sql($configuracion,"adicionar_espacio_oracle", $variableInscripcion);//echo $cadena_sql_adicionar;
                    ...
                    $cadena_sql_adicionarMysql=$this->sql->cadena_sql($configuracion,"adicionar_espacio_mysql", $variables);
                    $resultado_adicionarMysql=$this->ejecutarSQL($configuracion, $this->accesoGestion, $cadena_sql_adicionarMysql,"" );
...
<table class='contenidotabla' align='center' width='80%' cellpadding='2' cellspacing='2'>
    ...
    <td><center>ELECTIVAS EXTR&Iacute;NSECAS OFRECIDAS</center></td>
</thead>
<table class='contenidotabla' align='center' width='80%' cellpadding='2' cellspacing='2'>
    <thead class='cuadro_color centrar'>
    <td>Nivel</td><td>Codigo Espacio</td><td>Nombre Espacio</td><td>Clasificaci&oacute;n</td><td>Nro Cr&eacute;ditos</td><td>Adicionar</td>
            ...
            <?
                    ...
                    for($i=0;$i<count($resultado_planEstudio);$i++) {
                        ...
                        $cadena_sql_espacio=$this->sql->cadena_sql($configuracion,"nombre_espacio", $resultado_planEstudio[$i][0]);//echo $cadena_sql_espacio;exit;
                        $resultado_espacio=$this->ejecutarSQL($configuracion, $this->accesoGestion, $cadena_sql_espacio,"busqueda" );
...
//            $registroCreditosEspacio=$this->ejecutarSQL($configuracion, $this->accesoGestion, $cadena_sql,"busqueda" );
            ...
            $cadena_sql=$this->sql->cadena_sql($configuracion,"espaciosInscritosClas", $codEstudiante);//echo $cadena_sql;exit;
...
//            $registroCreditosEspacio=$this->ejecutarSQL($configuracion, $this->accesoGestion, $cadena_sql,"busqueda" );
            ...
            switch($registroEspaciosInscritos[$i][3])
            {
                case 1:
                        $OBEst=$OBEst+$registroEspaciosInscritos[$i][2];
                    break;

                case 2:
                        $OCEst=$OCEst+$registroEspaciosInscritos[$i][2];
                    break;

                case 3:
                        $EIEst=$EIEst+$registroEspaciosInscritos[$i][2];
                    break;

                case 4:
                        $EEEst=$EEEst+$registroEspaciosInscritos[$i][2];
                    break;
