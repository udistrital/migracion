...
//Clase
class bloque_adminConsultarPlanEstudioDecano extends bloque
{

	 public function __construct($configuracion)
	{	include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
		$this->tema=$tema;
		$this->funcion=new funcion_adminConsultarPlanEstudioDecano($configuracion);
...
$obj_aprobar=new bloque_adminConsultarPlanEstudioDecano($configuracion);
