    ...
    function cadena_sql($configuracion, $tipo, $variable="") {
		...
		$this->cadena_sql.=" AND pen_estado='A' ";
            ...
            case "insertarCurso":
                ...
                $this->cadena_sql=" INSERT INTO mntac.accursos ";
                $this->cadena_sql.="(cur_id,cur_ape_ano, cur_ape_per,cur_asi_cod,cur_grupo,cur_cra_cod,cur_nro_cupo, cur_estado,cur_dep_cod,cur_hor_alternativo,";
            ...
            case "verHorarioTemp":
                ...
                $this->cadena_sql.=" FROM mntac.achorarios HOR_G ";
                $this->cadena_sql.=" INNER JOIN gesalon_2012 SALON ON HOR_G.HOR_SAL_ID_ESPACIO=SALON.SAL_ID_ESPACIO";
	      ...
	      /* borreme despues de pasar pruebas
            ...
            case "infoCarga":
                ...
                $this->cadena_sql.="WHERE ";
                $this->cadena_sql.="car_cur_asi_cod='".$variable['espacio']."' ";
                $this->cadena_sql.="AND car_cur_nro='".$variable['grupo']."' ";
                $this->cadena_sql.="AND car_ape_ano='".$variable['anio']."' ";
                $this->cadena_sql.="AND car_ape_per='".$variable['periodo']."' ";
                break;
            ...
            case "infoInscritos":
                ...
                $this->cadena_sql.="FROM ";
                $this->cadena_sql.="acins,mntac.accursos ";
				...
				$this->cadena_sql.="AND ins_gr=cur_grupo ";
            ...
            case "infoDocente":
                ...
                $this->cadena_sql.="INNER JOIN accarga carg on carg.car_doc_nro_iden=doc.doc_nro_iden ";
                $this->cadena_sql.="WHERE ";
                $this->cadena_sql.="carg.car_ape_ano='".$variable['anio']."' ";
                $this->cadena_sql.="and carg.car_ape_per='".$variable['periodo']."' ";
	        $this->cadena_sql.="and carg.car_cra_cod='".$variable['proyecto']."' ";
                $this->cadena_sql.="and carg.car_cur_asi_cod='".$variable['espacio']."' ";
                $this->cadena_sql.="and carg.car_cur_nro='".$variable['grupo']."' ";
                $this->cadena_sql.="and carg.car_estado='A' ";
	...
	case "sede_codigo":
	 ...
	 case "salones":
		 $this->cadena_sql=" select 
                            ...
                            from gesalon_2012 , geedificio
                            where SAL_ESTADO='A' AND sal_edificio=edi_cod
                            AND sal_sed_id='".$variable."'";
	 ...
	 case "salones_ocupados":
		...
		$this->cadena_sql.=" INNER JOIN mntac.accursos ON  cur_id=hor_id_curso ";
		$this->cadena_sql.=" WHERE hor_sal_id_espacio='".$variable['cod_salon']."' ";
		$this->cadena_sql.=" AND cur_ape_ano='2013' ";
	 ...
	 case "salon_ocupado":
		...
		$this->cadena_sql.=" WHERE cur_ape_ano='2013' ";
		$this->cadena_sql.=" AND cur_ape_per='1' ";
	 ...
	 case "registrar_horario":
                    ...
                    $this->cadena_sql.=' VALUES(';
                    $this->cadena_sql.="".$variable['dia'].$variable['hora'].", ";
                    $this->cadena_sql.="".$variable['curso'].", ";
