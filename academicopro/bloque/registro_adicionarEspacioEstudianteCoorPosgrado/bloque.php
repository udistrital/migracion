...
class bloque_registroAdicionarEspacioEstudianteCoorPosgrado extends bloque {

  private $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_registroAdicionarEspacioEstudianteCoorPosgrado($configuracion);
    $this->funcion = new funcion_registroAdicionarEspacioEstudianteCoorPosgrado($configuracion, $this->sql);
  }
...
$esteBloque = new bloque_registroAdicionarEspacioEstudianteCoorPosgrado($configuracion);
