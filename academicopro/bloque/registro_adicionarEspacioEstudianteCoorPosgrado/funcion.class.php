  ...
  //Crea un objeto tema y un objeto SQL.
    ...
    */
    ...
    function espacioPlan($datos) {
        $cadena_sql=$this->sql->cadena_sql("espacios_planEstudio",$datos);//echo $cadena_sql;exit;
    ...
    function consultarDatosEspacio($datos) {
        $cadena_sql=$this->sql->cadena_sql("datosEspacio",$datos);//echo $cadena_sql;exit;
        return $resultado_espacio=$this->ejecutarSQL($this->configuracion, $this->accesoOracle, $cadena_sql,"busqueda" );
    }
    ...
    function adicionarEspacioMysql($datos) {
        $cadena_sql_adicionarMysql=$this->sql->cadena_sql("adicionar_espacio_mysql",$datos);//echo $cadena_sql_adicionarMysql;exit;
    ...
    function adicionarOracle($datos) {
        $cadena_sql_adicionar=$this->sql->cadena_sql("adicionar_espacio_oracle",$datos);//echo $cadena_sql_adicionar;exit;
