...
class funcion_registroAgregarComentarioEspacioCoordinador extends funcionGeneral {
    ...
    function __construct($configuracion) {
        ...
        $this->log_us= new log();
        $this->formulario="registroAgregarComentarioEspacioCoordinador";
   ...
   function agregarComentario($configuracion,$variables)
    ...
    function guardarRegistros($configuracion)
    {
       ...
       if($resultado_comentario==true)
           {
                echo "<script>alert('Se agrego el comentario con exito para el espacio académico ".$codEspacio." ')</script>";
                    $pagina=$configuracion["host"].$configuracion["site"]."/index.php?";
