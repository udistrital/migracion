...
class funciones_adminVerRequisitosEstudiante extends funcionGeneral {
//Crea un objeto tema y un objeto SQL.
    ...
    //include ($configuracion["raiz_documento"].$configuracion["estilo"]."/".$this->estilo."/tema.php");
        ...
        //Datos de sesion
        $this->formulario="adminVerRequisitosEstudiante";
    ...
    function verRequisitosEstudiante($configuracion) {
      ...
      <table align="center" border="0" cellpadding="0" width="100%">
          <tr>
              <td style='text-align:center' align="center" colspan="2">
                ...
                $this->menuEstudiante($configuracion, $variable)
                ?>
              </td>
          </tr>
          <tr>
    ...
    function menuEstudiante($configuracion,$variable){
    ?>
    <table class="contenidotabla centrar" width="100%" >
        <tr class="centrar">
