...
class funciones_admin_certIngresosRetenciones extends funcionGeneral
{
	...
	function __construct($configuracion, $sql)
	{
		...
		include_once($configuracion["raiz_documento"] . $configuracion["clases"] . "/pdf/fpdf.php");
                echo $configuracion["raiz_documento"].$configuracion["bloques"] ."/admin_desprendiblesPagos". $configuracion["clases"] . "/crearDocumento.class.php";//exit;
		include_once($configuracion["raiz_documento"].$configuracion["bloques"] ."/admin_desprendiblesPagos". $configuracion["clases"] . "/crearDocumento.class.php");
		
		$this->cripto=new encriptar();
		$this->tema=$tema;
		$this->sql=$sql;
		$this->certificado=new crearDocumento();
				...
				<tr>
					<td>	
						...
						<table class="formulario" align="center">
							...
							<tr class="cuadro_color">
								<td>
									Fecha consignaci&oacute;n <br>(formato DD/MM/AAAA)
								</td>
								<td>
									Valor
								</td>
...
__________________________________________________________________________________________________*/
    ...
    function mostrarEnlaceGenerarCertificado($configuracion,$identificacion,$valor,$fecha) {
       ...
       function generarCertificado($configuracion){
          ...
          // $this->certificado->crearCertificado($tipo_certificado,$parametro_sql,$configuracion);
