...
class funcion_registroCambiarGrupoEstudianteGrupoCoorCI extends funcionGeneral
{
...
//      }exit;
    ...
    function realizarCambioSeleccionados() {
        ...
        //var_dump($estudiantesCambio);exit;
...
//        }exit;
    ...
    function cambiarGrupoEstudiante() {
        ...
        if($actualizo>=1)
        {
          $variablesRegistro=array('usuario'=>$this->usuario,
                                    ...
                                    'registro'=>$this->ano."-".$this->periodo.", ".$_REQUEST['codEspacio'].",".$_REQUEST['grupoAnterior'].",".$_REQUEST['idGrupo'].", ".$_REQUEST['planEstudio'].", ".$_REQUEST['carrera'],
    ...
    function reporteGrupo($param) {
        ...
        $variable.="&idGrupo=".$_REQUEST['grupoAnterior'];
