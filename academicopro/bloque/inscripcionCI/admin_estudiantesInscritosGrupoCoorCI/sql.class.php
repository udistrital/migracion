 ...
 * @subpackage Consulta
 */
class sql_estudiantesInscritosGrupoCoorCI extends sql
{
...
//***************************************
                ...
                case 'espacio_grupo':
                    ...
                    $cadena_sql="select distinct cur_asi_cod, cur_id, cur_cra_cod, cur_nro_cupo, cur_nro_ins, pen_sem from accurso ";
                ...
                case 'grupos_del_espacio_academico':
                    ...
                    $cadena_sql="select distinct cur_id from accursos ";
...
//echo $cadena_sql;exit;
                ...
                case 'horario_grupos':
                    ...
                    $cadena_sql.="FROM achorarios";
                    $cadena_sql.=" INNER JOIN accursos ON hor_id_curso=cur_id";
                    $cadena_sql.="INNER JOIN GESEDE ON HOR_SED_COD=GESEDE.SED_COD ";
