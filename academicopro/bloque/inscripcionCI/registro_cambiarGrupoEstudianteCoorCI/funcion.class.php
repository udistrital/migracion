...
class funcion_registroCambiarGrupoEstudianteCoorCI extends funcionGeneral
{
  ...
  //Crea un objeto tema y un objeto SQL.
    function __construct($configuracion, $sql)
    {
            ...
            //Datos de sesion
            $this->formulario="registro_cambiarGrupoEstudianteCoorCI";
    ...
    function cambiarGrupo() {
        ...
        $retorno['parametros'].="&idGrupo=".$_REQUEST['grupoAnterior'];
        ...
        if($cambioOracle>=1)
        {
                ...
                $_REQUEST['idGrupo']=$_REQUEST['grupoAnterior'];
                $this->procedimiento->actualizarCupo($_REQUEST);

                $variablesRegistro=array('usuario'=>$this->usuario,
                                          'evento'=>'3',
                                          'descripcion'=>'Cambio grupo del Espacio Académico CI',
                                          'registro'=>$this->ano."-".$this->periodo.", ".$_REQUEST['codEspacio'].",".$_REQUEST['idGrupo'].",".$grupo.", ".$_REQUEST['planEstudio'].", ".$_REQUEST['carrera'],
        ...
        else
          {
              ...
              $variablesRegistro=array('usuario'=>$this->usuario,
                                        'evento'=>'50',
                                        'descripcion'=>'Conexion Error Oracle Cambio de Grupo CI',
    ...
    function actualizarRegistroEspacioEstudianteMysql() {
        $cadena_sql=$this->sql->cadena_sql("actualizar_grupo_espacio_mysql", $_REQUEST);//echo $cadena_sql;exit;
