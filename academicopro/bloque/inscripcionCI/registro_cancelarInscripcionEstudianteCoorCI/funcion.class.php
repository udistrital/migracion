...
class funcion_registroCancelarInscripcionEstudianteCoorCI extends funcionGeneral {
...
//Crea un objeto tema y un objeto SQL.
    function __construct($configuracion, $sql)
    {
        ...
        //Datos de sesion
        $this->formulario="registro_cancelarInscripcionEstudianteCoorCI";
        $this->bloque="inscripcionCI/registro_cancelarInscripcionEstudianteCoorCI";
    ...
    */
    function cancelarCreditos() {
       ...
       //var_dump($_REQUEST);exit;
        ...
        {
          $retorno['mensaje']="El registro ya ha sido eliminado. No se puede cancelar ".$_REQUEST['nombreEspacio'].".";
        ...
        {
            $retorno['mensaje']='Espacio eliminado exitosamente.';
                ...
                $variablesRegistro=array('usuario'=>$this->usuario,
                          ...
                          'registro'=>$this->ano."-".$this->periodo.", ".$_REQUEST['codEspacio'].",".$_REQUEST['idGrupo'].", 0, ".$_REQUEST['planEstudio'].", ".$_REQUEST['carrera'],
        ...
        else
          {
              ...
              $variablesRegistro=array('usuario'=>$this->usuario,
                      ...
                      'registro'=>$this->ano."-".$this->periodo.", ".$_REQUEST['codEspacio'].",0, ".$_REQUEST['idGrupo'].", ".$_REQUEST['planEstudio'].", ".$_REQUEST['carrera'],
                      'afectado'=>$_REQUEST['codEstudiante']);
          }
