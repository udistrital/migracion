<?
/**
 * Bloque admin_inscripcionCoordinadorCI
 *
 ...
 * @subpackage Admin
 */
class bloque_adminInscripcionCoordinadorCI extends bloque
{
  ...
  /**
	 ...
	 public function __construct($configuracion)
	{
            ...
            $this->funcion=new funcion_adminInscripcionCoordinadorCI($configuracion);
...
/**
 * Crea un nuevo objeto de la clase bloque_adminInscripcionCoordinadorCI
 *
 * Se instancia la clase bloque_adminInscripcionCoordinadorCI y se envia a la funcion que se necesita dependiendo si existe la variable $_REQUEST['action'] o no
 */
$obj_aprobar=new bloque_adminInscripcionCoordinadorCI($configuracion);
