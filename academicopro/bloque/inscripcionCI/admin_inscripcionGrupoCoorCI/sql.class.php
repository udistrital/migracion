 ...
 * @subpackage Admin
 */
class sql_adminInscripcionGrupoCoorCI extends sql {
  ...
  /**
    ...
    function cadena_sql($tipo,$variable="") {
        switch($tipo) {
              ...
              //Oracle
              case 'periodo_activo_vacaciones':
          ...
          //Oracle
            ...
            case 'buscarHorarioGrupo':
                ...
                $cadena_sql.=" INNER JOIN GESALONES ON achorarios.HOR_SAL_ID_ESPACIO=SAL_ID_ESPACIO";
                $cadena_sql.=" INNER JOIN GESEDE ON SAL_SED_COD=GESEDE.SED_COD";
...
//                $cadena_sql.=" INNER JOIN ACCURSOS ON Achorario_2012.HOR_ASI_COD=ACCURSOS.CUR_ASI_COD AND Achorario_2012.HOR_NRO=ACCURSOS.CUR_ID";
...
//                $cadena_sql.=" ORDER BY 1,2,3";
            ...
            case 'contarInscritos':
                ...
                $cadena_sql.=" AND INS_GR=".$variable['idGrupo'];
...
//****************************************************************************
            ...
            case 'horario_grupos':
                ...
                $cadena_sql.=" INNER JOIN accursos ON achorario.hor_asi_cod=accursos.cur_asi_cod AND achorario.hor_nro=accursos.cur_id";
                ...
                $cadena_sql.=" AND hor_ape_ano=".$variable['ano'];
                $cadena_sql.=" AND hor_ape_per=".$variable['periodo'];
                $cadena_sql.=" AND hor_nro=".$variable['idGrupo'];
                $cadena_sql.=" ORDER BY 1,2,3";
            ...
            case 'espacios_seleccionadoCodigo':
                ...
                $cadena_sql="select distinct cur_asi_cod, cur_id, cur_cra_cod, cur_nro_cupo, cur_nro_ins, pen_sem from accursos ";
                $cadena_sql.="inner join acpen on accursos.cur_asi_cod=acpen.pen_asi_cod ";
                $cadena_sql.="inner join accra on accursos.cur_cra_cod=acpen.pen_cra_cod ";
