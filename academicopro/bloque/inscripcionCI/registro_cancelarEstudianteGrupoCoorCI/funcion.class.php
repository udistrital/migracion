...
include_once($configuracion["raiz_documento"].$configuracion["clases"]."/procedimientosCI.class.php");

class funcion_registroCancelarEstudianteGrupoCoorCI extends funcionGeneral {
...
//Crea un objeto tema y un objeto SQL.
    function __construct($configuracion, $sql)
    {
       // include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
        ...
        $this->procedimiento=new procedimientosCI();
        //$this->tema=$tema;
        $this->sql=$sql;
        ...
        //Datos de sesion
        $this->formulario="registro_cancelarEstudianteGrupoCoorCI";
        $this->bloque="inscripcionCI/registro_cancelarEstudianteGrupoCoorCI";
 ...
 */
      ...
      <table border='0' width='90%' cellpadding="2" cellspacing="2" align="center">
          <tr class="texto_subtitulo">
              <td colspan="2" align="center">
                    ...
                    <br> ¿Est&aacute; seguro que desea cancelar a <b><?echo $numEstudiantes?></b> <?echo $cantidad?> del grupo de<br><b><? echo $_REQUEST['nombreEspacio'] ?></b> c&oacute;digo <b><? echo $_REQUEST['codEspacio'] ?></b>?
              </td>
          </tr>
    ...
    */
    function cancelarCreditos() {
      ...
      $datosActualizar=array('codEspacio'=>$_REQUEST['codEspacio'],'idGrupo'=>$_REQUEST['idGrupo']);
              ...
              if ($reprobado=='ok')
              {
              ...
              else
                {
                  ...
                  $variablesRegistro=array('usuario'=>$this->usuario,
                                      'evento'=>'2',
                                      'descripcion'=>'Cancela Espacio académico CI',
                                      'registro'=>$this->ano."-".$this->periodo.", ".$_REQUEST['codEspacio'].",".$_REQUEST['idGrupo'].", 0, ".$_REQUEST['planEstudio'].", ".$_REQUEST['codProyecto'],
                  ...
                  else
                  {
                    $variablesRegistro=array('usuario'=>$this->usuario,
                                      'evento'=>'50',
                                      'descripcion'=>'Conexion Error Oracle cancelacion CI',
                                      'registro'=>$this->ano."-".$this->periodo.", ".$_REQUEST['codEspacio'].",0, ".$_REQUEST['idGrupo'].", ".$_REQUEST['planEstudio'].", ".$_REQUEST['codProyecto'],
                                      'afectado'=>$_REQUEST['codEstudiante']);
                    $this->procedimiento->registrarEvento($variablesRegistro);
    ...
    function cancelar($mensaje='')
    {
        ...
        $variable.="&codProyecto=".$_REQUEST['codProyecto'];
        $variable.="&planEstudio=".$_REQUEST['planEstudio'];
        $variable.="&codProyectoEstudiante=".(isset($_REQUEST['codProyectoEstudiante'])?$_REQUEST['codProyectoEstudiante']:'');
    ...
    function reporteGrupo($param) {
        ...
        $variable.="&codEspacio=".$_REQUEST['codEspacio'];
        $variable.="&idGrupo=".$_REQUEST['idGrupo'];
        $variable.="&grupoNuevo=".$_REQUEST['idGrupo'];
