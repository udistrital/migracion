 ...
 * @subpackage Consulta
 */
class bloque_registroMensajeDocente extends bloque
{
  ...
  /**
	...
	{	
		...
		$this->tema=$tema;
		$this->funcion=new funcion_registroMensajeDocente($configuracion);
                ...
                switch($_REQUEST['opcion'])
		{
                        case "pasarDestinatario":
                          ...
                          //se arma un solo arreglo de destinatarios, los dos arreglos deben existir para realizar el merge (combinar arreglos)
                            if(is_array($_REQUEST['coordinador']) and is_array($_REQUEST['estudiante']))
                                {                                       
                                    $destinatario=array_merge($_REQUEST['coordinador'],$_REQUEST['estudiante']);                                                                                                            
                                }
                            ...
                            if(!is_array($_REQUEST['coordinador']) and is_array($_REQUEST['estudiante']))
                                {                                       
                                    $destinatario=$_REQUEST['estudiante'];                                                                                                            
                                }
 ...
 */
$esteBloque=new bloque_registroMensajeDocente($configuracion);
