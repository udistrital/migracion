		...
		<table class=tablaMarco width="100%" border="0" align="center" cellpadding="4 px" cellspacing="0px" >
                    ...
                    <tr>    
                        <td  width="30%"><span style='color:red;' > * </span>N&uacute;mero de espacios Obligatorios</td>
                            <td >
                                    <input type="text" name='numObligatorios' id="numObligatorios" size="6" maxlength='5' <? if(isset($numObligatorios)?$numObligatorios:'')echo "value='".$numObligatorios."'";?> tabindex='<? echo $tab++;?>' onKeyPress="return solo_numero_sin_slash(event)" onBlur="xajax_sumarObligatoriosYElectivos(document.getElementById('numObligatorios').value,document.getElementById('numElectivos').value,1,1)" >
                    ...
                    <tr>    
                            ...
                            <td >
                                    <input type="text" name='numElectivos' id="numElectivos" size="6"  maxlength='5' <? if(isset($numElectivos)?$numElectivos:'')echo "value='".$numElectivos."'";?> tabindex='<? echo $tab++;?>' onKeyPress="return solo_numero_sin_slash(event)"  onBlur="xajax_sumarObligatoriosYElectivos(document.getElementById('numObligatorios').value,document.getElementById('numElectivos').value,1,1)">
                            </td>
                    </tr>
                    <tr>    
            ...
            <div id="div_mensaje1" align="center" class="ab_name">
                Espacios requeridos (*)  
                <br>Nota: Si alguno de los par&aacute;metros no tiene valor coloque 0.
            </div>
                   <? $this->mostrarEnlaceRetorno();?>
	    </div>
