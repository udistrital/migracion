...
//Clase
class bloque_registroCancelarCreditosEstudiante extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql=new sql_registroCancelarCreditosEstudiante();
 		$this->funcion=new funciones_registroCancelarCreditosEstudiante($configuracion, $this->sql);
...
$esteBloque=new bloque_registroCancelarCreditosEstudiante($configuracion);
