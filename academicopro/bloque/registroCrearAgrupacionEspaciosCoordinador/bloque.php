...
//Clase
class bloque_registroCrearAgrupacionEspaciosCoordinador extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql=new sql_registroCrearAgrupacionEspaciosCoordinador();
 		$this->funcion=new funciones_registroCrearAgrupacionEspaciosCoordinador($configuracion, $this->sql);
...
$esteBloque=new bloque_registroCrearAgrupacionEspaciosCoordinador($configuracion);
