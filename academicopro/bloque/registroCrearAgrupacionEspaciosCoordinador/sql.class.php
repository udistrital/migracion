...
class sql_registroCrearAgrupacionEspaciosCoordinador extends sql {
    function cadena_sql($configuracion,$conexion, $opcion,$variable="") {
        ...
        switch($opcion) {
            ...
            case "buscarNombreExistente":
                $cadena_sql="select * from ".$configuracion['prefijo']."encabezado" ;
                $cadena_sql.=" where encabezado_nombre  like '%".$variable[0]."%'";
