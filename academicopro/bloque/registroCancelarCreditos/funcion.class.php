...
class funciones_registroCancelarCreditos extends funcionGeneral {
//Crea un objeto tema y un objeto SQL.
    ...
    //include ($configuracion["raiz_documento"].$configuracion["estilo"]."/".$this->estilo."/tema.php");
        ...
        //Datos de sesion
        $this->formulario="registroCancelarCreditos";
    ...
    function formularioConsultaHorario($configuracion) {
    ...
    function verificarCreditos($configuracion) {
        ...
        if ($creditos<=$resultado_minimo[0][0]) {
            if($codigoEstudiante==$this->usuario) {
                ?><table border='0' width='90%' cellpadding="2" cellspacing="2" align="center">
    <tr class="texto_subtitulo">
        <td align="center"><?
