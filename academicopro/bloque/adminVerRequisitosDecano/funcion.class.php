...
class funciones_adminVerRequisitosDecano extends funcionGeneral {
//Crea un objeto tema y un objeto SQL.
    ...
    //include ($configuracion["raiz_documento"].$configuracion["estilo"]."/".$this->estilo."/tema.php");
        ...
        //Datos de sesion
        $this->formulario="adminVerRequisitosDecano";
    ...
    function verRequisitosDecano($configuracion) {
      ...
      <table align="center" border="0" cellpadding="0" width="100%">
          <tr>
              <td style='text-align:center' align="center" colspan="2">
                ...
                $this->menuDecano($configuracion, $variable)
                ?>
              </td>
          </tr>
          <tr>
