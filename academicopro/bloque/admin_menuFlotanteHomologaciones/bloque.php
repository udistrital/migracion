...
//Clase
class bloque_adminMenuFlotanteHomologaciones extends bloque {
  ...
  public function __construct($configuracion) {
    ...
    //$this->tema = $tema;
    $this->funcion = new funcion_adminMenuFlotanteHomologaciones($configuracion);
...
$esteBloque = new bloque_adminMenuFlotanteHomologaciones($configuracion);
