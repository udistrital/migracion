...
function mostrarFormulario(){  
        ...
        <div id="normal" <?if($_REQUEST['tipo_hom']<>'normal') echo "style='display: none'"?>>
          <table class="formulario">
              <tr><td align="center"><img src="<? echo $this->configuracion['site'] . $this->configuracion['grafico'] ?>/hom_normal.png" width="80" height="50" border="0"><br><b>Homologaciones uno a uno</b></td>
                  ...
                  <td align="center"><a href="#" onclick="$('#normal').hide();$('#union').hide();$('#bifurcacion').show();"><img src="<? echo $this->configuracion['site'] . $this->configuracion['grafico'] ?>/bifurcacion.png" width="80" height="50" border="0"><br>Homologaciones 1 a 2</a></td>
              </tr>
          </table>
            <br>
    ...
    function camposBusquedaEspaciosPadre($cod_proyecto_curricular){ 
        ...
        ?>
			...
			<thead class='sigma'>
                        ...
                        <tr>
				<td align="center">
					<input type="text" name='cod_padre1' id="cod_padre1" size="7" <? if($_REQUEST['cod_padre1'])echo "value='".$_REQUEST['cod_padre1']."'";?> onKeyPress="return solo_numero(event)" onBlur="xajax_buscarPadre(document.getElementById('cod_padre1').value,<? echo $cod_proyecto_curricular;?>,1,1)"  tabindex='1'>
				</td>
				<td  align='center'>
    ...
    function camposBusquedaEspaciosHijo($cod_proyecto_curricular){
        ...
        <table class="contenidotabla" border="0" cellpadding="0" cellspacing="0"  >
                        ...
                        <tr>
				<td align="center">
					<input type="text" name='cod_hijo1' id="cod_hijo1" size="7" <? if($_REQUEST['cod_hijo1'])echo "value='".$_REQUEST['cod_hijo1']."'";?>  onKeyPress="return solo_numero(event)"  onBlur="xajax_buscarHijo(document.getElementById('cod_hijo1').value,<? echo $cod_proyecto_curricular;?>,1,1)" tabindex='2' >
				</td>
				<td  align='center'>
...
function mostrarFormularioBifurcacion(){   
        ...
        <div  id="bifurcacion"  <?if($_REQUEST['tipo_hom']<>'bifurcacion') echo "style='display: none'"?>>
          <table class="formulario">
              <tr><td align="center"><a href="#" onclick="$('#union').hide();$('#normal').show();$('#bifurcacion').hide();"><img src="<? echo $this->configuracion['site'] . $this->configuracion['grafico'] ?>/hom_normal.png" width="80" height="50" border="0"><br>Homologaciones uno a uno</a></b></td>
                  <td align="center"><a href="#" onclick="$('#normal').hide();$('#union').show();$('#bifurcacion').hide();"><img src="<? echo $this->configuracion['site'] . $this->configuracion['grafico'] ?>/union.png" width="80" height="50" border="0"><br>Homologaciones dos a uno (Unión)</a></td>
                  <td align="center"><img src="<? echo $this->configuracion['site'] . $this->configuracion['grafico'] ?>/bifurcacion.png" width="80" height="50" border="0"><br><b>Homologaciones 1 a 2 (Bifurcación)</b></td>
 ...
 function camposBusquedaEspaciosHijoUnion($cod_proyecto_curricular){ 
        ...
        <table class="contenidotabla" border="0" cellpadding="0" cellspacing="0"  >
                         ...
                         <tr>
				<td align="center">
					<input type="text" name='cod_hijo2' id="cod_hijo2" size="7"  <? if($_REQUEST['cod_hijo2'])echo "value='".$_REQUEST['cod_hijo2']."'";?>   onKeyPress="return solo_numero(event)"  onBlur="xajax_buscarHijo(document.getElementById('cod_hijo2').value,<? echo $cod_proyecto_curricular;?>,2,2)" tabindex='6' >
				</td>
				<td  align='center'>
                        ...
                        <tr>
				<td align="center">
					<input type="text" name='cod_hijo3' id="cod_hijo3" size="7"  <? if($_REQUEST['cod_hijo3'])echo "value='".$_REQUEST['cod_hijo3']."'";?>   onKeyPress="return solo_numero(event)"  onBlur="xajax_buscarHijo(document.getElementById('cod_hijo3').value,<? echo $cod_proyecto_curricular;?>,3,2)" tabindex='8' >
				</td>
				<td  align='center'>
       ...
       function camposBusquedaEspaciosPadreUnion($cod_proyecto_curricular){  
        ...
        ?>
			...
			<thead class='sigma'>
                        ...
                        <tr>
				<td align="center">
					<input type="text" name='cod_padre2' id="cod_padre2" size="7"  <? if($_REQUEST['cod_padre2'])echo "value='".$_REQUEST['cod_padre2']."'";?>  onKeyPress="return solo_numero(event)" onBlur="xajax_buscarPadre(document.getElementById('cod_padre2').value,<? echo $cod_proyecto_curricular;?>,2,2)"  tabindex='4'>
				</td>
				<td  align='center'>
  ...
  function camposBusquedaEspaciosHijoBifurcacion($cod_proyecto_curricular){      
        ...
        ?>    
			...
			<thead class='sigma'>
                        ...
                        <tr>
				<td align="center">
					<input type="text" name='cod_hijo4' id="cod_hijo4" size="7"  <? if($_REQUEST['cod_hijo4'])echo "value='".$_REQUEST['cod_hijo4']."'";?>  onKeyPress="return solo_numero(event)" onBlur="xajax_buscarHijo(document.getElementById('cod_hijo4').value,<? echo $cod_proyecto_curricular;?>,4,3)"  tabindex='4'>
				</td>
				<td  align='center'>
  ...
  function camposBusquedaEspaciosPadreBifurcacion($cod_proyecto_curricular){       
        ...
        <table class="contenidotabla" border="0" cellpadding="0" cellspacing="0"  >
                         ...
                         <tr>
				<td align="center">
					<input type="text" name='cod_padre3' id="cod_padre3" size="7"  <? if($_REQUEST['cod_padre3'])echo "value='".$_REQUEST['cod_padre3']."'";?>   onKeyPress="return solo_numero(event)"  onBlur="xajax_buscarPadre(document.getElementById('cod_padre3').value,<? echo $cod_proyecto_curricular;?>,3,3)" tabindex='6' >
				</td>
				<td  align='center'>
                                ...
                                <td  align='center'>
                                        <div id ="div_reqPadre3">    <input type="radio" name="req_padre3" value="N" <? if($_REQUEST['req_padre3']=='N') echo "checked";?>> NO<br>
                                                                    <input type="radio" name="req_padre3" value="S" <? if($_REQUEST['req_padre3']=='S' || $_REQUEST['req_padre3']!='N') echo "checked";?>> SI
                                        </div>
				</td>
			</tr>
                         <tr>
				<td align="center">
					<input type="text" name='cod_padre4' id="cod_padre4" size="7"  <? if($_REQUEST['cod_padre4'])echo "value='".$_REQUEST['cod_padre4']."'";?>   onKeyPress="return solo_numero(event)"  onBlur="xajax_buscarPadre(document.getElementById('cod_padre4').value,<? echo $cod_proyecto_curricular;?>,4,3)" tabindex='6' >
				</td>
				<td  align='center'>
                                ...
                                <td  align='center'>
                                        <div id ="div_reqPadre4">    <input type="radio" name="req_padre4" value="N" <? if($_REQUEST['req_padre4']=='N') echo "checked";?>> NO<br>
                                                                    <input type="radio" name="req_padre4" value="S" <? if($_REQUEST['req_padre4']=='S' || $_REQUEST['req_padre4']!='N') echo "checked";?>> SI
                                        </div>
				</td>
			</tr>
		</table>
