 ...
 * @subpackage Consulta
 */
class bloque_menuComunicacionesDocente extends bloque
{
  ...
  /**
	...
	{	
		...
		$this->tema=$tema;
		$this->funcion=new funcion_menuComunicacionesDocente($configuracion);
 ...
 */
$esteBloque=new bloque_menuComunicacionesDocente($configuracion);
