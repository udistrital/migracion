...
//Clase
class bloque_adminBuscarEspacioEECreditosEstudianteSop extends bloque {

  public $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarEspacioEECreditosEstudianteSop();
    $this->funcion = new funcion_adminBuscarEspacioEECreditosEstudianteSop($this->configuracion, $this->sql);
  }
...
$esteBloque = new bloque_adminBuscarEspacioEECreditosEstudianteSop($configuracion);
