...
class funcion_adminCIEstudianteCoordinador extends funcionGeneral {
    ...
    function __construct($configuracion) {
        ...
        $this->tema=$tema;
        $this->sql=new sql_adminCIEstudianteCoordinador();
        $this->log_us= new log();
        $this->formulario="adminCIEstudianteCoordinador";
        ...
        if(trim($resultado_estudiante[0][0])=='S')
            {
            ...
            }else if(trim($resultado_estudiante[0][0])=='N')
                {
                    ...
                    {
                        echo "<script>alert('Digite de nuevo el código del estudiante')</script>";
                        $pagina=$configuracion["host"].$configuracion["site"]."/index.php?";
                        $variable="pagina=adminCIEstudianteCoordinador";
                        $variable.="&opcion=consultar";
                        $variable.="&codProyecto=".$_REQUEST["codProyecto"];
                ...
                {
                    echo "<script>alert('El código del estudiante debe ser númerico, intente de nuevo')</script>";
                        $pagina=$configuracion["host"].$configuracion["site"]."/index.php?";
                        $variable="pagina=adminCIEstudianteCoordinador";
                        $variable.="&opcion=consultar";
                        $variable.="&codProyecto=".$_REQUEST["codProyecto"];
