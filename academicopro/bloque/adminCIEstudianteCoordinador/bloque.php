...
//Clase
class bloque_adminCIEstudianteCoordinador extends bloque
{

	 public function __construct($configuracion)
	{	include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
		$this->tema=$tema;
		$this->funcion=new funcion_adminCIEstudianteCoordinador($configuracion);
...
$obj_aprobar=new bloque_adminCIEstudianteCoordinador($configuracion);
