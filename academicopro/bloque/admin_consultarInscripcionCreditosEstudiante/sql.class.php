...
class sql_adminConsultarInscripcionCreditosEstudiante extends sql { //@ Método que crea las sentencias sql para el modulo admin_consultarInscripcionCreditosEstudiante
