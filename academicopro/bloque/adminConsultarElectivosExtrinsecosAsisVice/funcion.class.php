...
class funcion_adminConsultarElectivosExtrinsecosAsisVice extends funcionGeneral {
  ...
  public $formulario;
    ...
    function __construct($configuracion) {
        ...
        $this->log_us= new log();
        $this->formulario="adminConsultarElectivosExtrinsecosAsisVice";
  ...
  function verRegistroOtros() {
    ...
    $this->menuAsisVice($this->configuracion, $planEstudio);
