...
//Clase
class bloque_adminConsultarElectivosExtrinsecosAsisVice extends bloque
{

	 public function __construct($configuracion)
	{	include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
		$this->tema=$tema;
		$this->funcion=new funcion_adminConsultarElectivosExtrinsecosAsisVice($configuracion);
		$this->sql=new sql_adminConsultarElectivosExtrinsecosAsisVice($configuracion);
	}
...
$obj_aprobar=new bloque_adminConsultarElectivosExtrinsecosAsisVice($configuracion);
