...
class funcion_registroComentarioPlanCoordinador extends funcionGeneral {
...
//@ Método costructor que crea el objeto sql de la clase sql_noticia
    ...
    //include ($configuracion["raiz_documento"].$configuracion["estilo"]."/".$this->estilo."/tema.php");
        ...
        $this->tema=$tema;
        $this->sql=new sql_registroComentarioPlanCoordinador();
        $this->log_us= new log();
        $this->formulario="registroComentarioPlanCoordinador";
    ...
    function formularioComentario($configuracion) {
        ...
        $cadena_sql_comentarios=$this->sql->cadena_sql($configuracion,$this->accesoGestion,"buscarComentarios",$planEstudio);//echo $cadena_sql_comentarios;exit;
        $resultado_comentarios=$this->ejecutarSQL($configuracion, $this->accesoGestion, $cadena_sql_comentarios,"busqueda");//var_dump($resultado_comentarios);exit;
...
<table class='contenidotabla centrar' border="0" background="<?echo $configuracion['site'].$configuracion['grafico']?>/escudo_fondo.png" style="background-attachment:fixed; background-repeat:no-repeat; background-position:top">
    ...
    <tr>
        <td class="cuadro_plano" width="40">Usuario:</td><td class="cuadro_plano" width="15"><? echo $resultado_perfil[0][2].": ".$resultado_perfil[0][0]." ".$resultado_perfil[0][1] ?> </td>
    </tr>
                <?
                $estadoLeido=$resultado_comentarios[$i][6];
                if ($estadoLeido==1) { ?>
    <tr>
...
<form enctype='multipart/form-data' method='POST' action='index.php' name='<? echo  $this->formulario?>'>
    ...
    function guardarRegistros($configuracion) {
        ...
        if($band==1) {
            ...
            $variable="pagina=registroComentarioPlanCoordinador";
