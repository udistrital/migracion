...
//Clase
class bloque_adminBuscarEspacioEstudianteCoorHoras extends bloque {

  public $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarEspacioEstudianteCoorHoras();
    $this->funcion = new funcion_adminBuscarEspacioEstudianteCoorHoras($this->configuracion, $this->sql);
  }
...
$esteBloque = new bloque_adminBuscarEspacioEstudianteCoorHoras($configuracion);
