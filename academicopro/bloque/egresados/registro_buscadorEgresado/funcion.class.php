 ...
 * @subpackage Consulta
 */
class funcion_registroBuscadorEgresado extends funcionGeneral
{
	...
	function __construct($configuracion) {
	    ...
	    $this->sql=new sql_registroBuscadorEgresado($configuracion);
            
            $this->formulario="registro_buscadorEgresado";//nombre del bloque que procesa el formulario
            $this->bloque="egresados/registro_buscadorEgresado";//nombre del bloque que procesa el formulario
  ...
  function MostrarBuscadorEgresado() {
