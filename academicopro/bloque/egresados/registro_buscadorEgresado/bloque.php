 ...
 */
class bloque_registroBuscadorEgresado extends bloque
{
  ...
  /**
	...
	{	
		...
		//$this->tema=$tema;
		$this->funcion=new funcion_registroBuscadorEgresado($configuracion);
...
//                include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
	...
	function html()
	{
		...
		switch($_REQUEST['opcion'])
		{
			...
			case "verEgresado":
				$this->funcion->MostrarBuscadorEgresado();
				break;
 ...
 */
$esteBloque=new bloque_registroBuscadorEgresado($configuracion);
