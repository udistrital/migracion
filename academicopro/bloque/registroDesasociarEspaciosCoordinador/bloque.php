...
//Clase
class bloque_registroDesasociarEspaciosCoordinador extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql=new sql_registroDesasociarEspaciosCoordinador();
 		$this->funcion=new funciones_registroDesasociarEspaciosCoordinador($configuracion, $this->sql);
		...
		if(isset($_REQUEST['opcion']))
			{
				...
				switch($accion)
				{
						...
						break;
                                       ...
                                       case "desagrupar":
						$this->funcion->desagruparEspacios($configuracion);
						break;
...
$esteBloque=new bloque_registroDesasociarEspaciosCoordinador($configuracion);
