 ...
 * @subpackage Consulta
 */
class bloque_menuComunicacionesEstudiante extends bloque
{
  ...
  /**
	...
	{	
		...
		$this->tema=$tema;
		$this->funcion=new funcion_menuComunicacionesEstudiante($configuracion);
 ...
 */
$esteBloque=new bloque_menuComunicacionesEstudiante($configuracion);
