...
//Clase
class bloque_adminConsultarHorarioEstudianteCoordinador extends bloque
{
	...
	{	
            ...
            $this->funcion=new funcion_adminConsultarHorarioEstudianteCoordinador($configuracion);
...
$obj_aprobar=new bloque_adminConsultarHorarioEstudianteCoordinador($configuracion);
