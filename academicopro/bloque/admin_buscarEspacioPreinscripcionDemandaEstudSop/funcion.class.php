...
class funcion_admin_buscarEspacioPreinscripcionDemandaEstudiante extends funcionGeneral {      //Crea un objeto tema y un objeto SQL.
  ...
  public $sesion;
   ...
   // include ($configuracion["raiz_documento"] . $configuracion["estilo"] . "/basico/tema.php");
    ...
    //Conexion ORACLE
    if ($this->nivel==51 ||$this->nivel==80){
    ...
    elseif ($this->nivel==52 ||$this->nivel==80){
...
<?
    ...
    $parametros=$this->consultarParametros();  
            ...
            foreach ($niveles as $nivel)
            {
                ...
                if ($nombreObservacion=='Adicionar')
                {
                    if (trim($this->datosEstudiante[0]['TIPO_ESTUDIANTE']) == 'S')
                    {
                        ...
                        <div class="columna2" style="width:15%"><?echo "consulta";?></div>
                    <?
                    }else 
                        {
                            ?> <div class="columna2" style="width:<?echo $ancho;?>">Clasificaci&oacute;n</div> 
                        ...
                        <?
                            ...
                            {?>
                                <div class='cuadro_espacio' style="width:36%"><?
                                    ...
                                    {
                                        echo "El espacio supera el máximo de semestres consecutivos.<br>";
                                    }
                                ?></div><?
                            }?>
                        </div>
                                    ...
                                    <div class="contenidotabla_equivalencias" onmouseover="this.style.background='#F4FA58'" onmouseout="this.style.background=''">
                                        ...
                                        <?}else
                                            ...
                                            ?>
                                                ...
                                                if ($espacio['NIVELES']==0)
                                                {
                                                    echo "El espacio supera el m&iacute;ximo de semestres consecutivos.<br>";
                                                }
                                            ?></div><?
                                            }?>
                                    </div><?
...
function mostrarMensajeDeEspera(){
    ...
    function variablesRetorno() {
        ...
        $variable = "pagina=admin_consultarPreinscripcionDemandaEstudsop";
