...
//Clase
class bloque_adminCargarDatosEgresado extends bloque
{
...
//                include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
		$this->configuracion=$configuracion;
                //$this->tema=$tema;
		$this->funcion=new funcion_adminCargarDatosEgresado($configuracion);
...
$obj_aprobar=new bloque_adminCargarDatosEgresado($configuracion);
