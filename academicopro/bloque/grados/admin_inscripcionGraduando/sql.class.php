    ...
    function cadena_sql($tipo,$variable="") {
        switch($tipo) {
            ...
            case 'consultarDatosEstudiante':
                ...
                $cadena_sql.=" nvl(est_pen_nro,'') PENSUM, ";
                $cadena_sql.=" nvl(est_ind_cred,'') MODALIDAD, ";
                ...
                $cadena_sql.=" nvl(est_sexo,'') SEXO, ";
                $cadena_sql.=" nvl(eot_email,'') EMAIL, ";
                $cadena_sql.=" nvl(est_telefono,'') TELEFONO, ";
                $cadena_sql.=" nvl(eot_tel_cel,'') CELULAR, ";
                $cadena_sql.=" nvl(est_direccion,'') DIRECCION, ";
                $cadena_sql.=" nvl(eot_cod_mun_res,'') POBLACION, ";
                $cadena_sql.=" nvl(TO_CHAR(eot_fecha_nac, 'yyyymmdd'),'') FEC_NACIMIENTO, ";
                $cadena_sql.=" est_nro_iden IDENTIFICACION, ";
                $cadena_sql.=" nvl(est_tipo_iden,'') TIPO_IDENTIFICACION, ";
                $cadena_sql.=" nvl(est_lib_militar,'') LIBRETA, ";
                $cadena_sql.=" nvl(est_nro_dis_militar,'') DISTRITO_MILITAR, ";
                $cadena_sql.=" nvl(est_fallecido,'') FALLECIDO ";
            ...
            case 'consultarDatosEgresado':
                ...
                $cadena_sql="SELECT nvl(egr_tip_iden,'') TIPO_IDENTIFICACION, ";
                ...
                $cadena_sql.=" nvl(egr_sexo,'') SEXO, ";
                $cadena_sql.=" nvl(egr_lug_exp_iden,'') LUGAR_DOCUMENTO, ";
                $cadena_sql.=" nvl(egr_trabajo_grado,'') NOMBRE_TRABAJO, ";
                $cadena_sql.=" nvl(egr_director_trabajo,'') DIRECTOR_TRABAJO, ";
                $cadena_sql.=" nvl(egr_director_trabajo_2,'') DIRECTOR_TRABAJO_2, ";
                $cadena_sql.=" nvl(egr_acta_sustentacion,'') ACTA_SUST, ";
                $cadena_sql.=" nvl(to_char(egr_fecha_grado,'YYYY/MM/DD'),'') FECHA_GRADO, ";
                $cadena_sql.=" nvl(egr_acta_grado,'') ACTA_GRADO, ";
                $cadena_sql.=" nvl(egr_nota,'') NOTA, ";
                $cadena_sql.=" nvl(egr_libro,'') LIBRO, ";
                $cadena_sql.=" nvl(egr_folio,'') FOLIO, ";
                $cadena_sql.=" nvl(egr_reg_diploma,'') DIPLOMA, ";
                $cadena_sql.=" nvl(egr_titulo,'') TITULO, ";
                $cadena_sql.=" nvl(egr_rector,'') RECTOR, ";
                $cadena_sql.=" nvl(egr_secretario,'') SECRETARIO, ";
                $cadena_sql.=" nvl(egr_email,'') EMAIL, ";
                $cadena_sql.=" nvl(egr_telefono_casa,'') TELEFONO, ";
                $cadena_sql.=" nvl(egr_movil,'') CELULAR, ";
                $cadena_sql.=" nvl(egr_direccion_casa,'') DIRECCION, ";
                $cadena_sql.=" nvl(egr_empresa,'') EMPRESA, ";
                $cadena_sql.=" nvl(egr_direccion_empresa,'') DIRECCION_EMPRESA, ";
                $cadena_sql.=" nvl(egr_telefono_empresa,'') TELEFONO_EMPRESA, ";
                $cadena_sql.=" nvl(egr_caracter_nota,'') MENCION ";
            ...
            case 'consultarDatosGraduando':
                ...
                $cadena_sql.=" nvl(ing_nom_trabajo,'') NOMBRE_TRABAJO, ";
                $cadena_sql.=" nvl(ing_director,'') DOC_DIRECTOR, ";
                $cadena_sql.=" nvl(ing_tipo_trabajo,'') TIPO_TRABAJO, ";
                $cadena_sql.=" nvl(ing_acta,'') ACTA_SUST ";
            ...
            case "consultarSecretarios":
                ...
                $cadena_sql.=" trim(sec_nombre)||' '||trim(sec_apellido)||' ('||nvl(to_char(sec_fecha_desde,'DD-MON-YYYY'),'')||' '||DECODE(nvl(sec_fecha_hasta,''),'','','hasta '||to_char(sec_fecha_hasta,'DD-MON-YYYY'))||')' NOMBRE_FECHA,";
                $cadena_sql.=" nvl(to_char(sec_fecha_desde,'YYYYMMDD'),'') SEC_DESDE,";
                $cadena_sql.=" nvl(to_char(sec_fecha_hasta,'YYYYMMDD'),to_char(sysdate,'YYYYMMDD')) SEC_HASTA";
            ...
            case "consultarRectores":
                ...
                $cadena_sql.=" trim(rec_nombre)||' '||trim(rec_apellido)||' ('||nvl(to_char(rec_fecha_desde,'DD-MON-YYYY'),'')||' '||DECODE(nvl(rec_fecha_hasta,''),'','','hasta '||to_char(rec_fecha_hasta,'DD-MON-YYYY'))||')' NOMBRE_FECHA,";
                $cadena_sql.=" nvl(to_char(rec_fecha_desde,'YYYYMMDD'),'') RECTOR_DESDE,";
                $cadena_sql.=" nvl(to_char(rec_fecha_hasta,'YYYYMMDD'),to_char(sysdate,'YYYYMMDD')) RECTOR_HASTA";
