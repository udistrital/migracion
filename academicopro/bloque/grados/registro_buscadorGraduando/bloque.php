 ...
 */
class bloque_registroBuscadorGraduando extends bloque
{
  ...
  /**
	...
	{	
		...
		//$this->tema=$tema;
		$this->funcion=new funcion_registroBuscadorGraduando($configuracion);
 ...
 */
$esteBloque=new bloque_registroBuscadorGraduando($configuracion);
