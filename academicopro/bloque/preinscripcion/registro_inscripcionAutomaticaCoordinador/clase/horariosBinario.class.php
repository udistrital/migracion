...
class horariosBinario {
     ...
     * @return <boolean>
     */
    public function ConsultarHorarios($cra_cod) {
        //consulta los horarios creados desde Oracle
        $resultado = $this->horarios($cra_cod);
        $horario = '';
/*        $cadena_sql = "INSERT INTO sga_horarios_binarios (hor_id_curso,hor_carrera,hor_facultad,hor_sede_dif,hor_alternativa,hor_lunes,hor_martes,hor_miercoles,hor_jueves,hor_viernes,hor_sabado,hor_domingo) VALUES ('13121','374','32','0','0','000000000000000110000000','000000000001100000000000','000000000000000110000000','000000000000000110000000','000000000000011000000000','0','0')";
        echo $cadena_sql."<br>";
        $resultado_adicionar = $this->funcionGeneral->ejecutarSQL($this->configuracion, $this->accesoGestion, $cadena_sql, "");
  */      //crea el horario binario para cada registro de curso
        ...
        foreach ($resultado as $key => $horarios) {
            ...
            echo "<script>callprogressHora(".round($porcentaje).",".$a.",".$total.")</script>"; //llamo a la función JS(JavaScript) para actualizar el progreso
        ...
        /*$cadena_sql = "INSERT INTO sga_horarios_binarios (hor_id_curso,hor_carrera,hor_facultad,hor_sede_dif,hor_alternativa,hor_lunes,hor_martes,hor_miercoles,hor_jueves,hor_viernes,hor_sabado,hor_domingo) VALUES ('13122','374','32','0','0','000000000000000110000000','000000000001100000000000','000000000000000110000000','000000000000000110000000','000000000000011000000000','0','0')";
        echo $cadena_sql."<br>";
        $resultado_adicionar = $this->funcionGeneral->ejecutarSQL($this->configuracion, $this->accesoGestion, $cadena_sql, "");
        exit;*/
    ...
    function crearArreglo($horario) {
        ...
        foreach ($horario as $key => $value) {
            //muestra el avance de creación de los horarios binarios
            $porcentaje = $a * 100 / $total; //saco mi valor en porcentaje
            echo "<script>callprogressHora(".round($porcentaje).",".$a.",".$total.")</script>"; //llamo a la función JS(JavaScript) para actualizar el progreso
            flush(); //con esta funcion hago que se muestre el resultado de inmediato y no espere a terminar todo el bucle
            ob_flush();
