...
class sql_adminRankingPreinsDemanda extends sql
{
 ...
 ;
            ...
            case "vaciarTablaHorariosBinarios":                
                ...
                $cadena_sql=" TRUNCATE TABLE sga_horarios_binarios";
            break;          
        
            case 'consultarFacultadesTablaInscripciones':
                $cadena_sql=" SELECT DISTINCT ins_fac_cod FACULTAD";
                $cadena_sql.=" FROM ".$this->configuracion['prefijo']."carga_inscripciones";
            break;
            
            case 'consultarProyectosTablaInscripciones':
                $cadena_sql=" SELECT DISTINCT ins_est_cra_cod PROYECTO";
                $cadena_sql.=" FROM ".$this->configuracion['prefijo']."carga_inscripciones";
