   ...
   function cadena_sql($tipo,$variable="")
	{
	 ...
	 switch($tipo)
	 {
              ...
              case 'consultarHorarios':
                ...
                $cadena_sql.=" hor.hor_id, ";
                $cadena_sql.=" hor.hor_id_curso, ";
                $cadena_sql.=" hor.hor_dia_nro, ";
                $cadena_sql.=" hor.hor_hora, ";
                $cadena_sql.=" hor.hor_alternativa, ";
                ...
                $cadena_sql.=" WHERE curso.cur_ape_ano=".$variable['ANO'];
                $cadena_sql.=" AND curso.cur_ape_per=".$variable['PERIODO'];
                $cadena_sql.=" ORDER BY hor.hor_id_curso,hor.hor_dia_nro, hor.hor_hora ";
                        
                break;

              //Oracle
              case 'insertarHorario':
                $variable['SED_ID']=(isset($variable['SED_ID'])?$variable['SED_ID']:'');
                ...
                $cadena_sql=" INSERT";
                $cadena_sql.=" INTO sga_achorarios";
                $cadena_sql.=" (";
                $cadena_sql.=" hor_id,";
                $cadena_sql.=" hor_id_curso,";
                $cadena_sql.=" hor_dia_nro,";
                $cadena_sql.=" hor_hora,";
                $cadena_sql.=" hor_alternativa,";
                $cadena_sql.=" hor_sede,";
                ...
                $cadena_sql.= "'".$variable['HOR_ID_CURSO']."',";
                $cadena_sql.= "'".$variable['HOR_DIA_NRO']."',";
                $cadena_sql.= "'".$variable['HOR_HORA']."',";
                $cadena_sql.= "'".$variable['HOR_ALTERNATIVA']."',";
