...
class funcion_adminConsultarPlanEstudioAsisVice extends funcionGeneral {
  ...
  private $datosPlan;
    ...
    function __construct($configuracion) {
        ...
        $this->formulario="adminConsultarPlanEstudioAsisVice";
...
<table class="contenidotabla centrar" width="100%" >
    ...
    */
    function verRegistro() {
      ...
      $this->cadena_sql=$this->sql->cadena_sql($this->configuracion,"listaPlanesEstudio",$variable,'');//echo $this->cadena_sql;exit;
...
<table  class="contenidotabla centrar" width="100%" >
    ...
    <tr class='bloquecentralcuerpo'>
        ...
        {
            $this->cadena_sql = $this->sql->cadena_sql($this->configuracion, "facultad", $registro[$i][8]);//echo $this->cadena_sql;exit;
    ...
    {
        $this->cadena_sql = $this->sql->cadena_sql($this->configuracion, "cantidadPlanes", $id);//echo $this->cadena_sql;exit;
        $numeroPlanes = $this->accesoGestion->ejecutarAcceso($this->cadena_sql, "busqueda");

        $this->cadena_sql = $this->sql->cadena_sql($this->configuracion, "listaPlanes", $id);//echo $this->cadena_sql;exit;
        $registro = $this->accesoGestion->ejecutarAcceso($this->cadena_sql, "busqueda");
...
<br>
    ...
    function mostrarEnlaceExtrinsecas() {
      ...
      $variable = "pagina=adminConsultarElectivosExtrinsecosAsisVice";
      $variable.="&opcion=ver";
