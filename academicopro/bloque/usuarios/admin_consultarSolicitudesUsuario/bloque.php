...
//Clase
class bloque_adminConsultarSolicitudesUsuario extends bloque {
  ...
  public function __construct($configuracion) {
    ...
    //$this->tema = $tema;
    $this->funcion = new funcion_adminConsultarSolicitudesUsuario($configuracion);
...
$esteBloque = new bloque_adminConsultarSolicitudesUsuario($configuracion);
