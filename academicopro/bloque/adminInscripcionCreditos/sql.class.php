...
class sql_adminInscripcionCreditos extends sql
...
//                    $this->cadena_sql.=" AND CUR_CRA_COD=".$variable[0][1];  //codigo del proyecto curricular
                ...
                case 'datosCoordinador':
                    ...
                    $this->cadena_sql="select usucra_cra_cod from geusucra ";
                    $this->cadena_sql.=" inner join geusuario on usucra_nro_iden= usu_nro_iden ";
                    $this->cadena_sql.="where usucra_nro_iden= ".$variable;
