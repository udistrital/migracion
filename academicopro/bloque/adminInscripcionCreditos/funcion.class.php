...
class funcion_adminInscripcionCreditos extends funcionGeneral
{
	...
	function __construct($configuracion)
	    ...
	    $this->log_us= new log();
            $this->formulario="adminInscripcionCreditos";
                              ...
                              if(is_array($registroCreditosInscritos))
                                  {
                                      ...
                                      $this->cadena_sql=$this->sql->cadena_sql($configuracion,"datosCoordinador",$this->usuario);
                                      $resultadoDatosCoordinador=$this->accesoOracle->ejecutarAcceso($this->cadena_sql,"busqueda");

                                      if($resultadoDatosCoordinador[0][0]==134)
                                          {
                                          ?>
                                            <table align="center" >
                                            <tr class="centrar">
                                            ...
                                            <img src="<?echo $configuracion['site'].$configuracion['grafico']?>/clean.png" width="30" height="30" border="0"><br>Adicionar Electivas
                                            </a>
                                            </td>
                                        </tr>
                                        </table>
        ...
        function HorarioEstudiante($configuracion, $resultado_grupos)
			...
			<tbody>
                ...
                for($j=0;$j<count($resultado_grupos);$j++){
                    ...
                    $this->cadena_sql=$this->sql->cadena_sql($configuracion,"horario_grupos",$variables);//echo $this->cadena_sql;exit;
