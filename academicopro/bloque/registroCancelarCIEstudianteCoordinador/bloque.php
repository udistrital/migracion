...
//Clase
class bloque_registroCancelarCIEstudianteCoordinador extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql=new sql_registroCancelarCIEstudianteCoordinador();
 		$this->funcion=new funciones_registroCancelarCIEstudianteCoordinador($configuracion, $this->sql);
...
$esteBloque=new bloque_registroCancelarCIEstudianteCoordinador($configuracion);
