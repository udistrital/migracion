...
class bloque_registroCancelarInscripcionCreditosEstudiante extends bloque
{
	...
	{
 		$this->sql=new sql_registroCancelarInscripcionCreditosEstudiante();
 		$this->funcion=new funciones_registroCancelarInscripcionCreditosEstudiante($configuracion, $this->sql);
