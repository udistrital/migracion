...
class sql_registroCancelarInscripcionCreditosEstudiante extends sql {
    function cadena_sql($configuracion,$opcion,$variable="") {
        ...
        case 'verificar_espacio_reprobado':

        $cadena_sql="SELECT not_asi_cod ";
        $cadena_sql.="from acnot ";
        $cadena_sql.=" where not_est_cod=".$variable[0];
        $cadena_sql.=" and not_asi_cod=".$variable[4];
