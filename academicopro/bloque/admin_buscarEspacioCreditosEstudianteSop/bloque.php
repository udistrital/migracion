...
//Clase
class bloque_adminBuscarEspacioCreditosEstudianteSop extends bloque {

  public $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarEspacioCreditosEstudianteSop();
    $this->funcion = new funcion_adminBuscarEspacioCreditosEstudianteSop($this->configuracion, $this->sql);
  }
...
$esteBloque = new bloque_adminBuscarEspacioCreditosEstudianteSop($configuracion);
