...
//Clase
class bloque_adminConsultarInscripcionEstudianteCoorHoras extends bloque {
  ...
  public function __construct($configuracion) {
    ...
    //$this->tema = $tema;
    $this->funcion = new funcion_adminConsultarInscripcionEstudianteCoorHoras($configuracion);
...
$esteBloque = new bloque_adminConsultarInscripcionEstudianteCoorHoras($configuracion);
