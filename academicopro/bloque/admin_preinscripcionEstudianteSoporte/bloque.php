...
//Clase
class bloque_adminPreinscripcionEstudianteSoporte extends bloque
{

	 public function __construct($configuracion)
	{	include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
		$this->tema=$tema;
		$this->funcion=new funcion_adminPreinscripcionEstudianteSoporte($configuracion);
		$this->sql=new sql_adminPreinscripcionEstudianteSoporte();
	}
...
$obj_aprobar=new bloque_adminPreinscripcionEstudianteSoporte($configuracion);
