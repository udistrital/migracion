...
class bloque_adminBuscarGruposProyectoPosgrado extends bloque {

  private $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarGruposProyectoPosgrado();
    $this->funcion = new funcion_adminBuscarGruposProyectoPosgrado($configuracion, $this->sql);
  }
...
$esteBloque = new bloque_adminBuscarGruposProyectoPosgrado($configuracion);
