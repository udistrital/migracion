    ...
    function cadena_sql($tipo, $variable="", $variable2="") {
        switch ($tipo) {
            ...
            case 'consultarInscripcionAutomatica':
                $cadena_sql = "SELECT ace_cod_evento, ace_cra_cod, ace_fec_ini";
            ...
            case "buscar_planEstudioEstudiante":
                $cadena_sql = "SELECT estudiante_idPlanEstudio, estudiante_idProyectoCurricular FROM " . $this->configuracion["prefijo"];
            ...
            case "obsAprobacionEspacios":
                $cadena_sql = "UPDATE " . $this->configuracion["prefijo"] . "planEstudio ";
