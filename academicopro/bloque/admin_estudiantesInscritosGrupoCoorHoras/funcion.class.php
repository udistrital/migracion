        ...
        function armarVistaGrupo() {
          ...
          <div style="margin: 5px">
              <table class="sigma contenidotabla">
                ...
                if ($resultadoDatosProyecto[0]['CODIGO']==105)
                {
                    $resultadoDatosEstudiante[0]['VERIFICACION']=array('CODIGO'=>$estudiante['CODIGO']);
                }else
                    {
              ...
              ?><table>
                  <tr>
                    ...
                    <td><input type="hidden" name="opcion" value="procesar">
                      ...
                      <input type="hidden" name="destino" value="registro_cambiarGrupoEstudianteGrupoCoorHoras">
