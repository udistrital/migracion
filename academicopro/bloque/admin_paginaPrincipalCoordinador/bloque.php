...
//Clase
class bloque_admin_paginaPrincipalCoordinador extends bloque
{

	 public function __construct($configuracion)
	{	include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
		$this->tema=$tema;
		$this->funcion=new funcion_admin_paginaPrincipalCoordinador($configuracion);
	...
	function html($configuracion)
	{
		...
		{
                    case 'proyectos':
                        $this->funcion->proceso_inscripcion($configuracion);
                        break;
...
$obj_aprobar=new bloque_admin_paginaPrincipalCoordinador($configuracion);
