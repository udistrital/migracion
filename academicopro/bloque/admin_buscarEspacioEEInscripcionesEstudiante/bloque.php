...
//Clase
class bloque_adminBuscarEspacioEEInscripcionesEstudiante extends bloque {

  public $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_adminBuscarEspacioEEInscripcionesEstudiante();
    $this->funcion = new funcion_adminBuscarEspacioEEInscripcionesEstudiante($this->configuracion, $this->sql);
  }
  ...
  function action() {
    switch ($_REQUEST['opcion']) {
      ...
      case "adicionar":
        ...
        $variable = "pagina=admin_buscarEspacioEEInscripcionesEstudiante";
...
$esteBloque = new bloque_adminBuscarEspacioEEInscripcionesEstudiante($configuracion);
