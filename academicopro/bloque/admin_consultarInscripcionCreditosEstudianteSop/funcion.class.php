...
class funcion_adminConsultarInscripcionCreditosEstudianteSop extends funcionGeneral {
  ...
  function __construct($configuracion) {
    ...
    $this->tema = $tema;
    $this->sql = new sql_adminConsultarInscripcionCreditosEstudianteSop($this->configuracion);
    $this->log_us = new log();
    $this->formulario = "admin_consultarInscripcionCreditosEstudianteSop";
            ...
            <td>
              ...
              ?>
                ...
                ?>
                  ...
                  $variables = "pagina=admin_buscarGruposEstudianteCreditosSop";
                  $variables.="&opcion=cambiar";
                  $destino = "&parametro==";
                  $destino.="&destino=registro_cambiarGrupoInscripcionCredEstudianteSop";
                  $destino.="&retorno=admin_consultarInscripcionCreditosEstudianteSop";
                ...
                ?>
                  ...
                  <?
                  $pagina = $this->configuracion["host"] . $this->configuracion["site"] . "/index.php?";
                  $variables = "pagina=registro_cancelarInscripcionCredEstudianteSop";
                    ...
                    <tr class="centrar">
                        ...
                        //enlace para adicionar espacios academicos
                                if (($vista == 1 || $vista == 2))
                                {
                                    $creditosInscritos=$this->calcularCreditos($resultadoInscritos);
                                    $pagina=$this->configuracion["host"].$this->configuracion["site"]."/index.php?";
                                    $variable="pagina=admin_buscarEspacioCreditosEstudianteSop";
                    ...
                    <tr>
                        ...
                        <?      //enlace para adicionar Electivos Extrinsecos
                                ...
                                {//no permite adicionar para estudiantes nuevos
                                            $creditosInscritos=$this->calcularCreditos($resultadoInscritos);
                                            $pagina=$this->configuracion["host"].$this->configuracion["site"]."/index.php?";
                                            $variable="pagina=admin_buscarEspacioEECreditosEstudianteSop";
                                            $variable.="&opcion=espacios";
                                            $variable.="&planEstudioEstudiante=" . $datosEstudiante['planEstudioEstudiante'];
                                            $variable.="&codProyectoEstudiante=" . $datosEstudiante['codProyectoEstudiante'];
                                            $variable.="&codEstudiante=".$datosEstudiante['CODIGO'];
