 ...
 * @subpackage Consulta
 */
class bloque_menuPreinscritosDemandaCoordinador extends bloque
{
  ...
  /**
	...
	{	
		...
		//$this->tema=$tema;
		$this->funcion=new funcion_menuPreinscritosDemandaCoordinador($configuracion);
 ...
 */
$esteBloque=new bloque_menuPreinscritosDemandaCoordinador($configuracion);
