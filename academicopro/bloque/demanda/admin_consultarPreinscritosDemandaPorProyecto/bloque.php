 ...
 */
class bloque_adminConsultarPreinscritosDemandaPorProyecto extends bloque
{
  ...
  /**
	...
	{	
		...
		//$this->tema=$tema;
		$this->funcion=new funcion_adminConsultarPreinscritosDemandaPorProyecto($configuracion);
	...
	function html()
	{
		...
		switch($_REQUEST['opcion'])
		{
			...
			case "reporte":
                                //por defecto presenta el reporte de creditos, 
				$this->funcion->mostrarReporte();
				break;
			...
			case "verProyectos":
				...
				break;
                        ...
                        case "consultarListadoEstudiantes":
                                $this->funcion->mostrarListadoEstudiantesProyecto();
                        break;                            
 ...
 */
$esteBloque=new bloque_adminConsultarPreinscritosDemandaPorProyecto($configuracion);
