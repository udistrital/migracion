...
class sql_registro_cancelarEspacioPreinscripcionDemandaEstud extends sql {
    ...
    function cadena_sql($opcion,$variable="")
    {
        ...
        switch($opcion)
        {
            ...
            case 'cancelar_espacio_oracle':
                ...
                $cadena_sql=" UPDATE ACINSDEMANDA SET INSDE_ESTADO='I'";
...
//                $cadena_sql.=" AND INS_PER = ".$variable['periodo'];
            ...
            case 'desbloquear_espacio_oracle':

                $cadena_sql=" UPDATE ACINSDEMANDA SET INSDE_ESTADO='A'";
                $cadena_sql.=" WHERE INSDE_ANO=".$variable['ano'];
                $cadena_sql.=" AND INSDE_PER=".$variable['periodo'];
                $cadena_sql.=" AND INSDE_EST_COD=".$variable['codEstudiante'];
                $cadena_sql.=" AND INSDE_ASI_COD=".$variable['codEspacio'];
