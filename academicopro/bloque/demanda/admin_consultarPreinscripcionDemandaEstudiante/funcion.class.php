...
class funcion_admin_consultarPreinscripcionDemandaEstudiante extends funcionGeneral {
  ...
  function __construct($configuracion) {
    ...
    elseif ($this->nivelUsuario[0][0]==51){
             ...
             if(is_array($arreglo_permisos))
            {
                ...
                if ($preinscripcion=='S')
                {
                    ...
                    if ($this->usuario!=$this->datosEstudiante[0]['CODIGO'])
                    {
                        ...
                        {
                            $this->presentarPreinscripcionesCanceladas($resultadoCancelados, $evento);
...
//                            $this->presentarPreinscripcionesEstudiante($resultadoCancelados, $registroEstudiante, $permiso,'I',$mensaje);
        ...
        {
            $this->iniciarTabla();
            echo "*En este momento se est&aacute;n actualizando sus datos para Preinscripciones. Por favor intente m&aacute;s tarde.*";
            $this->cerrarTabla();
        }
...
?>
   ...
   <div class="espacios_horario" ><b><?echo "Datos Estudiante";?></b></div>
    <div class="columna0">
     ...
     <div class="columna_1">
       <div class="datos"><? echo  "Nombre: <strong>".htmlentities($this->datosEstudiante[0]['NOMBRE'])."</strong>"; ?></div>
     ...
     <div class="datos"><? echo "Proyecto Curricular: <strong>".$this->datosEstudiante[0]['COD_CARRERA'] . " - " . htmlentities($this->datosEstudiante[0]['NOMBRE_CARRERA'])."</strong><br>"; ?></div>
     </div>
...
<?
  ...
  function adicionar($creditos, $maxSemestres,$tipo) {      
    ...
    $this->cripto = new encriptar();
                        ...
                        $variable = "pagina=admin_buscarEspacioPreinscripcionDemandaEstudiante";
              ...
              ?>
                ...
                if ($vista == 'adicion' || $vista == 'cancelacion') {
                 ...
                 ?>
                  ...
                  $destino="&retorno=admin_consultarPreinscripcionDemandaEstudiante";
