...
class funcion_adminBuscarEspacioEECreditosEstudiante extends funcionGeneral {      //Crea un objeto tema y un objeto SQL.
...
<?
    ...
    function enlaceAdicionar($datosEspacio, $datosGenerales) {
        $parametro = "=";
                  ...
                  $variables.="&retorno=admin_buscarEspacioEECreditosEstudiante";
