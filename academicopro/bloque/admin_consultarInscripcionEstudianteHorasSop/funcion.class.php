...
class funcion_adminConsultarInscripcionEstudianteHorasSop extends funcionGeneral {
  ...
  function __construct($configuracion) {
    ...
    $this->tema = $tema;
    $this->sql = new sql_adminConsultarInscripcionEstudianteHorasSop();
    $this->log_us = new log();
    $this->parametrosHoras=array();
    $this->formulario = "admin_consultarInscripcionEstudianteHorasSop";
            ...
            <td>
              ...
              ?>
                ...
                ?>
                  ...
                  $variables = "pagina=admin_buscarGruposEstudianteHorasSop";
                  $variables.="&opcion=cambiar";
                  $destino = "&parametro==";
                  $destino.="&destino=registro_cambiarGrupoEstudianteHorasSop";
                  $destino.="&retorno=admin_consultarInscripcionEstudianteHorasSop";
               ...
               <?
                ...
                ?>
                  ...
                  <?
                  $pagina = $this->configuracion["host"] . $this->configuracion["site"] . "/index.php?";
                  $variables = "pagina=registro_cancelarInscripcionEstudianteHorasSop";
    ...
    $this->cripto = new encriptar();
      ...
      ?>
        ...
        <td>
            <button class="botonEnlacePreinscripcion" onclick="window.location = 
                '<?
                        $variable = "pagina=admin_buscarEspacioEstudianteHorasSop";
