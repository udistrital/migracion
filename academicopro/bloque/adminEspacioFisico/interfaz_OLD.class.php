                                    ...
                                    <li id="foli6" class="notranslate leftHalf      ">
                                        ...
                                        <div id="DIV_<? echo $atributos[$i]["NOM_ID"] ?>">
                                            <? if ($atributos[$i]['NOM_ID'] == 'EFA04') {                                                      
                                                ...
                                                <input id="<? echo $atributos[$i]['NOM_ID']; ?>" name="<? echo $atributos[$i]['NOM_ID']; ?>" type="text" class="field text large" value="<? echo $dato ?>" maxlength="2" tabindex="<?$tab++?>" onBlur="xajax_armarCodigoEspacio(document.getElementById('EFA04').value, document.getElementById('EFA06').value, temp)" onKeyPress= "<? if ($cadenaValidacion != NULL)
                                echo $cadenaValidacion ?>" />                                                
                                                       <?
                                                   }else if ($atributos[$i]['NOM_ID'] == 'EFA05') {
                                                       ?>
                                                <input id="<? echo $atributos[$i]['NOM_ID']; ?>" name="<? echo $atributos[$i]['NOM_ID']; ?>" type="text" class="field text large" value="<? echo $dato ?>" maxlength="2" tabindex="<?$tab++?>" onBlur="xajax_armarCodigoEspacio(document.getElementById('EFA05').value, document.getElementById('EFA06').value, 'EFA05')" onKeyPress= "<? if ($cadenaValidacion != NULL)
                                       echo $cadenaValidacion ?>"/>
                                                       <?
                                                ...
                                                ?>
                                                <input id="<? echo $atributos[$i]['NOM_ID']; ?>" name="<? echo $atributos[$i]['NOM_ID']; ?>" type="text" class="field text large" value="<? echo $dato ?>" maxlength="4" tabindex="<?$tab++?>" onKeyPress= "<? if ($cadenaValidacion != NULL)
                                echo $cadenaValidacion ?>" />
                                                       <?
                                                   } else if ($atributos[$i]['NOM_ID'] == 'EFA06') {
                                                       ?>
                                                <input id="<? echo $atributos[$i]['NOM_ID']; ?>" name="<? echo $atributos[$i]['NOM_ID']; ?>" type="text" class="field text large" value="<? echo $dato ?>" maxlength="11" tabindex="<?$tab++?>" onBlur="<? if ($cadenaValidacion != NULL)
                                       echo $cadenaValidacion ?>" onkeyup = "this.value=this.value.toUpperCase()"/>
                                                       <?
                                                   }else {
                                                       ?>
                                                <input id="<? echo $atributos[$i]['NOM_ID']; ?>" name="<? echo $atributos[$i]['NOM_ID']; ?>" type="text" class="field text large" value="<? if ($dato != '')
                                       echo $dato ?>" maxlength="50" tabindex="<?$tab++?>" onKeyPress="<? if ($cadenaValidacion != NULL)
                                   echo $cadenaValidacion ?>" onkeyup = "this.value=this.value.toUpperCase()"/>
                <? } ?>
                                        </div>
                                    </li>
                    ...
                    for ($i = 0; $i < $cant_res; $i++) {
                        ...
                        <tr class="<? echo $clase ?>">
                            ...
                            for ($j = 0; $j < $cant_atributos; $j++) {
                                ...
                                if ($atributos[$j]['LIS']) {
                                    ...
                                    <td class="centrar">
                                        ...
                                        if ($resultados[$i][$nombre_campo] == NULL) {
                            ...
                            if ($opcion == "EliminarModificar" && $espacio != '1') {
                                ...
                                ?>
                                <td class="centrar">
                                    <a onclick="if(confirm('Señor usuario, ¿Confirma que desea eliminar el registro?'))  {window.location ='<? echo $indice . $variable; ?>'} ">
                                ...
                                ?>
                                <td class="centrar">
                                    <a onclick="if(confirm('Señor usuario, ¿Confirma que desea recuperar el registro?'))  {window.location ='<? echo $indice . $variable; ?>'} ">
        ...
        <html>
            ...
            <body id="public">
                ...
                <? echo $atributos[$i]['NOM_FORM'] ?>
                                        ...
                                        <div id="DIV_<? echo $atributos[$i]["NOM_ID"] ?>">
                                                   <? if ($atributos[$i]['NOM_ID'] == 'EFA04') { ?>
                                                <input id="<? echo $atributos[$i]['NOM_ID']; ?>" name="<? echo $atributos[$i]['NOM_ID']; ?>" type="text" class="field text large" value="<? echo $dato ?>" maxlength="2" tabindex="19" onBlur="xajax_armarCodigoEspacio(document.getElementById('EFA04').value, document.getElementById('EFA06').value)" onKeyPress= "<? if ($cadenaValidacion != NULL)
                                       echo $cadenaValidacion ?>" />                                                
                                                       <?
                                                   }else if ($atributos[$i]['NOM_ID'] == 'EFA05') {
                                                       ?>
                                                <input id="<? echo $atributos[$i]['NOM_ID']; ?>" name="<? echo $atributos[$i]['NOM_ID']; ?>" type="text" class="field text large" value="<? echo $dato ?>" maxlength="2" tabindex="19" onBlur="xajax_armarCodigoEspacio(document.getElementById('EFA05').value, document.getElementById('EFA06').value)" onKeyPress= "<? if ($cadenaValidacion != NULL)
                                       echo $cadenaValidacion ?>"/>
                                                       <?
                                                   }else if ($atributos[$i]['NOM_ID'] == 'EFA12') {
                                                       ?>
                                                ...
                                                ?>
                                                <input id="<? echo $atributos[$i]['NOM_ID']; ?>" name="<? echo $atributos[$i]['NOM_ID']; ?>" type="text" class="field text large" value="<? echo $dato ?>" maxlength="4" tabindex="19" onKeyPress= "<? if ($cadenaValidacion != NULL)
                                       echo $cadenaValidacion ?>" />
                                                       <?
                                                   } else {
                                                       ?>
                                                <input id="<? echo $atributos[$i]['NOM_ID']; ?>" name="<? echo $atributos[$i]['NOM_ID']; ?>" type="text" class="field text large" value="<? echo $dato ?>" maxlength="50" tabindex="19" onKeyPress="<? if ($cadenaValidacion != NULL)
                                       echo $cadenaValidacion ?>" onkeyup = "this.value=this.value.toUpperCase()"/>
                <? } ?>
                                        </div>
                                    </li>
                            ...
                            <li class="buttons ">
                                <div>
                                    ...
                                    <input class="btTxt submit" type="button" style='cursor:pointer;' onclick="if(confirm('Señor usuario, ¿Confirma que desea realizar la modificación?'))  {<? echo $this->formulario ?>.submit()} " name="modificar" value='Modificar'/></div>
                            </li>
                        </ul>
                    </form>
                </div><!--container-->
                    ...
                    <form id="form92" name="form92" class="wufoo  page" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <ul>
                            <li id="foli6" class="notranslate leftHalf      ">
                                ...
                                <input id="id_espacio" type="text" class="field text large" value="" maxlength="255" tabindex="19" onkeypress="javascript:if(event.keyCode==13){ xajax_buscarEspacioFisicoAcademico(document.getElementById('id_espacio').value); return false;}" />
                            </li>
                            <br><br><br>
                                    ...
                                    <tbody>
                                        ...
                                        for ($i = 0; $i < $cantAtributos; $i++) {
                                            ...
                                            <tr class="statement435">
                                                ...
                                                <td title="Dato">                                                    
                                                    <label for="Field435_1"><? echo $espacioFisicoA[0][$nombreCampo] ?></label>
                                                </td>
                                            </tr>
        <? } ?>
                                    </tbody>
