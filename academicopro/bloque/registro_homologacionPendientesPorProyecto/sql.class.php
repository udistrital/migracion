...
class sql_registroHomologacionPendientes extends sql {
    ...
    function cadena_sql($opcion,$variable="") {
        ...
        switch($opcion) {
            ...
            case 'consultarNotasEstudiante':
                            ...
                            //$cadena_sql.=" AND NOT_NOTA IS NOT NULL";
                        //    $cadena_sql.=" AND NOT_EST_COD=20081279035 ";
            ...
            case 'consultarEspaciosProyecto':
                ...
                case 'actualizar_homologacion':
                    $cadena_sql=" UPDATE ACNOT SET NOT_EST_REG='".$variable['estado']."'" ;
                    $cadena_sql.=" WHERE ";
                    $cadena_sql.="not_asi_cod=".$variable['NOT_ASI_COD_INS']; 
                    $cadena_sql.=" AND not_est_cod=".$variable['NOT_EST_COD'];
                    $cadena_sql.=" AND not_ano=".$variable['NOT_ANO'];
                    $cadena_sql.=" AND not_per=".$variable['NOT_PER'];
                break;
