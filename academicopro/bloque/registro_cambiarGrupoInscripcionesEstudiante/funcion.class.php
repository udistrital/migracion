 ...
 */        
    ...
    function verificarInscrito($retorno,$espaciosInscritos) {
        ...
        foreach ($espaciosInscritos as $inscritos)
        {
            ...
            {
                $inscrito='ok';
                if ($inscritos['GRUPO']!=$this->datosInscripcion['grupoAnterior'])
                {
    ...
    function registrarCambioGrupo($retorno) {
        ...
        if($cambioGrupo>=1)
        {
            ...
            $variablesRegistro=array('usuario'=>$this->usuario,
                                      ...
                                      'registro'=>$this->ano."-".$this->periodo.", ".$datos['codEspacio'].", ".$this->datosInscripcion['grupoAnterior'].", ".$this->datosInscripcion['grupo'].", ".$this->datosEstudiante[0]['PLAN_ESTUDIO'].", ".$this->datosInscripcion['carrera'],
        ...
        else
          {
              ...
              $variablesRegistro=array('usuario'=>$this->usuario,
                                        ...
                                        'registro'=>$this->ano."-".$this->periodo.", ".$datos['codEspacio'].", ".$this->datosInscripcion['grupoAnterior'].", ".$this->datosInscripcion['grupoAnterior'].", ".$this->datosEstudiante[0]['PLAN_ESTUDIO'].", ".$this->datosEstudiante[0]['COD_CARRERA']."",
                                        'afectado'=>$this->datosEstudiante[0]['CODIGO']);
          }
