...
<?
            ...
            <td>
              ...
              ?>
                ...
                ?></td><?
                  ...
                  $parametros = "&codProyecto=" . (isset($datosEstudiante['codProyecto'])?$datosEstudiante['codProyecto']:'');
  ...
  function consultarFechas($datosFechas) {
      $cadena_sql=$this->sql->cadena_sql('fechas_activas_coordinador', $datosFechas);//echo $cadena_sql;exit;
...
<?
  ...
  function consultaEspaciosInscritos($variablesInscritos) {
      $cadena_sql = $this->sql->cadena_sql("consultaEspaciosInscritos", $variablesInscritos);//echo $cadena_sql;exit;
