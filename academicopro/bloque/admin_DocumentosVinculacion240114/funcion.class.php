...
function historialPagos()
    {   
        ...
        $this->acceso_nominaVE=$this->conectarDB($this->configuracion,"docentesVE");
...
function historialPagosSIC()
    ...
    ?>
        <table id="tabla"  class="contenidotabla" width="100%" border ="1">
                    <thead class='sigma'>
                        <th class='espacios_proyecto' colspan ="6"><?echo " PAGOS ".$_REQUEST['vigenciaPago'].'-'.$_REQUEST['mesPago']; ?></th>
                    </thead>
                    <thead class='sigma'>
                    <th class='niveles centrar' > Rubro </th>    
                    <th class='niveles centrar' > Compromiso </th>    
                    <th class='niveles centrar' > Orden de Pago </th>    
                    <th class='niveles centrar' > Fecha Orden de pago </th>    
                    <th class='niveles centrar' > Valor Orden de pago </th>    
                    <th class='niveles centrar' > Descripci&oacute;n</th>    
                    </thead>
                    <?
                    ...
                    if(is_array($datoPagos))
                        {   foreach ($datoPagos as $key => $value) 
                                ...
                                ?> <tr >
                                        <td width="30%" class='cuadro_plano centrar'rowspan='2' >
                                         <? echo $datoPagos[$key]['RUBRO'];?>
                                        </td>
                                        <td width="5%" class='cuadro_plano'>
                                         <? echo $datoPagos[$key]['NUMERO_COMPROMISO'];?>
                                        </td>
                                        <td width="5%" class='cuadro_plano'>
                                        ...
                                        <td width="20%" class='cuadro_plano'>
                                         <? echo number_format ( $datoPagos[$key]['VALOR_ORDEN'],2,'.',',' ); ?>
                                        </td>
                                        <td width="30%" class='cuadro_plano'>
                                    ...
                                    <tr >
                                        ...
                                        <td class='cuadro_plano centrar' colspan ='5'>
                                             <table id="tabla"  class="contenidotabla" width="100%" border ="1">
                                                    <thead class='sigma'>
                                                        <th class='espacios_proyecto' colspan ="6"><?echo "DETALLE DE PAGO - ORDEN ".$datoPagos[$key]['ORDEN_PAGO']; ?></th>
                                                    </thead>
                                                    <thead class='sigma'>
                                                    <th class='niveles centrar' > Detalle descuento </th>    
                                                    <th class='niveles centrar' > Valor Base </th>    
                                                    <th class='niveles centrar' > % </th>    
                                                    <th class='niveles centrar' > Valor descuento </th>    
                                                    </thead>
                                                    <? if(is_array($datoDesc))
                                                            {$totalDesc=0;
                                                             foreach ($datoDesc as $desc => $value) 
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="25%" class='cuadro_plano centrar' >
                                                                     <? echo number_format ($datoDesc[$desc]['BASE_RTE'],2,'.',',' ); ?>
                                                                    </td>
                                                                    <td width="10%" class='cuadro_plano centrar'>
                                                                     <? echo $datoDesc[$desc]['PORC_DESC'];?>
                                                                    </td>
                                                                    <td width="25%" class='cuadro_plano centrar'>
                                                            ...
                                                            ?>
                                                            <tr>
                                                                <td width="75%" colspan='3' class='cuadro_plano'>
                                                                 Total Descuento
                                                                </td>
                                                                <td width="25%" class='cuadro_plano centrar'>
                                                            ...
                                                            <tr>
                                                                <td width="75%" class='niveles centrar' colspan='3'>
                                                                    <b>TOTAL DEVENGO</b>
                                                                </td>
                                                                <td width="25%" class='niveles centrar'>
                                                                 <b><? echo number_format (($datoPagos[$key]['VALOR_ORDEN']-$totalDesc),2,'.',',' ); ?></b>
                                                                </td>
                                                            </tr>
                                                        <?  }
                                                       else {  ?>
...
function generarDespendible()
    {   $encabezado = $this->armarEncabezado();
        $documento = $this->historialPagosPdf();
...
function historialPagosPdf()
  ...
  function generarPDF($doc_html,$encabezado, $pie_pagina,$cod_usuario){
    ...
    function armarEncabezado(){
        ...
        $html.='    <div class="datos">';
        $html.='<p><font face="arial" size=6 >&nbsp;DESPRENDIBLE DE PAGO</b></font><b></p>';
  ...
  function mostrarEnlaceGenerarReporte() {
            ...
            echo "<div align='center' id='right' style='float:right;width:50%;' ><p> <a href='".$pagina.$variable."'  class='enlaceHomologaciones'><font face='arial' size=3 color=green >:: Descargar Desprendible</font></a></p></div>";
