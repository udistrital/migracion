 ...
 * @subpackage Consulta
 */
class funcion_menuPreinscritosDemandaCoordinador extends funcionGeneral
{
	...
	function __construct($configuracion) {
	    ...
	    $this->sql=new sql_menuPreinscritosDemandaCoordinador($configuracion);
        ...
        function mostrarMenuNavegacion() {
            ...
            //Enlace consultar preincripciones por demanda por espacio
            ...
            ?>                
                ...
                <div>
                  <img src="<? echo $this->configuracion['site'] . $this->configuracion['grafico'] ?>/listas.png" width="40" height="40" border="0">
                <a href="<?= $pagina.$variable?>">Consulta por Espacio | </a>                
            <?
                        
            //Enlace consultar preincripciones por demanda por proyecto
            $pagina = $this->configuracion["host"] . $this->configuracion["site"] . "/index.php?";
            ...
            $variable= $this->cripto->codificar_url($variable, $this->configuracion);
            ?>
                <a href="<?= $pagina.$variable?>">Consulta por Proyecto | </a>               
            <?
            
            //Enlace consultar preincripciones por demanda por estudiante
            $pagina = $this->configuracion["host"] . $this->configuracion["site"] . "/index.php?";
            $variable = "pagina=admin_consultarPreinscripcionDemandaPorEstudiante";
            $variable.="&opcion=verProyectos";          
            $variable= $this->cripto->codificar_url($variable, $this->configuracion);
            ?>
                <a href="<?= $pagina.$variable?>">Consulta por Estudiante | </a>
                </div>
                <hr>
            <?
