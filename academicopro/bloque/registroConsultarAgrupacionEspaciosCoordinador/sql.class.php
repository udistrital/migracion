...
class sql_registroConsultarAgrupacionEspaciosCoordinador extends sql {
    function cadena_sql($configuracion,$conexion, $opcion,$variable="") {
        ...
        switch($opcion) {
            ...
            case 'buscarEncabezados':
               ...
               $cadena_sql.="encabezado_creditos, encabezado_nivel, id_clasificacion ";
               ...
               $cadena_sql.=" ORDER BY encabezado_nivel, id_encabezado";
            ...
            case 'buscarEspacioAsociados':
               $cadena_sql="SELECT ".$configuracion['prefijo']."espacioEncabezado.id_espacio, espacio_nombre, espacio_horasDirecto, espacio_horasCooperativo,espacio_horasAutonomo ";
