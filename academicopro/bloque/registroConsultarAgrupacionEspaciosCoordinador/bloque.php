...
//Clase
class bloque_registroConsultarAgrupacionEspaciosCoordinador extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql=new sql_registroConsultarAgrupacionEspaciosCoordinador();
 		$this->funcion=new funciones_registroConsultarAgrupacionEspaciosCoordinador($configuracion, $this->sql);
...
$esteBloque=new bloque_registroConsultarAgrupacionEspaciosCoordinador($configuracion);
