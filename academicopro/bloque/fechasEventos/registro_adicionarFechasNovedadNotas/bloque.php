...
class bloque_registroAdicionarFechasNovedadNotas extends bloque {

  private $configuracion;

  public function __construct($configuracion) {
    $this->configuracion = $configuracion;
    $this->sql = new sql_registroAdicionarFechasNovedadNotas($configuracion);
    $this->funcion = new funcion_registroAdicionarFechasNovedadNotas($configuracion, $this->sql);
  }
...
$esteBloque = new bloque_registroAdicionarFechasNovedadNotas($configuracion);
