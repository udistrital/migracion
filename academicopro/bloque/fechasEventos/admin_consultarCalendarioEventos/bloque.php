...
//Clase
class bloque_adminConsultarCalendarioEventos extends bloque {
  ...
  public function __construct($configuracion) {
    ...
    //$this->tema = $tema;
    $this->funcion = new funcion_adminConsultarCalendarioEventos($configuracion);
  ...
  function action() {
    switch ($_REQUEST['opcion']) {
        ...
        case "registrar":
            ...
            $variable = "pagina=registro_adicionarFechasCalendario";
...
$esteBloque = new bloque_adminConsultarCalendarioEventos($configuracion);
