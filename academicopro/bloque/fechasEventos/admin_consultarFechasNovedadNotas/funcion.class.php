...
class funcion_adminConsultarFechasNovedadNotas extends funcionGeneral {
  ...
  function __construct($configuracion) {
    ...
    $this->formulario = "admin_consultarFechasNovedadNotas";
    $this->bloque = "fechasEventos/admin_consultarFechasNovedadNotas";
  ...
  function mostrarCalendarioEventos() {
        ...
        echo "          <td>";
        echo "          <b>::::..</b>  Calendario de Novedades de notas para el per&iacute;odo ".$this->calendario[0][0]."-".$this->calendario[0][1];
        ...
        if(is_array($this->calendario)){
                foreach ($this->calendario as $calendario) {
                    ...
                    if($calendario['ACE_ESTADO']=='A' && $this->tipoUser==61 ){
                        ...
                        $variable3="pagina=registro_adicionarFechasNovedadNotas";
  ...
  function mostrarEnlaceRegistrarFechas(){
      ...
      echo "<table width='100%' ><tr><td align='right'><a href='".$enlace_nuevo."'><span>:: Registrar fechas Novedades de nota</span></a><td><tr></table>";
  }
                ...
                <div id="normal" >
                        ...
                        <table class=tablaMarco width="100%" border="0" align="center" cellpadding="4 px" cellspacing="0px" >
                            <tr class=texto_elegante >
                                <td colspan='2'>
                                            <b>::::..</b>  Registrar fechas Novedad de Notas <? echo $this->ano.'-'.$this->periodo; ?>
           ...
           <form enctype='multipart/form-data' method='POST' action='index.php' name='<? echo $this->formulario ?>'>
            <div id="normal" >
                    ...
                    <table class=tablaMarco width="100%" border="0" align="center" cellpadding="4 px" cellspacing="0px" >
                        <tr class=texto_elegante >
                            <td colspan='2'>
                                        <b>::::..</b>  Actualizar fechas Novedad de notas
                                    <hr class=hr_subtitulo>
                            </td>
                        </tr>		
                        <tr>    
