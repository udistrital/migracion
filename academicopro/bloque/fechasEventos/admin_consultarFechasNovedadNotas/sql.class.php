...
class sql_adminConsultarFechasNovedadNotas extends sql { //@ Método que crea las sentencias sql para el modulo admin_noticias
  ...
  function cadena_sql($tipo, $variable="") {
    ...
    switch ($tipo) {
        ...
        case 'calendario_eventos':
                ...
                $cadena_sql.=" AND acd_cod_evento=89";
