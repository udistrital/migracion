...
//            }
        ...
        $cadena_sql=$this->sql->cadena_sql($configuracion,"parametros_plan", $planEstudio);//echo $cadena_sql;exit;
        ...
        $cadena_sql=$this->sql->cadena_sql($configuracion,"asignaturasInscritas", $varInscritos);//echo $cadena_sql;exit;
        ...
        if(is_array($resultado_asignaturas))
            {
                ...
                {
                    $cadena_sql=$this->sql->cadena_sql($configuracion,"creditosInscritos", $resultado_asignaturas[$o][0]);//echo $cadena_sql;exit;
    ...
    <table class='sigma contenidotabla' align='center' width='80%' cellpadding='2' cellspacing='2'>
            ...
            <?$facultadAnterior=0;
                    for($i=0;$i<count($resultado_planEstudio);$i++) {
                        ...
                        $cadena_sql=$this->sql->cadena_sql($configuracion,"carrera_ofrece",$ofrece);//echo "<br>".$cadena_sql;exit;
...
<table class="cuadro_color centrar" width="100%">
    ...
    {
        $cadena_sql=$this->sql->cadena_sql($configuracion,"ano_periodo", '');//echo $cadena_sql_grupos;exit;
        ...
        $cadena_sql=$this->sql->cadena_sql($configuracion,"espacio_canceladoPeriodo", $varibleCancelado);//echo $cadena_sql;exit;
...
<?
        for($p=0;$p<count($resultadoAdicionesAbiertas);$p++){
            ...
            $cadena_sql_grupos=$this->sql->cadena_sql($configuracion,"otros_grupos", $variables);//echo $cadena_sql_grupos;exit;
            $resultado_grupos=$this->ejecutarSQL($configuracion, $this->accesoOracle, $cadena_sql_grupos,"busqueda" );
