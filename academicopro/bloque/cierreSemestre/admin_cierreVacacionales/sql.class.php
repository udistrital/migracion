...
class sql_adminCierreVacacionales extends sql
{
			...
			case "proyecto_curricular":
				...
				break;                            
                        ...
                        case "periodo":
                                ...
                                $cadena_sql.=" WHERE ape_estado IN ('V')";
				...
				break;
                            ...
                            case 'consultarDatosEstudiantesCierre':
                                ...
                                $cadena_sql.=" where A.est_cod in (SELECT DISTINCT ins_est_cod FROM acins where ins_ano=".$variable['anio'];
                                $cadena_sql.=" AND ins_per=".$variable['periodo'];
                                $cadena_sql.=" and ins_gr in (select cur_id from accursos ";
                                $cadena_sql.=" where cur_ape_ano=".$variable['anio'];
                                ...
                                $cadena_sql.=" and H.est_estado in ('A','B','H','T')";
                                $cadena_sql.=" and A.est_estado_est in ('A','B','U','Z','J','T','V','D','K','H')";
                            ...
                            case 'consultarDatosReglamento':
                                $cadena_sql=" SELECT A.est_cra_cod CODIGO_CRA,";
                                $cadena_sql.=" A.est_cod CODIGO,";
