                        ...
                        for($contador=0;$contador<$total;$contador++)
                        {
                                ...
                                $parametro=  $this->cripto->codificar_url($parametro,  $this->configuracion);
                                       echo "<tr> 
                                                 ...
                                                 <td class='cuadro_plano'><a href='".$indice.$parametro."'>".$registro[$contador]['NIVEL']."</a></td>
                                                 <td class='cuadro_plano'><a href='".$indice.$parametro."'>".$registro[$contador]['FACULTAD']."</a></td>
                                                 <td class='cuadro_plano'><a href='".$indice.$parametro."'>".(isset($registro[$contador]['FECHA'])?$registro[$contador]['FECHA']:'')."</a></td>
                                            </tr>";
                        }?>
					  </table>
					</td>
                              ...
                              <tr height='60PX'>
                                ...
                                <tr>
                                    ...
                                    if ($eventoInicio[0]['ACE_FEC_INI']<=$fechaActual&&$eventoInicio[0]['ACE_FEC_FIN']>=$fechaActual)
                                    {
										...
										if(!is_array($consultarEvento71)){//si el registro no existe imprime esto?>
										...
										<?}else{?> 
														...
														<td class="eventos1" valign='middle' width="20%" align='center'>
																<b><?=$_REQUEST['codProyecto']?> Cerró Notas con Éxito.</b>
														</td>
                                                                                ...
                                                                                if(!is_array($consultarEvento71)){
                                                                                        ...
                                                                                        ?><td valign='middle' width="33%" align='center' >
                                                                                            <form enctype='tipo:multipart/form-data,application/x-www-form-urlencoded,text/plain' method='GET' action='index.php' name='//<?// echo $this->formulario?>'>    
                                                                                                    ...
                                                                                                    <input type='hidden' name='periodo' value='<? echo  $variable['anio'].'-'.$variable['periodo'];?>'>
                                                                                                    <input name='estado' value='Cambiar Estados' type='submit'>    
                                                                                            </form>
											</td>
                                                                                    </tr>
                                                                                </table>
