 ...
 */
class bloque_registroRealizarCierreVacacionales extends bloque
{
  ...
  /**
	...
	{	
		...
		//$this->tema=$tema;
		$this->funcion=new funcion_registroRealizarCierreVacacionales($configuracion);
 ...
 */
$esteBloque=new bloque_registroRealizarCierreVacacionales($configuracion);
