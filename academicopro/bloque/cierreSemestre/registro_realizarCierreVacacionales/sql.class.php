 ...
 * @subpackage Consulta
 */
class sql_registroRealizarCierreVacacionales extends sql
{
   ...
   function cadena_sql($tipo,$variable="")
	{
	 ...
	 switch($tipo)
	 {
            ...
            case 'consultarNotasParciales':
                    ...
                    $cadena_sql.=" ON est_cod=ins_est_cod";
...
//                    $cadena_sql.=" AND est_cra_cod=".$variable['codProyecto'];
                    ...
                    //$cadena_sql.=" AND ins_est_cod=20072020014";
            ...
            case 'consultarEstudiantes':
                    ...
                    //$cadena_sql.=" AND est_cod='20072020014'";//para uno solo estudiante
            ...
            case 'consultarNotasInscripcionesProyecto':
                    $cadena_sql="SELECT est_cra_cod COD_PROYECTO,";
                    $cadena_sql.=" ins_est_cod COD_ESTUDIANTE,";
                    $cadena_sql.=" ins_asi_cod COD_ESPACIO,";
                    $cadena_sql.=" ins_ano ANO,";
                    ...
                    $cadena_sql.=" AND ins_obs not in ('11')";
                    $cadena_sql.=" ORDER BY est_cod,ins_asi_cod,ins_nota_acu DESC";
            break;                
                ...
                case 'consultarInicioEvento':
                    $cadena_sql=" SELECT ace_fec_ini INI,";
                    $cadena_sql.=" ace_fec_fin FIN";
                ...
                case 'consultarNotaAprobada':
                    $cadena_sql=" SELECT not_ano ANO,";
                    $cadena_sql.=" not_per PER,";
                    $cadena_sql.=" not_asi_cod COD_ESPACIO,";
                    $cadena_sql.=" not_cra_cod CRA_COD,";
                    ...
                    $cadena_sql.=" WHERE not_asi_cod=".$variable['NOT_ASI_COD'];
                    $cadena_sql.=" AND not_est_cod=".$variable['NOT_EST_COD'];
