...
//Clase
class bloqueAdminMenuCierreSemestre extends bloque
{   
         private $coordinador;
	...
	{
            $this->sql=new sql_adminMenuCierreSemestre($configuracion);
            $this->funcion=new funciones_adminMenuCierreSemestre($configuracion, $this->sql);
	...
	{	switch ($_REQUEST['opcion']){ }
                ...
                if(isset($_REQUEST['proyecto']))
                    { $this->funcion->mostrarRegistro($_REQUEST['proyecto'], $totalRegistros='', $opcion='', $variable='');
                    }
	}
	function action()
	{
...
$esteBloque=new bloqueAdminMenuCierreSemestre($configuracion);
