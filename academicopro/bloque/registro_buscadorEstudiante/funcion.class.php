 ...
 * @subpackage Consulta
 */
class funcion_registroBuscadorEstudiante extends funcionGeneral
{
	...
	function __construct($configuracion) {
	    ...
	    $this->sql=new sql_registroBuscadorEstudiante($configuracion);
            ...
            $this->formulario="registro_buscadorEstudiante";//nombre del bloque que procesa el formulario
