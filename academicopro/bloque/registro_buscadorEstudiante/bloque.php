 ...
 */
class bloque_registroBuscadorEstudiante extends bloque
{
  ...
  /**
	...
	{	
		...
		//$this->tema=$tema;
		$this->funcion=new funcion_registroBuscadorEstudiante($configuracion);
		$this->sql=new sql_registroBuscadorEstudiante($configuracion);
//                include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
	...
	function html()
	{
		...
		switch($_REQUEST['opcion'])
		{
			...
			case "verEstudiante":
				$this->funcion->MostrarBuscadorEstudiante();
				break;
			...
			default:
				echo 'Opci&oacute;n inv&aacute;lida html!!';
				break;
		}
	}
 ...
 */
$esteBloque=new bloque_registroBuscadorEstudiante($configuracion);
