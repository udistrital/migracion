...
//Clase
class bloque_registroComentarioPlanAsisVice extends bloque
{

	 public function __construct($configuracion)
	{	include ($configuracion["raiz_documento"].$configuracion["estilo"]."/basico/tema.php");
		$this->tema=$tema;
		$this->funcion=new funcion_registroComentarioPlanAsisVice($configuracion);
...
$obj_aprobar=new bloque_registroComentarioPlanAsisVice($configuracion);
