...
class sql_registroComentarioPlanAsisVice extends sql {	//@ Método que crea las sentencias sql para el modulo admin_noticias
    ...
    function cadena_sql($configuracion,$conexion,$tipo,$variable="") {
        ...
        switch($tipo) {
           ...
           case "listaCarrera":
                ...
                $this->cadena_sql.="id_proyectoAcademica ";
                $this->cadena_sql.="FROM ".$configuracion["prefijo"];
                $this->cadena_sql.="planEstudio PE ";
                $this->cadena_sql.="INNER JOIN ".$configuracion["prefijo"]."proyectoCurricular PC on PE.id_proyectoCurricular=PC.id_proyectoCurricular ";
            ...
            case "buscarComentarios":
                ...
                $this->cadena_sql.="comentario_general_planEstudio ";
                $this->cadena_sql.=" WHERE comentario_idPlanEstudio=".$variable;
            ...
            case "ingresarComentario":
                $this->cadena_sql="INSERT INTO ".$configuracion["prefijo"]."comentario_general_planEstudio " ;
            ...
            case "actualizaLeido":
                $this->cadena_sql="UPDATE ".$configuracion["prefijo"]."comentario_general_planEstudio ";
                $this->cadena_sql.="SET comentario_leidoAsesorVice='1' ";
                $this->cadena_sql.="WHERE id_comentario=".$variable;
                //$this->cadena_sql.="AND id_planEstudio=".$variable[1];

                break;

            case 'registroLogComentario':

                $this->cadena_sql="insert into ".$configuracion['prefijo']."log_eventos ";
                $this->cadena_sql.="VALUES(0, '".$variable[0]."', ";
                $this->cadena_sql.="'".$variable[1]."', ";
                $this->cadena_sql.="'16', ";
                $this->cadena_sql.="'Comentario Plan Estudio', ";
                $this->cadena_sql.="'".$variable[2]."-".$variable[3].", ";
                $this->cadena_sql.="Creo comentario, ".$variable[4].", ".$variable[5]."', ";
                $this->cadena_sql.="'".$variable[4]."')";

                break;

            case 'registroLogComentarioLeyo':
                ...
                $this->cadena_sql.="'Comentario Plan Estudio', ";
                $this->cadena_sql.="'".$variable[2]."-".$variable[3].", ";
                $this->cadena_sql.="Leyo comentario, ".$variable[4].", ".$variable[5]."', ";
                $this->cadena_sql.="'".$variable[4]."')";
