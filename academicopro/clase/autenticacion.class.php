		...
		<tr>
			<td colspan="2"> 
				...
				<tbody>
					...
					Si el problema persiste por favor contacte al administrador del sistema en:<br><a href="mailto:<? echo $configuracion["correo"]?>"><? echo $configuracion["correo"]?></a><br></td>
                                        <tr class="bloquecentralcuerpo centrar" ><td><b>Recuerde que el sistema C&oacute;ndor est&aacute; optimizado para Mozilla Firefox.</b></td></tr>
