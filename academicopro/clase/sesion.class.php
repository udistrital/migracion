...
/**
    ...
    {
	//var_dump($_COOKIE["aplicativo"]);echo "    COOKIE DE APLICATIVO     ";
		if(isset($_COOKIE["aplicativo"]))
		{
	...
	else 
	{
		...
		$cadena_sql="INSERT INTO ".$configuracion["prefijo"]."valor_sesion(id_sesion,variable,valor) VALUES";
		$cadena_sql.="('".$this->sesion_id."','".$variable."','".$valor."')"; 
			//echo $cadena_sql;
			$resultado=$db_sel->ejecutar_acceso_db($cadena_sql); 
			unset($db_sel);
			return $resultado;				
