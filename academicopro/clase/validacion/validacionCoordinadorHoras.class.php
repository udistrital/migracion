 ...
 */
include_once($this->configuracion["raiz_documento"] . $this->configuracion["clases"] . "/validacion/validaciones.class.php");



class inscripcionHorasGrupoCoordinador {
   ...
   */
    ...
    function crearArregloValidacionesCreditos(){
          ...
          $this->validaciones=array(  //'validarCodigoEstudiante',
                                      ...
                                      'validarCreditosPorClasificacion',
