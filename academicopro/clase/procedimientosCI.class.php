...
<table class="contenidotabla centrar">
    ...
    function crearCadenaHorario($espaciosInscritos) {
        ...
        foreach ($espaciosInscritos as $inscrito) {
            $cadena.="(`hor_asi_cod` =".$inscrito['CODIGO']." AND `hor_nro` =".$inscrito['GRUPO'].") OR ";
        }
    ...
    function consultarHorario($variable) {
        ...
        $resultado=$this->funcionGeneral->ejecutarSQL($this->configuracion, $this->accesoGestion, $cadena_sql,"busqueda" );
        return $resultado;
    }
            ...
            switch ($tipo)
                {
                  ...
                  case 'consultarHorario':
                      ...
                      $cadena_sql.=" FROM ".$this->configuracion['prefijo']."achorario";
