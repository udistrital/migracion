...
$enlaceponenciaDocente['nombre'] = " Registrar Ponencias Docente  ";
	                ...
	                <ul>
	                					 <li><a href="<?php echo $enlaceponenciaDocente['urlCodificada']?>"><?php echo $enlaceponenciaDocente ['nombre']?></a></li>
 										  <li><a href="<?php echo $enlaceregistrarPatentes['urlCodificada']?>"><?php echo $enlaceregistrarPatentes['nombre']?></a></li>
						                	 <li><a href="<?php echo $enlacepremiosDocente['urlCodificada']?>"><?php echo $enlacepremiosDocente['nombre']?></a></li><?php /*/?>
...
<?php */?>
                ...
                <li><a href="#">Bonificaci&oacute;n</a>
	                <ul>
<?php /*/?>
	                     <li><a href="<?php echo $enlacetraduccionesDocente['urlCodificada']?>"><?php echo $enlacetraduccionesDocente['nombre']?></a></li><?php */?>
