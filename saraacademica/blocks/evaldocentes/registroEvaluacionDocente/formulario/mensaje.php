...
echo $this->miFormulario->formulario("inicio",$atributos);
	...
	{
            $tipo = 'information';
            $mensaje = "No hay registros de Docentes en el Proyecto Curricular ".$_REQUEST['nombreCarrera']."!";
            $boton = "regresar";
            
            $valorCodificado="&pagina=indexEvaluacion"; 
            $valorCodificado.="&opcion=nuevo"; 
            //$valorCodificado.="&nombreProceso=".$_REQUEST['proceso']; 
            $valorCodificado.="&bloque=inicioRegistroEvaluacion";
