...
if(isset($_REQUEST['periodo']))
{
    ...
    {
        $tipo = 'information';
        $mensaje = "Estimado docente, usted podrá ver los resultados de la evaluación, una vez haya terminado el proceso de evaluación para el
...
$cadena_sql = $this->sql->cadena_sql("resultadosEvaluacion", $variable);
