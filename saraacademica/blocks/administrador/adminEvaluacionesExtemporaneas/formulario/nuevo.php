...
if (!$esteRecursoDB) {
    ...
    $valorCodificado.="&opcion=consultarCargaDocente";
    ...
    $atributos["leyenda"] = "Evaluación Docente extemporáneas";
    ...
    //---------------Inicio Formulario (<form>)--------------------------------
        ...
        $atributos["anchoEtiqueta"] = 150;
        $atributos["obligatorio"] = true;
        $atributos["etiqueta"] = "Tipo de evaluacion: ";
        //-----De donde rescatar los datos ---------
        $atributos["cadena_sql"] = $this->sql->cadena_sql("consultarTipoEvaluacionExtemporanea");
        $atributos["baseDatos"] = "evaldocentes";
        echo $this->miFormulario->campoCuadroLista($atributos);
        unset($atributos);
