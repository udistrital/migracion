...
////-------------------------------Mensaje-------------------------------------
$tipo = 'message';
$mensaje = "AUTOEVALUACIÓN EXTEMPORÁNEA,  DOCENTE: BENITO PÉREZ, ID. No. ".$_REQUEST['documentoId'].", PERIODO ACADÉMICO ".$registroPeriodo[0][1]." .";
