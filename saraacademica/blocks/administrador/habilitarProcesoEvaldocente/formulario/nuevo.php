...
//echo "MMM".$rutaBloque."<br>";

//echo "nuevo".$_REQUEST['tipo'];
...
{	
        ...
        for($i=0;$i<count($registro);$i++)
        {
            ...
            $variable.="&opcion=editarPeriodo";
            $variable.="&action=".$esteBloque["nombre"];
            $variable.="&usuario=". $_REQUEST['usuario'];
            $variable.="&anio=".$registro[$i][0];
            $variable.="&per=".$registro[$i][1];
