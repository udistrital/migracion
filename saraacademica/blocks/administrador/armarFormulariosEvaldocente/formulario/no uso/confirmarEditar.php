...
$rutaBloque.=$this->miConfigurador->getVariableConfiguracion("site") . "/blocks/evaldocentes/inicioEvaldocente/formulario/";
...
echo "este no es nuevo".$registroPeriodo[0][0];
