...
class SqlvalidarEstudiantesActivos extends sql {
	...
	function cadena_sql($tipo,$variable="") {
		...
		switch($tipo) {
			...
			case "consultarEstudianteActivo_":
					
						$cadena_sql="SELECT DECODE(A.ESTADO_ACTIVO,'S','SI','N','NO') FROM SGA.ACESTADO A , SGA.ACEST B ";
