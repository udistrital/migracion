...
foreach ($registros as $reg){
	...
	echo '<div id="formularioSolicitarCredito" style="margin: 0 auto;text-align: center;"><h3>'.$this->lenguaje->getCadena("mensajeSolicitud").'<br>'.$datoBusqueda['anio'].'-'.$datoBusqueda['per'].'</h3>';
	echo "<br>";
