    ...
    function cadena_sql($tipo, $variable = "") {
        ...
        switch ($tipo) {
            ...
            case "buscarUsuario":
                ...
                $cadena_sql.="AND ";
                $cadena_sql.="CLA_CLAVE = '" . md5(trim($variable["clave"])) . "' ";
                break;
                case "buscarNivelUsuario":
                	$cadena_sql = "SELECT ";
                	$cadena_sql.="CLA_CODIGO, ";
                	$cadena_sql.="CLA_TIPO_USU ";
                	$cadena_sql.="FROM ";
                	$cadena_sql.="geclaves ";
                	$cadena_sql.="WHERE ";
                	$cadena_sql.="CLA_CODIGO = '" . trim($variable) . "' ";
            ...
            case "buscarUsuario":
                ...
                $cadena_sql.="WHERE ";
                $cadena_sql.="correo = '" . trim($variable["usuario"]) . "' ";
                $cadena_sql.="AND ";
                $cadena_sql.="clave = '" . trim($variable["clave"]) . "' ";
                break;
            */
            case "buscarUsuarioOracle":
                ...
                $cadena_sql.="CLA_CODIGO = '" . trim($variable["usuario"]) . "' ";
                $cadena_sql.="AND ";
                $cadena_sql.="CLA_TIPO_USU = '" . trim($variable["modulo"]) . "' ";
                break;
