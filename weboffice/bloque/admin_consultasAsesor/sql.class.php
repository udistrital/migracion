	...
	function cadena_sql($configuracion,$conexion, $opcion,$variable="")
	{
		...
		switch($opcion)
		{
			case "datosEstudiantes":
				...
				$cadena_sql.="EST_NRO_IDEN AS IDENTIFICACION, ";
				...
				$cadena_sql.="EST_TELEFONO TELEFONO_1, ";
				$cadena_sql.="EOT_TEL_CEL TELEFONO_2, ";
				...
				$cadena_sql.="AND ((EST_COD::TEXT = '".$variable[0]."') OR (EST_NRO_IDEN::TEXT = '".$variable[1]."') ";
