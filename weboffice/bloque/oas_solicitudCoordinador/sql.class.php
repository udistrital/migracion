	...
	function cadena_sql($configuracion,$conexion, $opcion,$variable="")
	{
		...
		switch($opcion)
		{
			case "totalSolicitud":
				...
				$cadena_sql.="periodo=".$variable[2]." ";
				$cadena_sql.="AND ";
				$cadena_sql.="tipoPlantilla IN (1,2,3) ";				
				//echo $cadena_sql."<br>";
				  
				break;
			case "totalExtemporaneos":
				...
				$cadena_sql.="anno=".$variable[1]." ";
				$cadena_sql.="AND ";
				$cadena_sql.="tipoPlantilla IN (4,5) ";
				//echo $cadena_sql."<br>";
			...
			case "datosSolicitud":
				...
				break;
			case "solicitudReciboExtemporaneo":
				//MySQL
				$cadena_sql="SELECT ";
				$cadena_sql.=$configuracion["prefijo"]."solicitudRecibo.codigo_est, ";
				$cadena_sql.=$configuracion["prefijo"]."solicitudRecibo.cuota, ";
				$cadena_sql.=$configuracion["prefijo"]."solicitudInteres.anno, ";
				$cadena_sql.=$configuracion["prefijo"]."solicitudInteres.periodo, ";
				$cadena_sql.=$configuracion["prefijo"]."solicitudInteres.id_num_meses ";
				$cadena_sql.="FROM ";
				$cadena_sql.=$configuracion["prefijo"]."solicitudRecibo, ";
				$cadena_sql.=$configuracion["prefijo"]."solicitudInteres ";
				$cadena_sql.="WHERE ";
				$cadena_sql.=$configuracion["prefijo"]."solicitudRecibo.id_solicitud_recibo = ".$configuracion["prefijo"]."solicitudInteres.id_solicitud  ";
				$cadena_sql.="AND ";
				$cadena_sql.="id_solicitud_recibo= ".$variable." ";
				break;	

			case "datosReciboExtemporaneo":
				//oracle
				$cadena_sql="SELECT ";
				...
				$cadena_sql.="AND ";
				$cadena_sql.="ema_cuota= ".$variable[1]." ";
				$cadena_sql.="AND ";
			...
			case "actualizarSolicitud":
				...
				break;
			case "actualizarSolicitudExtemporanea":
				$cadena_sql="UPDATE ";
				$cadena_sql.=$configuracion["prefijo"]."solicitudRecibo "; 
				$cadena_sql.="SET "; 
				$cadena_sql.="`estado`='1', ";
				$cadena_sql.="`secuencia`=".$variable[0].", ";
				$cadena_sql.="WHERE ";
				$cadena_sql.="id_solicitud_recibo=".$variable[1]." ";
				break;				
			...
			case "verificaCalendario":
				...
				$cadena_sql.="acest ";
				$cadena_sql.="WHERE ";
				$cadena_sql.="est_cod = 7520305 ";// 7520305 ";20001015057";
				$cadena_sql.="AND ";
				$cadena_sql.="est_cra_cod =".$variable;
				/*$cadena_sql="SELECT ";
				$cadena_sql.="fua_verifica_recibo(".$variable.")";
				$cadena_sql.="FROM ";
				$cadena_sql.="DUAL ";*/
				break;
