...
//Clase
class bloque_blogdevObjetos extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql=new sql_blogdevObjetos();
 		$this->funcion=new funciones_blogdevObjetos($configuracion, $this->sql);
			...
			if(isset($_REQUEST['opcion']))
			{
				...
				switch($accion)
				{
					...
					case "nuevo":
						...
						break;
					case "editarObjetos":
						$this->funcion->modificarObjetos($configuracion,$tema,$accion,$formulario,$verificar,$fila,$tab,$this->funcion->acceso_db);
						break;
					case "corregir":
	...
	function action($configuracion)
	{
		...
		if(!isset($_REQUEST['cancelar']))
		{
			if(!isset($_REQUEST["editarObjetos"]))
			{
...
$esteBloque=new bloque_blogdevObjetos($configuracion);
