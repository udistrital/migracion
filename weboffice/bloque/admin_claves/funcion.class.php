...
class funciones_admin_claves extends funcionGeneral
{
	...
	function __construct($configuracion, $sql)
	{
		...
		//Conexion ORACLE
		$this->accesoOracle=$this->conectarDB($configuracion,"recuperacionClave");
		//Conexion General
	...
	function confirmaDatos($configuracion)
	{
		...
		if(is_array($resultadoTipoUsu))
		{
                        ...
                        while($i<=$cuenta-1)
			{
				...
				if($tipo==51 || $tipo==52)
				{
					$cadena_sql=$this->sql->cadena_sql($configuracion,$this->accesoOracle, "correoEstudiante",$valor);
					$resultadoCorreoEst=$this->ejecutarSQL($configuracion, $this->accesoOracle, $cadena_sql, "busqueda");
					$cierto=0;
				...
				{
					$cadena_sql=$this->sql->cadena_sql($configuracion,$this->accesoOracle, "correoFuncionario",$valor);
					$resultadoCorreoFun=$this->ejecutarSQL($configuracion, $this->accesoOracle, $cadena_sql, "busqueda");
					$cierto=0;
