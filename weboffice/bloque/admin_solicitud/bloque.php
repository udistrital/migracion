...
class bloqueAdminSolicitud extends bloque
{
	...
	function html()
	{
		...
		elseif(!isset($_REQUEST["action"]))
		{
			...
			if(isset($_REQUEST["bloque"]) && $_REQUEST["bloque"]=="bloqueadoEstudiante")
			{

				$this->funcion->recibosBloqueadosest($this->configuracion,$_REQUEST["estudiante"]);
			}
			else
			{
				//TO REVIEW
	...
	function action()
	{
		if(isset($_REQUEST["bloque"])&&$_REQUEST["bloque"]=="bloqueadoEstudiante")
		{
			...
			$registro=$this->funcion->consultaBloqueadosest($this->configuracion);
		}
		else
		{
