...
class funciones_registro_PlanTrabajo extends funcionGeneral
{
	...
	function registrarPlanTrabajo($configuracion,$conexion)
	{
	...
	function registroActividades($configuracion, $accesoOracle,$acceso_db)
	{
		include_once($configuracion["raiz_documento"].$configuracion["clases"]."/html.class.php");
		if($this->usuario)
		{
						...
						<table class="formulario" align="center">
							<tr>
									<td class="cuadro_brown">
										<br>
										<ul>
											<li> Seleccione la actividad, la sede, el sal&oacute;n, y el tipo de vinculaci&oacute;n si tiene m&aacute;s de una vinculaci&oacute;n y haga click en el bot&oacute;n "Grabar".</li>
											<li> Si al seleccionar una sede y en la lista de salones no aparece alg&uacute;n sal&oacute;n, es porque este ya ha sido ocupado.</li>
											<li>Recuerde que todos los campos son obligatorios, si al seleccionar una sede no despliega lista de salones, no le va a dejar grabar.</li>
										</ul>
									</td>
										...
										<table class="formulario">
											<tr>
												...
												<td>
													...
													$busqueda.="dac_nombre ";
													$busqueda.="FROM ";
													$busqueda.="acdocactividad ";
													$busqueda.="WHERE ";
													$busqueda.="dac_cod > 1 ";
													$busqueda.="AND ";
													$busqueda.="dac_estado='A' ";
													$busqueda.="ORDER BY 1";
											...
											<tr>
												...
												<td><?
													...
													$busqueda="SELECT ";
													$busqueda.="sed_cod||'#'||'".$valor[1]."'||'#'||'".$valor[2]."'||'#'||'".$valor[3]."'||'#'||'".$valor[4]."', ";
													$busqueda.="sed_nombre ";
													$busqueda.="FROM ";
													$busqueda.="gesede ";
													$busqueda.="WHERE ";
													...
													$configuracion["ajax_function"]="xajax_nombreSede";
											...
											<tr>								
												...
												<td>
													...
													$busqueda="SELECT ";
													$busqueda.="sal_cod, ";
													$busqueda.="sal_descrip ";
													$busqueda.="FROM ";
													$busqueda.="gesalon ";
													$busqueda.="ORDER BY sal_cod DESC";
																		
													$resultado=$this->ejecutarSQL($configuracion, $this->accesoOracle, $busqueda, "busqueda");
																					
													$mi_cuadro=$html->cuadro_lista("",'salon',$configuracion,-1,3,FALSE,$tab++,"salon",100);
											...
											<tr>	
												...
												<td>
													...
													$busqueda="SELECT ";
													$busqueda.="distinct dtv_tvi_cod, ";
													$busqueda.="tvi_nombre ";
													$busqueda.="FROM ";
													$busqueda.="acdoctipvin,acasperi,actipvin ";
													$busqueda.="WHERE ";
													$busqueda.="ape_ano=dtv_ape_ano ";
													$busqueda.="AND ";
													$busqueda.="tvi_cod=dtv_tvi_cod ";
													$busqueda.="AND ";
													$busqueda.="ape_per=dtv_ape_per ";
													$busqueda.="AND ";
													$busqueda.="ape_estado='".$valor[10]."' ";
													$busqueda.="AND ";
													$busqueda.="dtv_estado='A' ";
													$busqueda.="AND ";
													$busqueda.="dtv_doc_nro_iden= ".$valor[0]." ";
													//echo "<br>".$busqueda."<br>";
	...
	function guardarPlanTrabajo($configuracion, $accesoOracle,$acceso_db)
	{
	...
	function borrarActividades($configuracion, $accesoOracle,$acceso_db)
	{
		include_once($configuracion["raiz_documento"].$configuracion["clases"]."/html.class.php");
		if($this->usuario)
		{
									...
									<table class="tablaBase">
										<tr>
											...
											<td align="center">
												...
												<input value="Borrar" name="borrar" tabindex='<? echo $tab++ ?>' type="submit" onclick="if(<? echo $this->verificar; ?>){document.forms['<? echo $this->formulario?>'].submit()}else{false}"/><br>
											</td>
											<!--td align="center">
												<input type='hidden' name='nivel' value='<? //echo $valor[4]?>'>
												<input type="submit" name="notdef" value="Calcular Acumulado">
	...
	function eliminarActividad($configuracion, $accesoOracle,$acceso_db)
	{
		$valor[0]=$_REQUEST['usuario'];
		$valor[1]=$_REQUEST['anio'];
		$valor[2]=$_REQUEST['per'];
	...
	function grabarObservacion($configuracion, $accesoOracle,$acceso_db)
	{
		unset($valor);
		$valor[0]=$_REQUEST['usuario'];
		$valor[1]=$_REQUEST['anio'];
	...
	function ModificarObservacion($configuracion, $accesoOracle,$acceso_db)
	{
		unset($valor);
		$valor[0]=$_REQUEST['usuario'];
		$valor[1]=$_REQUEST['anio'];
