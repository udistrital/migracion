...
class AesCtrs extends Aess {
    ...
    /*
     * Unsigned right shift function, since PHP has neither >>> operator nor unsigned ints @param a number to be shifted (32-bit integer) @param b number of bits to shift a to the right (0..31) @return a right-shifted and zero-filled by b bits
     */
