	...
	function cadena_sql($configuracion,$conexion, $opcion,$variable="")
	{
		...
		switch($opcion)
		{
			...
			case "recibosSinPagar":
				...
				$cadena_sql.="			 AND ema_est_cod = ".$variable."  ";
				$cadena_sql.="			 AND (ema_obs is null or ema_obs NOT like '%SABER%')) ";
				$cadena_sql.=")	 ";			   
/*				$cadena_sql.="UNION select 2014,3 from dual where NOT EXISTS (SELECT ema_ano||ema_per";
				$cadena_sql.=" FROM acestmat";
				$cadena_sql.=" WHERE 20143 = ema_ano||ema_per";
				$cadena_sql.=" AND ema_est_cod = ".$variable.") ";*/
			...
			case "fechaPago":
				//MySQL
				$cadena_sql="SELECT ";
				$cadena_sql.="`ordinaria`,`extraordinaria` ";
				$cadena_sql.="FROM ";
				$cadena_sql.=$configuracion["prefijo"]."fechasPago ";
				$cadena_sql.="WHERE ";
				$cadena_sql.="cuota=3";
				$cadena_sql.=" and facultad=".$variable;
				break;
			...
			case "actualizaracestmat":
				...
				$cadena_sql.="ema_est_cod=".$variable[0]." ";
				$cadena_sql.="AND ";
				$cadena_sql.="ema_ano_pago=".$variable[2]." ";
				$cadena_sql.="AND ";
				$cadena_sql.="ema_per_pago=".$variable[3]." ";
				//$cadena_sql.="AND ";
				...
				$cadena_sql.="AND ";
				$cadena_sql.="(ema_obs is null or ema_obs not like '%SABER%') ";
				break;
