	...
	function action($configuracion)
	{
		...
		{	
			...
			if($datos!=false)
			{
				...
				echo "<br>*08 Numero de Columnas= $columnas*  //bloque.php line 73";
				
				if($columnas==26||$columnas==13||$columnas==22||$columnas==23)
				{
				...
				{	
					echo "<br>*- El n&uacute;mero de columnas leidas no corresponde a ninguna plantilla.*  //bloque.php line 87";
