	...
	function cadena_sql($configuracion,$conexion, $opcion,$variable="")
	{
		...
		switch($opcion)
		{
			...
			case "listaProyectosPregrado":
				...
				$cadena_sql.="ACCRA ";
				$cadena_sql.="WHERE ";
				$cadena_sql.="CRA_TIP_CRA IN (SELECT DISTINCT(TRA_COD) FROM MNTAC.ACTIPCRA WHERE tra_nivel='PREGRADO') ";
				$cadena_sql.="AND ";
				$cadena_sql.="CRA_ESTADO='A' ";
				break;
			...
			case "totalGenerado":
				...
				$cadena_sql.="AND ";
				$cadena_sql.="ema_est_cod NOT IN (SELECT est_cod FROM acest WHERE est_estado_est IN ('J','B')) ";
				break;
