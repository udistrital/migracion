							...
							<table align="center" width="100%">
								<tr>
									...
									<td class="textoCentral">
										<a href="<?echo $configuracion["host"].$configuracion["site"].'/documento/plantilla_recibos_extemporaneos_pregrados.xls'; ?>"> Plantilla_recibos_extomporaneos_pregrados</a><br>
										<a href="<?echo $configuracion["host"].$configuracion["site"].'/documento/plantilla_recibos_extemporaneos_posgrados.xls'; ?>"> Plantilla_recibos_extomporaneos_posgrados</a><br>
									</td>
								</tr>
								<tr>
									<td>
