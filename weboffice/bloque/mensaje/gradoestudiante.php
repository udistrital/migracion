				...
				<table class="tablaMarco">
					<tbody>
						...
						<tr class="bloquecentralcuerpo">
							<td valign="top" colspan=2 class="cuadro_brown">
							<p>Por favor lea completamente el instructivo y diligencie el formulario de forma cuidadosa. Los datos ser&aacute;n utilizados en la impresi&oacute;n
							de su Acta de Grado y Diploma. Una vez ingrese los datos no pueden ser modificados por este medio.</p>							
							</td>							
						</tr>
						<tr class="bloquecentralcuerpo">
						...
						<tr class="bloquecentralcuerpo">
							<td valign="top">
								...
								<p>
								Por favor leer completamente las instrucciones de diligenciamiento del formulario de inscripci&oacute;n antes de presentar su solicitud.
								</p>
								<p>
