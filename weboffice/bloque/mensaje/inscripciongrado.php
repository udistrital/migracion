						...
						<tr class="bloquecentralcuerpo">
							<td valign="top">
								...
								<table class="tablaImportante">
									<tr class="bloquecentralcuerpo">
										<td class="centrar">										
										<a href="<? echo $configuracion['host'].$configuracion['site'].$configuracion['documento']?>/manualInscripcionGrado.pdf"><img border="0" alt=" " src="<? echo $configuracion["host"].$configuracion["site"].$configuracion["grafico"]."/pdfGrande.png"?>" /><hr class="hr_subtitulo">Archivo PDF</a>
										</td>
										<td>
										<a href="<? echo $configuracion['host'].$configuracion['site'].$configuracion['documento']?>/manualInscripcionGrado.pdf">Intrucciones para llenar el formulario.</a>
										</td>
									</tr>
								</table>
								</p>
