...
//Clase
class bloque_blogdevClaobj extends bloque
{

	 public function __construct($configuracion)
	{
 		$this->sql=new sql_blogdevClaobj();
 		$this->funcion=new funciones_blogdevClaobj($configuracion, $this->sql);
			...
			if(isset($_REQUEST['opcion']))
			{
				...
				switch($accion)
				{
					...
					case "nuevo":
						...
						break;
					case "editarClaobj":
						$this->funcion->modificarClaobj($configuracion,$tema,$accion,$formulario,$verificar,$fila,$tab,$this->funcion->acceso_db);
						break;
					case "editar":
	...
	function action($configuracion)
	{
		...
		if(!isset($_REQUEST['cancelar']))
		{
			...
			if(isset($_REQUEST["editarClaobj"]))
			{
...
$esteBloque=new bloque_blogdevClaobj($configuracion);
