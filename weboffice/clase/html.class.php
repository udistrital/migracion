	...
	function cuadro_lista($cuadro_sql,$nombre,$configuracion,$seleccion,$evento,$limitar,$tab=0,$id="",$tamano="200")
		...
		if($this->cuadro_campos>0)
		{
			...
			switch($evento)
			{
				...
				case 3 :
					//echo "Este es evento que se esta:".$evento;
                                        $function=isset($configuracion["ajax_function"])?$configuracion["ajax_function"]:'';
                                        $control=isset($configuracion["ajax_control"])?$configuracion["ajax_control"]:'';
					$mi_evento=" style='width: 300px;' onchange=\"".$function."(document.getElementById('".$control."').value)\"";
					break;
