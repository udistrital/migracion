...
class oci8
{
	...
	* @access public
	 */
	/**
         * Se cambio la opcion del IF, ya que retornaba el valor false cuando existia la ejecucion del query
	...
	function ejecutar_acceso_db($cadena_sql) 
	{
		...
		if($busqueda)
		{
                    //return FALSE; //Aqui se realizo el cambio
                    return TRUE;
		} 
		else 
		{
                    //return TRUE; //Aqui se realizo el cambio
                    return FALSE;
		}
	}
