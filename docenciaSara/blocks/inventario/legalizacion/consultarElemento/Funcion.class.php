...
class FuncionconsultarElemento {
    ...
    function desplegarElementos($elementos) {
 
        include_once($this->ruta . "/formulario/desplegarElementos.php");
    }
        ...
        if (!isset($_REQUEST["opcion"]) || (isset($_REQUEST["opcion"]) && ($_REQUEST["opcion"] == "nuevo" || $_REQUEST["opcion"] == "editar"))) {
            ...
            if ($validacion == false) {
                ...
                if (!isset($_REQUEST['opcion']) || $_REQUEST["opcion"] == "nuevo") {
                    ...
                    if ($_REQUEST["opcion"] == "filtrar") {

                        $this->procesarConsultar();
                    }
                }
            }
        } else {
