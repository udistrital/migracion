...
class SqlEntradaElemento extends sql {
	...
	function cadena_sql($tipo,$variable="") {
		...
		switch($tipo) {
			 ...
			 */
			case "buscarTipoSuministro":
				$cadena_sql="SELECT ";
				$cadena_sql.="sum_id, ";
				$cadena_sql.="sum_nombre ";
				$cadena_sql.="FROM ";
				$cadena_sql.="suministros ";
				$cadena_sql.="WHERE ";
				$cadena_sql.="UPPER(sum_nombre) like '%".strtoupper(trim($variable))."%' ";
				break;

			case "buscarIva":
				$cadena_sql="SELECT ";
				$cadena_sql.="iva_id, ";
				$cadena_sql.="iva_valor ";
				$cadena_sql.="FROM ";
				$cadena_sql.="iva ";
				$cadena_sql.="WHERE ";
				$cadena_sql.="iva_estado= TRUE ";
				break;
