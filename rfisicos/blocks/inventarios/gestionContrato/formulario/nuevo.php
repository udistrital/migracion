...
$items=array("tabContratoConsultar"=>$this->lenguaje->getCadena("tabContratoConsultar"),"tabContratoCrear"=>$this->lenguaje->getCadena("tabContratoCrear") );
...
$atributos["id"]="tabContratoConsultar";
$atributos["estilo"]="";
echo $this->miFormulario->division("inicio",$atributos);
