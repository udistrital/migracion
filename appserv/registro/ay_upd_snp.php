...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	CONSULTA Y MODIFICACIÓN DE SNP</span></td>
  ...
  <tr>
    <td colspan="2">
	<p align="justify">Listado de los aspirantes a ingresar a la universidad, que aún no se les ha insertado la información del Icfes en la tabla “acaspw”.</p>
	<p align="justify">En la columna “Gestión”, Haciendo clic en el lápiz frente a cada registro; en la parte superior del listado, se editará la información del mismo para modificar el “SNP Icfes”.</p>
	<p align="justify">Una vez modificada la información, haga clic en el botón de la columna “Grabar”.</p>
    </td>
  </tr>
</table>
<br>
