...
<body>
<?PHP 
fu_cabezote("CODIFICADOS POR A&Ntilde;O Y PER&Iacute;ODO");
...
print'<div align="center"><br><br><br>
	<span class=\'Estilo5\'>Seleccione el archivo, de acuerdo al per&iacute;odo.</span>
	<form name="form1">
		<select name="asp">';
			$i=0;
			while(isset($RowPartNom[$i][0]))
			{
				...
				echo'<option value="'.$RowPartNom[$i][0].'">'.$RowPartNom[$i][0].'</option>\n';
			$i++;
			}
			print'</select>
