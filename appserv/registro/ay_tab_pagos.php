...
<table width="90%" align="center" background="../img/fondo_ay.png">
  ...
  <tr>
    <td colspan="2">
	<p align="justify">Ejecute este proceso para: Insertar en la tabla de pagos, los registros subidos a la base de datos desde el archivo de reporte de pagos y generarles una credencial.</p>
