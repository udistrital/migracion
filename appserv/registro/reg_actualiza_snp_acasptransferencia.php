...
$QryCred = "SELECT atr_cred,atr_nro_iden_icfes,atr_email,atr_telefono,atr_snp
	FROM mntac.acasptransferencia a
	...
	AND atr_cred = ".$_REQUEST['cred']."
	AND atr_nro_iden_icfes = ".$_REQUEST['iden'];

$RowCred = $conexion->ejecutarSQL($configuracion,$accesoOracle,$QryCred,"busqueda");

print'<p></p>
<form action="prog_actualiza_snp_acasptransferencia.php" name="snpw" id="snpw" method="post">
