...
<body>
<?PHP 
fu_cabezote("POBLACI&Oacute;N DE ASPIRANTES POR ESTRATO"); 
...
print'<div align="center"><br>
  ...
  <form name="PoblacionAsp" method="post" action="'. $_SERVER['PHP_SELF'] .'">
	...
	<table width="478" border="0" align="center">
		<tr>
		<td><p style="line-height: 100%" align="justify">De acuerdo al per&iacute;odo seleccionado, se despliega la informaci&oacute;n del total de la poblaci&oacute;n de aspirantes por estrato.
			<br><br><b>Nota.</b> No est&oacute;n incluidos los aspirantes de reintegro.
		</td>
	</tr>
  </table>
  <p></p>
...
if(!empty($_REQUEST['anoper'])){
   ...
   $cont = 0;
	...
	<caption>POBLACI&Oacute;N DE ASPIRANTES POR ESTRATO - PER&Iacute;ODO ACAD&Eacute;MICO '.$Anio.'-'.$Peri.'</caption>
	  <tr>
		<td>';
		require_once('esta_poblacion_asp_estrato.php');
		print'</td>
		
		<td>';
		require_once('gen_graf_esta_poblacion_asp_estrato.php');
		print'</td>
	  </tr>
	</table>
