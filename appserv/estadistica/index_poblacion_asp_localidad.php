...
<body>
<?PHP 
fu_cabezote("POBLACI&Oacute;N DE ASPIRANTES POR LOCALIDAD"); 
...
print'<div align="center"><br>
  ...
  <form name="PoblacionAsp" method="post" action="'. $_SERVER['PHP_SELF'] .'">
    ...
    <tr>
      <td><p style="line-height: 100%" align="justify">De acuerdo al per&iacute;odo seleccionado, se despliega la informaci&oacute;n del total de la poblaci�n de aspirantes por localidad.
	  <br><br><b>Nota.</b> No est&aacute;n incluidos los aspirantes de reintegro.</td>
    </tr>
  </table>
  <p></p>
</div><br>';
...
if(!empty($_REQUEST['anoper'])){
   ...
   $cont = 0;
	...
	<caption>POBLACI&Oacute;N DE ASPIRANTES POR LOCALIDAD - PER&Iacute;ODO ACAD&Eacute;MICO '.$Anio.'-'.$Peri.'</caption>
	  <tr>
		<td>';
		require_once('esta_poblacion_asp_localidad.php');
		print'</td>
		
		<td>';
		require_once('gen_graf_esta_poblacion_asp_localidad.php');
		print'</td>
	  </tr>
	</table>
