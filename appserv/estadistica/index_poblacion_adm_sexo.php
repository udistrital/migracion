...
<body>
<?PHP 
fu_cabezote("POBLACI&Oacute;N DE ADMITIDOS POR SEXO"); 
...
print'<div align="center"><br>
  ...
  <form name="PoblacionAsp" method="post" action="'. $_SERVER['PHP_SELF'] .'">
    ...
    <tr>
      <td><p style="line-height: 100%" align="justify">De acuerdo al per&iacute;odo seleccionado, se despliega la informaci&oacute;n del total de la poblaci&oacute;n de admitidos por sexo.
...
if(!empty($_REQUEST['anoper']))
{
   ...
   $cont = 0;
	...
	<caption>POBLACI&Oacute;N DE ADMITIDOS POR SEXO - PER&Iacute;ODO ACAD&Eacute;MICO '.$Anio.'-'.$Peri.'</caption>
	  <tr>
		<td>';
		require_once('esta_poblacion_adm_sexo.php');
		print'</td>

		<td>';
		require_once('gen_graf_esta_poblacion_adm_sexo.php');
		print'</td>
	  </tr>
	</table>
