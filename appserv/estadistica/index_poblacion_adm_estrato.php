...
<body>
<?PHP 
fu_cabezote("POBLACI&Oacute;N DE ADMITIDOS POR ESTRATO"); 
...
print'<div align="center"><br>
  <span class="Estilo5">Seleccione el per&iacute;odo</span>
    ...
    <tr>
      <td><p style="line-height: 100%" align="justify">De acuerdo al per&iacute;odo seleccionado, se despliega la informaci&oacute;n del total de la poblaci�n de admitidos por estrato.
...
if(!empty($_REQUEST['anoper'])){
   ...
   $cont = 0;
	...
	<caption>POBLACI&Oacute;N DE ADMITIDOS POR ESTRATO - PER&Iacute;ODO ACAD&Eacute;MICO '.$Anio.'-'.$Peri.'</caption>
	  <tr>
		<td>';
		require_once('esta_poblacion_adm_estrato.php');
		print'</td>

		<td>';
		require_once('gen_graf_esta_poblacion_adm_estrato.php');
		print'</td>
	  </tr>
	</table>
