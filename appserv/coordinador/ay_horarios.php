...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="coor_cra_hor.php" target="principal">HORARIOS</a></span></td>
  ...
  <ul>
    <li>Haga clic en la lista de valores de &quot;Cursos&quot;.</li>
    <li>Seleccione el curso. (C&oacute;digo de la asignatura-Nombre-Grupo). </li>
    <li>Haga clic en el bot&oacute;n &quot;Consultar&quot;.</li>
    </ul>
	</td>
  </tr>
