...
<table width="90%" align="center" background="../img/fondo_ay.png">
  ...
  <tr>
    <td colspan="2">
	<ul>
	<li class="PopItemStyle"><strong>Electiva</strong>. S o N si la asignatura es o no una electiva.</li>
        <li class="PopItemStyle"><strong>Horas T</strong>. N&uacute;mero de horas te&oacute;ricas que se dictan semanalmente de la asignatura.</li>
	<li class="PopItemStyle"><strong>Horas P</strong>. N&uacute;mero de horas practicas que se dictan semanalmente de la asignatura.</li>
	</ul>
	<p>Haga clic en el nombre de la asignatura, para ver los grupos programados (horario).</p>
