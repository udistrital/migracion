...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    <td width="786" valign="middle"><span class="Estilo1"><br>&nbsp;&nbsp;&nbsp;
	    <a href="coor_correos_doc.php" target="principal">CONTACTAR DOCENTES</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<ul>
    <li>Haga clic en la lista de valores "Proyecto Curricular".</li>
    <li>Seleccione el Proyecto Curricular.</li>
    <li>Haga clic en el bot&oacute;n &quot;Consultar&quot;.</li>
    </ul>
  <ul>
    <li>Haga clic en la casilla de verificación frente al nombre del docente al cual le enviará el correo.</li>
    <li>Haga clic en el botón "Enviar Correos"</li>
    </ul>
	</td>
  </tr>
</table>
