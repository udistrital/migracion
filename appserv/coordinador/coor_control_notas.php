...
include_once('coor_lis_desp_carrera.php');
...
?>	 <div align="center"><h3>PROYECTO CURRICULAR: <? print $NomCra->rescataNombre($_REQUEST['cracod']);?><BR>PER&Iacute;ODO ACAD&Eacute;MICO <? print $ano.'-'.$per;?></h3></div>
...
<?php
	...
	while(isset($consulta[$i][0]))
	{
		...
		<td align="center">'.$consulta[$i][11].'</td></tr>';
	$i++;
	}
}
?>
