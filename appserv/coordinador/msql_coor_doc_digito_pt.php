...
$QryDocPt = "SELECT DPT_DAC_COD,
	...
	SED_ABREV,
	SAL_DESCRIP
	FROM ACDOCPLANTRABAJO,ACDOCACTIVIDAD,ACASPERI,ACDOCENTE,GEDIA,GEHORA,GESEDE,GESALON
...
$QryCarLec = "SELECT cle_ape_ano,
	...
	sed_nombre,
	sal_cod
	FROM gedia, gehora, gesede, gesalon, acdocactividad, v_accargalectiva
	...
	AND cle_cra_cod= ".$_REQUEST['cracod']."             
