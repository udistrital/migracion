 ...
 */
function d17_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function d17_service_links_node_format($links) {
 ...
 * Usingstyles in IE
*/
function d17_img_assist_page($content, $attributes = NULL) {
