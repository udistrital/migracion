...
<div class="cleared"></div>
<p class="art-page-footer"><?php echo t('Powered by ').'<a href="http://drupal.org/">'.t('Drupal').'</a>'.t(' and ').'<a href="http://drupal2u.com/">Drupal templates</a>'.t(' created with ').'<a href="http://www.flashtemplates.com/">flash site templates</a>'; ?>.</p>
</div>
