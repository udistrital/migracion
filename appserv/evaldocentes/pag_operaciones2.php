...
function valideradio(n) {
	...
	alert(m);
		...
		if ( m != 8 && m != 14 && m!= 9 && m!= 6 && m!= 11 && m!= 13) {
					var btn = val(parent.fra_formato.document.evaluar.r17);
					if (btn == null) {x = 0; 
						}
		}
		if ( m != 8 && m != 14 && m!= 9 && m!= 6 && m!= 11 && m!= 13 && m!= 12) {
...
function browser(){
  ...
  function aceptar(){
	...
	if (brw=="NN4"){
		...
		}else { alert('Estimado usuario: Para grabar su evaluaci&oacute;n debe responder todas las preguntas.');}		
	}else if (brw=="NN6"){
