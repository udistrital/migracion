...
<p align="center"> 
<a href="vice_pag_menu.php" target="_self"><span class="link">Contraer el Menú</span></a>
<script>
...
makeMenu('top','Datos Personales')
	makeMenu('sub','Actualizar','vice_actualiza_dat.php','principal')
	
//Menu 1    
makeMenu('top','Aspirantes')
  makeMenu('sub','Proceso Actual','../generales/gen_inscritos_por_facultad.php','principal')
  makeMenu('sub','Por Año y Período','vice_asp_anoper.php','principal')
...
makeMenu('top','Admitidos') 
  makeMenu('sub','Por Año y Período','vice_adm_anoper.php','principal')
...
makeMenu('top','Est. Codificados') 
  makeMenu('sub','Por Año y Período','vice_codif_anoper.php','principal')
...
makeMenu('top','Salir')
  ...
  makeMenu('sub','Contraer el Menú','vice_pag_menu.php','_self')
...
<a href="vice_mapa.php" target="principal" onMouseOver="link();return true;" onClick="link();return true;">
