...
//echo $consulta;
	...
	if(isset($registro[0][0])){
		echo'<p></p><table border="0" width="90%" align="center" cellpadding="2">
			...
			<td ><strong>'.UTF8_DECODE($registro[0][1]).'</strong></td>
		...
		<?php
		   	...
		   	while(isset($registro[$i][0]))
			{
			 	  ...
			 	  <td align="left">
				  <a href="est_asi_doc_responsable.php?asicod='.$registro[$i][6].'&asigr='.$registro[$i][8].'" target="asihor" onMouseOver="link();return true;" onClick="link();return true;" title="Ver docente responsable">'.UTF8_DECODE($registro[$i][7]).'</a></td> 
