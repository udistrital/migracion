...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="est_fre_asi_ins.php" target="principal">HORARIO</a></span></td>
  ...
  <tr>
    <td colspan="2">
	  <p><b>Día</b>: Dias de la semana.<br>
	    <br>
        <b>Hora Ini</b>: Hora inicial.<br>
        <br>
        <b>Hora Fin</b>: Hora final.<br>
        <br>
        <b>Salón</b>: Número del salón de clase.<br>
        <br>
        <b>Sede</b>: Sede en donde se dicta la clase.</p>
    <p>&nbsp;</p></td>
  </tr>
</table>
<br>
