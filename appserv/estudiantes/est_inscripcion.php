...
require_once('valida_estudiante_creditos.php');
...
$consulta = "SELECT est_cod,
	...
	if(isset($opcion)){	
		...
		switch($opcion){
			...
			break;
			case "102":
				$salida="Usted ya inscribio el n&uacute;mero m&aacute;ximo de asignaturas permitidas por su coordinaci&oacute;n ";
			break;	
			case "103":
				$salida="Actualmente usted tiene tres o mas asignaturas reprobadas. Su coordinaci&oacute;n no le permite adicionar m&aacute;s. ";
			break;
			case "104":
				$salida="Su coordinaci&oacute;n no le permite inscribir asignaturas de semestres superiores";
			break;	
			case "105":
			case "106":			
			...
			break;		
			case "199":
				$salida="Estudiante en Creditos";
			break;	
			case "200":
				$salida="Usted se encuentra en prueba acad&eacute;mica, no puede adicionar m&aacute;s asignaturas";
			break;														
...
?>
<!-- <div align="center"><a href="#" onClick="javascript:popUpWindow('est_graf_addcan.php', 'no', 100, 100, 550, 201)">Gr�fica del Proceso</a></div> -->
 ...
 <br> <table border="1" width="90%" align="center" cellspacing="0" cellpadding="1">
    <tr class="tr">
      ...
      <td colspan="2" align="center">Gesti&oacute;n</td>
    </tr>
<?php
...
while(isset($registro[$i][0])){
	echo'<tr onMouseOver="this.className=\'raton_arr\'" onMouseOut="this.className=\'raton_aba\'">
		<td align="right">
			<a href="est_asi_hor.php?asicod='.$registro[$i][6].'&asigr='.$registro[$i][8].'" target="inferior" title="Horario de la asignatura">'.$registro[$i][6].'</a>
		</td>
  	 	<td align="left">'.$registro[$i][7].'</td>
  	  	<td align="center">'.$registro[$i][8].'</td>
  	  	<td align="center">
			<a href="est_cambia_grupo_asi.php?asicod='.$registro[$i][6].'&asigru_ant='.$registro[$i][8].'" target="inferior">'.$b_edit.'</a>
		</td>
   		<td align="center">
			<a href="est_borra_asi.php?asicod='.$registro[$i][6].'&asigru='.$registro[$i][8].'" target="inferior">'.$b_deltbl.'</a>
		</td>
	</tr>';
	$i++;
}
...
<table width="90%"  border="0" align="center" cellpadding="0" cellspacing="2">
  <tr>
    ...
    <td width="50%" align="center"><a href="#" onClick="javascript:popUpWindow(\'add_can.php\', \'no\', 100, 100, 350, 133)">Fechas de Adici&oacute;n y Cancelaci&oacute;n</a></td>
  </tr>
</table>';
