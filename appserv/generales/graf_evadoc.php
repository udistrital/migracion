...
require_once("msql_graf_evadoc.php");
...
//Titulo y subtitulo
$graph->title->Set("Proceso de Evaluación Docente");
...
$activity1 = new GanttBar(0,"Evaluación",$IniAd, $FinAd,"[$AddPor%]");
//Color de la barra
$activity1->SetPattern(BAND_RDIAG,"green");
$activity1->SetFillColor("white");
