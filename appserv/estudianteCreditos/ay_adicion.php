...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="est_fre_inscripcion.php" target="principal">ADICIÓN DE ASIGNATURAS</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p align="justify">Para adicionar una asignatura, haga clic el nombre para ver los grupos disponibles de la misma. Luego haga clic en el 
icono <img alt="Adicionar" src="http://localhost/CONDOR/img/b_insrow.png" border="0" width="16" height="16"> del grupo que desea inscribir.
