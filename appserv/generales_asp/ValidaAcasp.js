...
function ValidaInscripcionAspirante() {
    ...
    if (document.forms["acasp"].elements["CraCod"].value == "") {
        alert("Debe seleccionar una carrera.");
        document.forms["acasp"].elements["CraCod"].focus();
        return 0;
    }
    if (document.forms["acasp"].elements["acta"].value.length < 3) {
        alert("Debe ingresar numero de acta de Grado del Titulo de Tecnologo del cual es egresado.");
    ...
    if (!isNaN(xYear1)) {
        if (xYear1 >= 2005) {
            alert("El ano de nacimiento no esta correcto.");
            document.forms["acasp"].elements["CraCod"].focus();
            return 0
        }
    }
...
//DATOS SOCIO-ECON�MICOS
    ...
    if (document.forms["acasp"].elements["dir"].value == "") {
        alert("Debe digitar la direccion actual de residencia.");
    ...
    if (isNaN(document.forms["acasp"].elements["tel"].value)) {
        alert("El número de teléfono debe de ser digitado sin espacios.");
        document.forms["acasp"].elements["tel"].focus();
        return 0;
    }
                ...
                if ((str_carrera !== 383)) {
                    if ((str_carrera !== 372)) {
                        if ((str_carrera !== 375)) {
                            if ((str_carrera !== 377)) {
                                if (res < 20092) {
                                    alert("Ingrese un SNP válido. Recuerde que debe ser mínimo del 20092");
                                    document.forms["acasp"].elements["NroIcfes"].focus();
    ...
    if (document.forms["acasp"].elements["TipoIcfes"].value != document.forms["acasp"].elements["CVTipoIcfes"].value) {
        alert("El Tipo de registro del icfes (SNP) es diferente.");
