...
Imprima y conserve este comprobante.</p>
	...
	{
		echo '<p align="justify"><b>Se&ntilde;or aspirante, el paso que usted debe seguir es:</b></p>
		<p>Asistir a la sede Macarena A, cra 3 A No. 26 A - 40  el d&iacute;a 12 Noviembre de 2014 despu&eacute;s de las 2:00 p.m., con el fin de consultar si fue <strong>preseleccionado</strong> para presentar entrevista. Tenga en cuenta que dicha preselecci&oacute;n se har&aacute; de acuerdo a los mayores puntajes del ex&aacute;men de estado ICFES o SABER 11.</p>
	...
	{
		echo '<p align="justify"><b>Se&ntilde;or aspirante, el paso que usted debe seguir es:</b></p>
		<p>Consultar los resultados de admisiones el d&iacute;a 23 de Noviembre 2014.</p>
...
/*echo "<p><strong>PROGRAMA ACAD&Eacute;MICO DE ADMINISTRACI&Oacute;N DEPORTIVA </strong>.</p>
			<p>1. Publicaci&oacute;n listado de Admitidos: 23 Noviembre 2014</p>
...
telefonos 3238400, 3239300 Ext. 1102, o remitir su inquietud al correo electr&oacute;nico admisiones@udistrital.edu.co, dentro de los plazos asignados en el proceso de admisiones.
</font></p>
<center><input name="button" type="button" onClick="javascript:window.print();" value="Imprimir" style="cursor:pointer; width:80" title="Clic para imprimir el reporte"></center>
</fieldset>
<p></p>
<?php
?>
