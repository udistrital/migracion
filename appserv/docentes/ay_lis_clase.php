...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="doc_curso.php" target="principal">LISTAS DE CLASE Y CAPTURA DE NOTAS</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p align="justify">Haga clic en el código de la asignatura, para ver la lista de clase.
<br><br>
Haga clic en el nombre de la asignatura, para digitar las notas. </p>
<br><br><br><br><br>
    </td>
  </tr>
</table>
