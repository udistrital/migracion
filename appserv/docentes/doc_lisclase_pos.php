...
if($Nivel != 'POSGRADO')
{
	echo "<script>location.replace(' ../err/err_no_posgrado.php?carrera=$Carrera')</script>";
}
   //die('<BR><BR><BR><BR><BR><BR><h3><CENTER>EL PROYECTO CURRICULAR, '.$Carrera.' NO ES UN POSGRADO.</CENTER></h3>');
...
while(isset($consulta[$i][0]))
{
	...
	<td width="25%" align="center">
		<table border="1" width="300" cellspacing="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#FFFFFF">
		 	<tr><td width="5%" style="border: .8 dotted #000000">&nbsp;</td>
...
<?php 
$print = "javascript:popUpWindow('print_lis_clase_pos.php?as=$as&gr=$gr', 'yes', 0, 0, 790, 650)";
