...
<p align="justify">
<strong>ARTÍCULO 49</strong>.- Plan de trabajo. Los profesores de carrera deben concertar con su
coordinador de proyecto curricular, con una anticipación mínima de un (1) mes a la
iniciación del período académico, un plan de trabajo describiendo detalladamente las
actividades que se compromete a realizar durante el mismo tiempo.</p>

<strong>Ingresar una actividad:</strong><br>
    <ol>
	<li>Para ingresar una actividad, selecciónela de la lista desplegable "<span class="error">ACTIVIDADES</span>".</li>
	<li>Haga clic en el ídem "Día" o en el botón frente al mismo, esto le permitirá ver la lista de valores y allí podrá seleccionar la información deseada.</li>
	<li>Repita el paso 2 para los ítem "Hora, Sede y Salón".</li>
	<li>Complete el formulario y haga clic en el botón "Grabar".</li>
	</ol>
