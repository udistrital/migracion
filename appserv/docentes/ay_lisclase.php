...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="doc_fre_carga.php" target="principal">LISTA DE CLASE</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p align="justify">
Haga clic en [Generar Archivo de Excel], para generar una hoja electrónica de Excel.<br><br>
Haga clic en [Enviar correo al grupo], para enviar un correo a los estudiantes del curso.<br><br>
Haga clic en el nombre del estudiante, para ver el plan de estudio. </p>
<br><br><br><br>
    </td>
  </tr>
</table>
