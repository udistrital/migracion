...
echo'<p>&nbsp;</p><div align="center">
  ...
  <td width="300" align="right" height="9" colspan="2">Perfil Bienestar Institucional</td></tr></table>
  <p></p>
  <table border="0" width="500" cellpadding="0">
    ...
    <tr>
      <td width="67%" height="258" background="../img/escudo_fondo.png" style="background-attachment:fixed; background-repeat:no-repeat; background-position:top">
        <p align="justify" style="line-height: 100%">En esta p&aacute;gina usted podr&aacute;: Revisar informaci&oacute;n de los modelos matem&aacute;ticos para bienestar.</p>
	  </td>
    </tr>
    <tr>
