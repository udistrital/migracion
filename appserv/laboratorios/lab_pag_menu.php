...
require_once("../clase/encriptar.class.php");
 ...
 //Enlace validacion deudores
	...
	$opcion = 'datos=';
	$variable="&rol=laboratorios";
	$variable.="&pagina=index";
	$variable.="&usuario=".$usuario;
	$variable.="&opcionPagina=administrarDeudas";
	$variable.="&modulo=".$modulo;
	$variable.="&token=".$tokenCondor;
	$variable=$miCodificadorServiciosAcademicos->codificar($variable);
	$enlaceAdministrarDeudas = $indiceSara.$opcion.$variable;
...
<li class="subitem1"><a target="principal" href="<? echo $enlaceConsejeriaEstudiante ?>">Historia Acad&eacute;mica</a></li>
 <li class="subitem1"><a target="principal" href="<? echo $enlaceAdministrarDeudas ?>">Administrar Deudas</a></li>
</ul>
</li>

<li class=""><a href="#">Reportes</a>
<ul class="submenus">
<li class="subitem1"><a target="principal" href="<? echo $enlaceReporteLaboratorios; ?>">Ver Reportes</a></li>
</ul>
</li>
