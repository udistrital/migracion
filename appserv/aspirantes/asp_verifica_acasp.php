...
$EstratoCost = $nom->rescataNombre($_POST['StrResCost'],"NombreEstrato");
...
if($_POST['TipCol']=='O'){ $TipoCol = 'OFICIAL';}
if($_POST['TipCol']=='P'){ $TipoCol = 'PRIVADO';}
...
<table width="98%" border="1" align="center" cellpadding="2" cellspacing="3" style="border-collapse:collapse">
    ...
    <tr>
      <td align="right">Estrato socioecon&oacute;mico de quien costear&aacute; los estudios:</td>
      <td colspan="3">
	  <? print $EstratoCost; ?>
	  <input name="StrResCost" type="hidden" value="<? print $_POST['StrResCost'];?>">
	  </td>
    </tr>
    <tr>
    ...
    <tr>
      <td align="right">Tipo del colegio donde culmin&oacute; el grado 11:</td>
      <td colspan="3" align="left">
	  <? print $_POST['TipCol'].' '.$TipoCol ?>
	  <input name="TipCol" type="hidden" value="<? print $_POST['TipCol'];?>">
	</td>
    </tr>
    <tr>
      <td align="right">Tipo de discapacidad, si la presenta:</td>
      <td colspan="3" align="left">
	  <? print $_POST['TipDis'];?>
	  <input name="TipDis" type="hidden" value="<? print $_POST['TipDis'];?>">
	</td>
    </tr>
    <tr>
      <td align="right">Valid&oacute; el bachillerato?</td>
      <td colspan="3" align="left">
	  <? print $_POST['valido'];?>
	  <input name="valido" type="hidden" value="<? print $_POST['valido'];?>">
	</td>
    </tr>
     <tr>
      <td align="right">N&uacute;mero de semestres transcurridos desde la terminaci&oacute;n del grado once:</td>
      <td colspan="3" align="left">
	  <? print $_POST['semestresTranscurridos'];?>
	  <input name="semestresTranscurridos" type="hidden" value="<? print $_POST['semestresTranscurridos'];?>">
	</td>
    </tr>
    <tr>
