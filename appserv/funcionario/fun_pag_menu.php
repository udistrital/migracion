...
require_once("../clase/encriptar.class.php");
	...
	$variable=$cripto->codificar_url($variable,$configuracion);
	$enlacePagos=$indiceCIR.$variable;*/
...
<li class="item2"><a href="#">Formaci&oacute;n </a>
<ul class="submenus">
...
<li class=""><a href="#">Desprendibles de Pago </a>
<ul class="submenus">
...
<li class="item5"><a href="#">Formatos Solicitud</a>
<ul class="submenus">
