...
{  
   ...
   function restriccion_acceso()
                ...
                $restriccion_ini=strtotime(substr($this->configuracion['restriccion_acceso_est'],0,14));
                $restriccion_fin=strtotime(substr($this->configuracion['restriccion_acceso_est'],15,14));
                                              
                $h_actual=date("d/m/y-H:i");
