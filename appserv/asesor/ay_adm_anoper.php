...
<table width="90%" align="center" background="../img/fondo_ay.png">
  ...
  <tr>
	...
	<p align="justify"> Seleccione de la lista desplegable el per&iacute;odo académico a consultar.</p>
  	...
  	<P align="justify">De acuerdo al período seleccionado, se despliega la información del total de admitidos por Facultad y Carrera. Graficando el porcentaje de admitidos por carrera frente al total de la Facultad.
	</td>
  </tr>
</table>
<br>
