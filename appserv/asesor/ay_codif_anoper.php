...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
	...
	<a href="assr_codif_anoper.php" target="principal">CODIFICADOS POR A&Ntilde;O Y PER&Iacute;ODO</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p align="justify">Seleccione de la lista desplegable el per&iacute;odo académico a consultar.</p>
  	<p align="justify">Haga clic en el bot&oacute;n &quot;<strong>Consultar</strong>&quot;.</p>
  	<P align="justify">De acuerdo al per&iacute;odo seleccionado, se despliega la informaci&oacute;n del total de estudiantes codificados por Facultad y Carrera. Graficando el porcentaje de admitidos por carrera frente al total de la Facultad.
    </td>
  </tr>
</table>
<br>
