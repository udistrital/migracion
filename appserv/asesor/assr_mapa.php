...
<table width="200" border="0" align="center" cellpadding="0" cellspacing="0">
   ...
   <tr>
     ...
     <td width="178"><a href="assr_asp_anoper.php" target="principal">Por A&ntilde;o y Per&iacute;odo</a></td>
   </tr>
   <tr>
     <td><img src="../img/espacio.gif" width=10 height=20><img src="../img/lin1.gif" border=0 width=10 height=20></td>
   ...
   <tr>
     <td><img src="../img/espacio.gif" width=10 height=20><img src="../img/lin1.gif" border=0 width=10 height=20></td>
     <td><a href="assr_adm_anoper.php" target="principal" onMouseOver="link();return true;" onClick="link();return true;">Por A&ntilde;o y Per&iacute;odo</a></td>
   </tr>
   <tr>
     <td><img src="../img/espacio.gif" width=10 height=20><img src="../img/lin1.gif" border=0 width=10 height=20></td>
   ...
   <tr>
     ...
     <td><a href="assr_codif_anoper.php" target="principal" onMouseOver="link();return true;" onClick="link();return true;">Por A&ntilde;o y Per&iacute;odo</a></td>
   </tr>
   <tr>
     <td colspan="2"><img src="../img/espacio.gif" width=10 height=20></td>
   </tr>
   ...
   <tr>
     <td><img src="../img/espacio.gif" width=10 height=20><img src="../img/lin2.gif" border=0 width=10 height=20></td>
     <td><a href="../estadistica/index_poblacion_activa_estrato.php" target="principal">Activos por Sexo </a></td>
   </tr>
   <tr>
     <td colspan="2"><img src="../img/espacio.gif" width=10 height=20></td>
   </tr>
    <tr>
     <td colspan="2"><span class="Estilo5">Servivios</span></td>
   </tr>
   <tr>
     <td><img src="../img/espacio.gif" width=10 height=20><img src="../img/lin1.gif" border=0 width=10 height=20></td>
   ...
   <tr>
     <td><img src="../img/espacio.gif" width=10 height=20><img src="../img/lin1.gif" border=0 width=10 height=20></td>
     <td><a href="http://sgral.udistrital.edu.co/sgral/index.php?option=com_content&task=view&id=37&Itemid=77" target="principal">Calendario Acad&eacute;mico</a></td>
   </tr>
   <tr>
     <td><img src="../img/espacio.gif" width=10 height=20><img src="../img/lin1.gif" border=0 width=10 height=20></td>
   ...
   <tr>
     <td colspan="2"><span class="Estilo5">Estadísticas</span></td>
   </tr>
   <tr>
     <td><img src="../img/espacio.gif" width=10 height=20><img src="../img/lin1.gif" border=0 width=10 height=20></td>
   ...
   <tr>
     <td><img src="../img/espacio.gif" width=10 height=20><img src="../img/lin1.gif" border=0 width=10 height=20></td>
     <td><a href="../estadistica/index_desercion.php" target="principal">Deserci&oacute;n</a></td>
   </tr>
   <tr>
     <td><img src="../img/espacio.gif" width=10 height=20><img src="../img/lin1.gif" border=0 width=10 height=20></td>
