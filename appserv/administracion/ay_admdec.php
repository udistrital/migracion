...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="adm_decanos.php" target="principal">ADMINISTRACIÓN DE DECANOS</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p>Para activar, desactivar o corregir el nombre de un Decano, haga clic en el icono <img alt="Adicionar" src="../img/b_edit.png" border="0" width="16" height="16">.</p>
	<p>Para borrar un Decano, haga clic en el icono <img alt="Adicionar" src="../img/b_deltbl.png" border="0" width="16" height="16">.</p>
	<p></p>
    </td>
  </tr>
</table>
