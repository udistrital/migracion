...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="#" target="principal">GESTIÓN DE USUARIOS</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p></p>
	<p>Digite el c&oacute;digo a consultar, seleccione de la lista el tipo de usuario. Haga clic en el bot&oacute;n "<STRONG>Consultar</STRONG>", para ejecutar la consulta.</p>
    <p></p>
	</td>
  </tr>
</table>
