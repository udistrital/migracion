...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="adm_fra_facultades.php" target="principal">FACULTADES</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p>Haga clic en el nombre de la Facultad para ver el listado de Coordinadores.</p>
	<p>Para activar, desactivar o corregir el nombre de un Coordinador, haga clic en el icono <img alt="Adicionar" src="../img/b_edit.png" border="0" width="16" height="16">.</p>
	<p>Para borrar un Coordinador, haga clic en el icono <img alt="Adicionar" src="../img/b_deltbl.png" border="0" width="16" height="16">.</p>
	<p></p>
    </td>
  </tr>
</table>
