...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="#" target="principal">USUARIO</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p></p>
	<p>Para activar, desactivar el usuario, haga clic en el icono <img alt="Adicionar" src="../img/b_edit.png" border="0" width="16" height="16">.</p>
    <p>Para activar, desactivar el usuario, haga clic en el icono <img alt="Adicionar" src="../img/b_edit.png" border="0" width="16" height="16">.</p>
	<p>Cambie el estado del registro: "I" para inactivar o "A" para activar.</p>
	<p>Haga clic en el botón "Grabar".</p>
	<p>Para borrar un usuario, haga clic en el icono <img alt="Adicionar" src="../img/b_deltbl.png" border="0" width="16" height="16">.</p>
	</td>
  </tr>
</table>
<br>
