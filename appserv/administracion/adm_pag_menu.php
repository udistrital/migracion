...
$variable.="&usuario=".$_SESSION['usuario_login'];
$variable.="&opcion=seleccionarPeriodo";
...
$enlaceFechasCalendario=$indiceAcademico.$variable; 
 ...
 /*enlace para cierre*/
$variable="pagina=adminCierreSemestreSoporte";
$variable.="&usuario=".$_SESSION['usuario_login'];
$variable.="&action=loginCondor";
...
<a href="#">Servicios</a>
<ul class="submenus">
<li class="subitem1"><a target="principal" href="<?echo $enlaceGeneraArchivosRecibos;?>">Enviar recibos</a></li>
<li class="subitem1"><a target="principal" href="<?echo $enlaceCierre?>">Cierres Semestres</a></li>
