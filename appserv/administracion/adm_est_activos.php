...
<body style="margin-top:0; margin-left:15">
<?php
ob_start();
$redir = 'adm_pag_null.php';
//if($_REQUEST['cracod'] == "") die('<center><h3>No hay registros para esta consulta.</h3></center>');
...
$nom = new Nombres;
$NomCra = $nom->rescataNombre($_SESSION['carrera'],'NombreCarrera');
...
function listar($matriz){
	echo'<table width="197" border="0" cellpadding="0" cellspacing="0">';
	while(list($clave, $valor) = each($matriz))
	{
		  echo'<tr><td width="10%" class="Estilo1" align="center">'.$clave.'</td>
		  <td width="90%">'.$valor.'</td></tr>';
	}
	echo'</table>';
}
?>
<div align="center" class="Estilo11"><? print $NomCra;?></span><br>
<span class="Estilo11">ESTADOS ACAD&Eacute;MICOS DE LOS ESTUDIANTES CON ASIGNATURAS INSCRITAS</span></div>
<table width="97%" border="1" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		<td><? listar($ArrayEstados); ?></td>
		<td align="center" valign="bottom">
		<div align="center" class="aviso">Los estudiantes en los estados A y B, son los &uacute;nicos que deben tener asignaturas inscritas.</div>
...
<div align="center"><b>TOTAL DE ESTUDIANTES CON ASIGNATURAS INSCRITAS</b>: <b><? print $sumtot; ?></b></div>
<br>
</body>
</html>