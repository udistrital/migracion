...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="adm_update_geclaves.php" target="principal">CAMBIO DE CLAVES</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p>Digite el usuario. Digite la nueva clave, confirme la nueva clave y haga clic en el botón "Cambiar Clave".</p>
    </td>
  </tr>
</table>
<br>
