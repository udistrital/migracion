...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="adm_fra_datos_est.php" target="principal">CONSULTA DE ESTUDIANTES</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p>Digite el código del Estudiante a consultar.</p>
	<p>Haga clic en el botón "Consultar Estudiante".</p>
