...
if($row != 1){
   header("Location: adm_pag_null.php?error_login=25");
   exit;
} 
echo'<FORM method="post" ACTION="adm_actualiza_doc.php" name="act"><div align="center">
<table border="1" width="55%" cellspacing="0" cellpadding="0" class="fondoTab">
<tr class="tr" align="center">
<td colspan="2" align="center"><span class="Estilo11">ACTUALIZACIÓN DE DATOS - DOCENTES</span></td></tr>
<tr><td align="left">
