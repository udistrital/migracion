...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="coor_fra_datos_doc.php" target="principal">CONSULTA DE DOCENTES</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p>Digite el número de identificación del Docente a consultar.</p>
	<p>Haga clic en el botón "Consultar Docente".</p>
	<p>Haciendo clic en el botón “Grabar”, usted podrá actualizar la información que haya modificado.</p>
    </td>
  </tr>
</table>
<br>
