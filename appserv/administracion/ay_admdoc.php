...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="adm_docentes.php" target="principal">ADMINISTRACIÓN DE DOCENTES</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p>Haciendo clic en el botón de radio que antecede a cada criterio de búsqueda, usted podrá ver un listado de los usuarios Docentes  de Cóndor.</p>
	<p>Haga clic en la letra inicial que corresponda al criterio de búsqueda.</p>
	<p>Haciendo clic en el botón “Consultar”, usted podrá ver un listado de los usuarios Docentes de Cóndor ordenado según el criterio de búsqueda seleccionado y de letra inicial seleccionada.</p>
    </td>
  </tr>
</table>
<br>
