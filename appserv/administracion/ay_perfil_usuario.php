...
<table width="90%" align="center" background="../img/fondo_ay.png">
  <tr>
    ...
    &nbsp;&nbsp;&nbsp;
	<a href="adm_perfil_usuario.php" target="principal">PERFILES DE USUARIO</a></span></td>
  ...
  <tr>
    <td colspan="2">
	<p></p>
	<p>Digite el usuario y haga clic en &quot;Consultar&quot;.</p>
    <p>Para inactivar un perfil del usuario, haga clic en el icono <IMG src="../img/b_deltbl.png" border=0>.</p>
	<p>Para activar un perfil del usuario, haga clic en el icono <IMG src="../img/s_okay.png" border=0>.</p>
	<p>Para crear un nuevo perfil, seleccione de la lista &quot;<B>CREAR NUEVO PERFIL</B>&quot; el nombre del perfil a crear.</p>
	<p>Haga clic en el bot&oacute;n &quot;Crear&quot;.</p>
	<p></p>
	</td>
  </tr>
</table>
