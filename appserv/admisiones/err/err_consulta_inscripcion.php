...
//-->
var pagina="http://www.udistrital.edu.co";
function ud(){
...
<tr><td><fieldset style="padding:20;">
		...
		<p align="justify">&nbsp;</p>
		<p align="center"><b>Primero debe diligenciar un formulario, 24 horas después podrá consultar su inscripción.</b></p>
		<p align="justify">&nbsp;</p>
	  ...
	  <p>&nbsp;</p>
	  <p align="center"><input type="button" name="Submit" value="Regresar" onClick="ud();" style="width:150; cursor:pointer"></p>
