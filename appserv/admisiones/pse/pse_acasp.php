...
<script language="JavaScript" src="../general/BorraLink.js"></script>
<script language="JavaScript" src="../general/SoloNumero.js"></script>
...
<form name="acasp" method="post" action="pse_verifica_acasp.php">
...
<table width="99%" border="1" align="center" cellpadding="0" cellspacing="2" style="border-collapse:collapse">
    ...
    <tr>
      ...
      <td colspan="5" align="justify" class="Estilo10">Si selecciona un <b>Tipo de inscripción</b> diferente de normal, debe presentar los soportes en el sitio y la fecha indicadas, (ver instructivo de inscripciones especiales).</td>
    </tr>
    <tr>
