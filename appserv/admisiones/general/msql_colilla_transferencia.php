...
$QryCTransferencia = OCIParse($oci_conecta, "SELECT (DECODE(atr_ape_per,1,'PRIMER PERIODO',3,'SEGUNDO PERIODO')||' '||atr_ape_ano) periodo,
...
OCIExecute($QryCTransferencia) or die(Ora_ErrorCode());
$RowCTransferencia = OCIFetch($QryCTransferencia);
?>