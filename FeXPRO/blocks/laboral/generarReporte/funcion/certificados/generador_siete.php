...
// Creación del objeto de la clase heredada
    ...
    $pdf->Output($ruta."/documentos/basico_sueldomensual.pdf",'F');    
    echo "<script language='javascript'>window.open('".$url."/basico_sueldomensual.pdf','_self','');</script>";//para ver el archivo pdf generado
