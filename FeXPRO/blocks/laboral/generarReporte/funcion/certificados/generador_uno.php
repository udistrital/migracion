...
//$fila = $cadena_sql;
//var_dump(utf8_decode($cadena_sql[0][3]));exit;
...
// 	}
	...
	/*****************Genera Tabla en Reporte -- Fin************************************/
    $pdf->Output($ruta."/documentos/promedio_mensual.pdf",'F');
    
    echo "<script language='javascript'>window.open('".$url."/promedio_mensual.pdf','_self','');</script>";//para ver el archivo pdf generado
